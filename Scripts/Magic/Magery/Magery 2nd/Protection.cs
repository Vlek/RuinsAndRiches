	...
	public class ProtectionSpell : MagerySpell
	{
		...
		public static void Toggle( Mobile caster, Mobile target )
		{
			...
			if ( mods == null )
			{
				...
				target.FixedParticles( 0x375A, 9, 20, 5016, Server.Misc.PlayerSettings.GetMySpellHue( true, caster, 0 ), 0, EffectLayer.Waist );
		...
		public override void OnCast()
		{
			...
			else
			{
				...
				else if ( CheckSequence() )
				{
					...
					{
						double value = (int)(Caster.Skills[SkillName.Psychology].Value + Caster.Skills[SkillName.Meditation].Value + Caster.Skills[SkillName.Inscribe].Value);
						value /= 4;
						...
						Caster.FixedParticles( 0x375A, 9, 20, 5016, Server.Misc.PlayerSettings.GetMySpellHue( true, Caster, 0 ), 0, EffectLayer.Waist );
