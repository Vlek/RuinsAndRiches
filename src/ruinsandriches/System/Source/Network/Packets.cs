...
public sealed class DisplayGumpPacked : Packet, IGumpWriter
{
    ...
    public int TextEntries {
        get { return m_TextEntries; } set { m_TextEntries = value; }
    }
    public int Switches {
        get { return m_Switches; } set { m_Switches = value; }
    }
...
public sealed class SupportedFeatures : Packet
{
    ...
    public static FeatureFlags Value {
        get { return m_AdditionalFlags; } set { m_AdditionalFlags = value; }
    }
