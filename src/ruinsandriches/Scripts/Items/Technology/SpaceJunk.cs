...
public class SpaceJunkA : SpaceJunk { [Constructable] public SpaceJunkA()
                                      {
                                      }

                                      public SpaceJunkA(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkB : SpaceJunk { [Constructable] public SpaceJunkB()
                                      {
                                      }

                                      public SpaceJunkB(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkC : SpaceJunk { [Constructable] public SpaceJunkC()
                                      ...
                                      public SpaceJunkC(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkD : SpaceJunk { [Constructable] public SpaceJunkD()
                                      {
                                      }

                                      public SpaceJunkD(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkE : SpaceJunk { [Constructable] public SpaceJunkE()
                                      {
                                      }

                                      public SpaceJunkE(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkF : SpaceJunk { [Constructable] public SpaceJunkF()
                                      {
                                      }

                                      public SpaceJunkF(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkG : SpaceJunk { [Constructable] public SpaceJunkG()
                                      {
                                      }

                                      public SpaceJunkG(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkH : SpaceJunk { [Constructable] public SpaceJunkH()
                                      {
                                      }

                                      public SpaceJunkH(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkI : SpaceJunk { [Constructable] public SpaceJunkI()
                                      {
                                      }

                                      public SpaceJunkI(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkJ : SpaceJunk { [Constructable] public SpaceJunkJ()
                                      {
                                      }

                                      public SpaceJunkJ(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkK : SpaceJunk { [Constructable] public SpaceJunkK()
                                      {
                                      }

                                      public SpaceJunkK(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkL : SpaceJunk { [Constructable] public SpaceJunkL()
                                      {
                                      }

                                      public SpaceJunkL(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkM : SpaceJunk { [Constructable] public SpaceJunkM()
                                      {
                                      }

                                      public SpaceJunkM(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkN : SpaceJunk { [Constructable] public SpaceJunkN()
                                      {
                                      }

                                      public SpaceJunkN(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkO : SpaceJunk { [Constructable] public SpaceJunkO()
                                      {
                                      }

                                      public SpaceJunkO(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkP : SpaceJunk { [Constructable] public SpaceJunkP()
                                      {
                                      }

                                      public SpaceJunkP(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkQ : SpaceJunk { [Constructable] public SpaceJunkQ()
                                      {
                                      }

                                      public SpaceJunkQ(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkR : SpaceJunk { [Constructable] public SpaceJunkR()
                                      {
                                      }

                                      public SpaceJunkR(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkS : SpaceJunk { [Constructable] public SpaceJunkS()
                                      {
                                      }

                                      public SpaceJunkS(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkT : SpaceJunk { [Constructable] public SpaceJunkT()
                                      {
                                      }

                                      public SpaceJunkT(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkU : SpaceJunk { [Constructable] public SpaceJunkU()
                                      {
                                      }

                                      public SpaceJunkU(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkV : SpaceJunk { [Constructable] public SpaceJunkV()
                                      {
                                      }

                                      public SpaceJunkV(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkW : SpaceJunk { [Constructable] public SpaceJunkW()
                                      {
                                      }

                                      public SpaceJunkW(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkX : SpaceJunk { [Constructable] public SpaceJunkX()
                                      {
                                      }

                                      public SpaceJunkX(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkY : SpaceJunk { [Constructable] public SpaceJunkY()
                                      {
                                      }

                                      public SpaceJunkY(Serial serial) : base(serial)
                                      {
                                      }
...
public class SpaceJunkZ : SpaceJunk { [Constructable] public SpaceJunkZ()
                                      {
                                      }

                                      public SpaceJunkZ(Serial serial) : base(serial)
                                      {
                                      }
