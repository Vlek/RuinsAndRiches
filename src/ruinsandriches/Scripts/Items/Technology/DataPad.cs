...
public class DataPad : Item
{
    ...
    public int Data_ID {
        get { return DataID; } set { DataID = value; InvalidateProperties(); }
    }

    public string DataTitle;
    [CommandProperty(AccessLevel.Owner)]
    public string Data_Title {
        get { return DataTitle; } set { DataTitle = value; InvalidateProperties(); }
    }

    public string DataAuthor;
    [CommandProperty(AccessLevel.Owner)]
    public string Data_Author {
        get { return DataAuthor; } set { DataAuthor = value; InvalidateProperties(); }
    }

    public string DataSubject;
    [CommandProperty(AccessLevel.Owner)]
    public string Data_Subject {
        get { return DataSubject; } set { DataSubject = value; InvalidateProperties(); }
    }
