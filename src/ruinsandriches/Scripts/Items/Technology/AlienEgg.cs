...
public class AlienEgg : Item
{
    ...
    public static bool ProcessAlienEgg(Mobile m, Mobile vet, Item dropped)
    {
        ...
        if (XormiteReturn > 0)
        {
            m.AddToBackpack(new DDXormite(XormiteReturn)); vet.Say("Here is " + XormiteReturn.ToString() + " xormite back for all of your help.");
        }
    ...
    public string g_AnimalTrainerLocation {
        get { return AnimalTrainerLocation; } set { AnimalTrainerLocation = value; }
    }
    ...
    public int g_HaveRod {
        get { return HaveRod; } set { HaveRod = value; }
    }
    ...
    public int g_HaveRedCrystal {
        get { return HaveRedCrystal; } set { HaveRedCrystal = value; }
    }

    public int HaveYellowCrystal;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveYellowCrystal {
        get { return HaveYellowCrystal; } set { HaveYellowCrystal = value; }
    }

    public int HavePotion;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HavePotion {
        get { return HavePotion; } set { HavePotion = value; }
    }
}
}
