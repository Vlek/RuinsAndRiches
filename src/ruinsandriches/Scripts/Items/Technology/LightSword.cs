...
public class LightSword : BaseSword
{
    ...
    public override void Deserialize(GenericReader reader)
    {
        ...
        if (Hue == 0x48D)
        {
            AosElementDamages.Physical = 50; AosElementDamages.Cold = 50;
        }
        else if (Hue == 0x48E)
        {
            AosElementDamages.Physical = 50; AosElementDamages.Fire = 50;
        }
        else if (Hue == 0x48F)
        {
            AosElementDamages.Physical = 50; AosElementDamages.Poison = 50;
        }
        else if (Hue == 0x490)
        {
            AosElementDamages.Physical = 50; AosElementDamages.Energy = 50;
        }
        else
        {
