...
public class EssenceOrb : Item
{
    ...
    public int mMorphHue {
        get { return m_MorphHue; } set { m_MorphHue = value; InvalidateProperties(); }
    }

    public int m_MorphHairHue;
    [CommandProperty(AccessLevel.GameMaster)]
    public int mMorphHairHue {
        get { return m_MorphHairHue; } set { m_MorphHairHue = value; InvalidateProperties(); }
    }

    public string m_MorphName;
    [CommandProperty(AccessLevel.GameMaster)]
    public string mMorphName {
        get { return m_MorphName; } set { m_MorphName = value; InvalidateProperties(); }
    }

    public string m_OriginalName;
    [CommandProperty(AccessLevel.GameMaster)]
    public string mOriginalName {
        get { return m_OriginalName; } set { m_OriginalName = value; InvalidateProperties(); }
    }

    public int m_Status;
    [CommandProperty(AccessLevel.GameMaster)]
    public int mStatus {
        get { return m_Status; } set { m_Status = value; InvalidateProperties(); }
    }
