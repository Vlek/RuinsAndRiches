...
public class MagicForges : Item
{
    ...
    public override void OnSpeech(SpeechEventArgs e)
    {
        if (!e.Handled)
        {
            ...
            if (m.Region.IsPartOf("the Altar of Golden Rangers") || m.Region.IsPartOf("the Ranger Outpost"))
            {
                keyword = "Aurum";
            }
            ...
            if (this.Name == "Priest Grave")                       // PRIEST GRAVES
            {
                ...
                if (m.Karma >= 2500 && isPriest > 0 && priestCheck)
                {
                    ...
                    if (this.X == 3082)
                    {
                        priest = "Drumat the Apostle"; symbol = "HolyManSymbol774"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                        ...
                        {
                            Item item = ( Item )targets[i]; item.Delete();
                        }
                    }
                    else if (this.X == 805)
                    {
                        priest = "Vincent the Priest"; symbol = "HolyManSymbol775"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Father Michal"; symbol = "HolyManSymbol778"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Xephyn the Monk"; symbol = "HolyManSymbol782"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Sister Tiana"; symbol = "HolyManSymbol779"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Chancellor Davis"; symbol = "HolyManSymbol783"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Abigayl the Preacher"; symbol = "HolyManSymbol776"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Edwin the Pope"; symbol = "HolyManSymbol781"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Deacon Wilems"; symbol = "HolyManSymbol773"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Patriarch Morden"; symbol = "HolyManSymbol770"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Brother Kurklan"; symbol = "HolyManSymbol780"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Archbishop Halyrn"; symbol = "HolyManSymbol771"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Cardinal Greggs"; symbol = "HolyManSymbol777"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        priest = "Bishop Leantre"; symbol = "HolyManSymbol772"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                ...
                else if (m.Karma > 0 && m.Skills[SkillName.Psychology].Base > 0 && Server.Misc.GetPlayerInfo.isJedi(m, false))
                {
                    ...
                    if (this.X == 3082)
                    {
                        yoda = "Jacen Sollo"; jedi = "JediDatacron01"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        yoda = "Kiadi Mundia"; jedi = "JediDatacron02"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        yoda = "Kip Fisto"; jedi = "JediDatacron03"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        yoda = "Marra Jade"; jedi = "JediDatacron04"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        yoda = "Numi Sunrider"; jedi = "JediDatacron05"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        yoda = "Plo Kune"; jedi = "JediDatacron06"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        yoda = "Kyle Katran"; jedi = "JediDatacron07"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        yoda = "Kyp Duron"; jedi = "JediDatacron08"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        yoda = "Ganer Rhysode"; jedi = "JediDatacron09"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        yoda = "Coran Horn"; jedi = "JediDatacron10"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
            ...
            else if (this.Name != "Magic Forge Trigger")                       // DEATH KNIGHT SHRINES
            {
                if (m.Karma < 0 && m.Skills[SkillName.Knightship].Base > 0)
                {
                    ...
                    {
                        skull = "DeathKnightSkull750"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull751"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull752"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull753"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull754"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull755"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull756"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull757"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull758"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull759"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull760"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull761"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull762"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        skull = "DeathKnightSkull763"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                ...
                if (m.Karma <= 0 && m.Skills[SkillName.Psychology].Base > 0 && Server.Misc.GetPlayerInfo.isSyth(m, false))
                {
                    ...
                    {
                        syth = "SythDatacron01"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        syth = "SythDatacron02"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        syth = "SythDatacron03"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        syth = "SythDatacron04"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        syth = "SythDatacron05"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        syth = "SythDatacron06"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        syth = "SythDatacron07"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        syth = "SythDatacron08"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        syth = "SythDatacron09"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                    ...
                    {
                        syth = "SythDatacron10"; ArrayList targets = new ArrayList(); foreach (Item item in World.Items.Values)
                        {
                                ...
                                if (Server.Misc.Arty.canEnchant(enchant) && enchant.X >= 704 && enchant.Y >= 2208 && enchant.X <= 705 && enchant.Y <= 2209 && Change == 0)
                                {
                                    ...
                                    if (Change == 1)
                                    {
                                        ...
                                        if (itemType != null)
                                        {
                                            ...
                                            if (nameItem == null)
                                            {
                                                nameItem = MorphingItem.AddSpacesToSentence((newItem.GetType()).Name);
                                            }
            ...
            else if (m.Region.IsPartOf("the Moon's Core") && m.X == 5689 && m.Y == 1912)                         // MOON CORE
            {
                if (m.Skills[SkillName.Elementalism].Base >= 80 || m.Skills[SkillName.Magery].Base >= 80 || m.Skills[SkillName.Necromancy].Base >= 80)
                {
                        ...
                        )
                    {
                        ...
                        int magic = 0;
                        if (m.Skills[SkillName.Necromancy].Base > m.Skills[SkillName.Magery].Base)
                        {
                            magic = 1;
                        }
                        if (m.Skills[SkillName.Elementalism].Base > m.Skills[SkillName.Magery].Base)
                        {
                            magic = 2;
                        }
                        if (m.Skills[SkillName.Elementalism].Base > m.Skills[SkillName.Necromancy].Base)
                        {
                            magic = 2;
                        }
                    ...
                    if (Server.Misc.Arty.canEnchant(enchant) && enchant.X >= 1064 && enchant.Y >= 1167 && enchant.X <= 1067 && enchant.Y <= 1169)
                    {
                        if (enchant is BaseWeapon)
                        {
                            ...
                            if (weapon.AosElementDamages.Poison < 100 && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem(enchant))
                            {
                                ...
                                {
                                    weapon.WeaponAttributes.HitPoisonArea = Utility.RandomMinMax(1, 100);
                                }
                    ...
                    if (Server.Misc.Arty.canEnchant(enchant) && enchant.X >= 3979 && enchant.Y >= 736 && enchant.X <= 3982 && enchant.Y <= 738)
                    {
                        if (enchant is BaseWeapon)
                        {
                            ...
                            if (weapon.AosElementDamages.Cold < 100 && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem(enchant))
                            {
                                ...
                                if (Utility.RandomMinMax(1, 20) == 1)
                                {
                                    weapon.WeaponAttributes.HitColdArea = Utility.RandomMinMax(1, 100);
                                }
                    ...
                    if (Server.Misc.Arty.canEnchant(enchant) && enchant.X >= 5331 && enchant.Y >= 3203 && enchant.X <= 5334 && enchant.Y <= 3207)
                    {
                        if (enchant is BaseWeapon)
                        {
                            ...
                            if (weapon.AosElementDamages.Energy < 100 && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem(enchant))
                            {
                                ...
                                if (Utility.RandomMinMax(1, 20) == 1)
                                {
                                    weapon.WeaponAttributes.HitEnergyArea = Utility.RandomMinMax(1, 100);
                                }
                    ...
                    if (Server.Misc.Arty.canEnchant(enchant) && enchant.X >= 725 && enchant.Y >= 1151 && enchant.X <= 730 && enchant.Y <= 1156)
                    {
                        if (enchant is BaseWeapon)
                        {
                            ...
                            if (weapon.AosElementDamages.Fire < 100 && Server.Misc.MaterialInfo.IsAnyKindOfMetalItem(enchant))
                            {
                                ...
                                if (Utility.RandomMinMax(1, 20) == 1)
                                {
                                    weapon.WeaponAttributes.HitFireArea = Utility.RandomMinMax(1, 100);
                                }
