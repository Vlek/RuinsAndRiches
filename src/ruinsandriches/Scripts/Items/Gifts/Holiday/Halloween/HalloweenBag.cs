...
public class ChocolateMonster : Item
{
    ...
    public ChocolateMonster() : base()
    {
        ...
        {
            Hue = 1150; Name = "Marshmallow"; ItemID = 2538;
        }
        else if (Gift == 3)
        {
            Hue = 0; Name = "Jaw Breaker"; ItemID = 6251;
        }
        else if (Gift == 4)
        {
            Hue = 0; Name = "Sour Drop"; ItemID = 5930;
        }
        else if (Gift == 5)
        {
            Hue = 0; Name = "Lemon Drop"; ItemID = 5928;
        }
        else if (Gift == 6)
        {
            Hue = 2965; Name = "Pixie Sticks"; ItemID = 3978;
        }
        else if (Gift == 7)
        {
            Hue = 1167; Name = "Jelly Beans"; ItemID = 3611;
        }
        else if (Gift == 8)
        {
            Hue = 0; Name = "Hard Candy"; ItemID = 3967;
        }
        else
        {
            Hue = 1195; Name = "Gum Ball"; ItemID = 3699;
        }
    }
