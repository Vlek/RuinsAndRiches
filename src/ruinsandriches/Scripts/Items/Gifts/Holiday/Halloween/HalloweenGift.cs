...
public class HalloweenGift : Item
{
    ...
    public HalloweenGift() : base()
    {
        ...
        if (Gift == 2)
        {
            ItemID = 16382; Name = "Stuffed Nightmare"; Hue = 0x386;
        }
        else if (Gift == 3)
        {
            ItemID = 2852; Name = "Gothic Lamp Post"; Light = LightType.Circle225;
        }
        else if (Gift == 4)
        {
            ItemID = 9777; Name = "Bat";
        }
        else if (Gift == 5)
        {
            ItemID = 9737; Name = "Chaos Demon";
        }
        else if (Gift == 6)
        {
            ItemID = 16142; Name = "Coffin";
        }
        else if (Gift == 7)
        {
            ItemID = 15117; Name = "Witch's Toad";
        }
        else if (Gift == 8)
        {
            ItemID = 10936; Name = "Altar";
        }
        else if (Gift == 9)
        {
            ItemID = 10897; Name = "Bone Throne";
        }
        else if (Gift == 10)
        {
            ItemID = 10898; Name = "Torture Table";
        }
        else if (Gift == 11)
        {
            ItemID = 8700; Name = "Skull Spikes";
        }
