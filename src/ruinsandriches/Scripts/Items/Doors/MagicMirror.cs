...
public class MagicMirror : Item
{
    ...
    public int Mirror_Destination {
        get { return MirrorDestination; } set { MirrorDestination = value; InvalidateProperties(); }
    }

    public int MirrorX;
    [CommandProperty(AccessLevel.Owner)]
    public int Mirror_X {
        get { return MirrorX; } set { MirrorX = value; InvalidateProperties(); }
    }

    public int MirrorY;
    [CommandProperty(AccessLevel.Owner)]
    public int Mirror_Y {
        get { return MirrorY; } set { MirrorY = value; InvalidateProperties(); }
    }

    public int MirrorZ;
    [CommandProperty(AccessLevel.Owner)]
    public int Mirror_Z {
        get { return MirrorZ; } set { MirrorZ = value; InvalidateProperties(); }
    }

    public Map MirrorMap;
    [CommandProperty(AccessLevel.Owner)]
    public Map Mirror_Map {
        get { return MirrorMap; } set { MirrorMap = value; InvalidateProperties(); }
    }
