    ...
    public void DoPublicDoor(Mobile m)
    {
        ...
        if (m is PlayerMobile)
        {
            ...
            else if (m.Region is PublicRegion)                       // FAIL SAFE
            {
                ...
                {
                    loc = new Point3D(1830, 768, 0); failMap = Map.Sosaria;     failPlace = "the Bank";
                }
                else if (Server.Misc.Worlds.GetRegionName(m.Map, m.Location) == "the Tavern")
                {
                    loc = new Point3D(1831, 758, 12); failMap = Map.Sosaria;     failPlace = "the Inn";
                }
                ...
                {
                    loc = new Point3D(1831, 758, 12); failMap = Map.Sosaria;       failPlace = "the PortThat ";
                }
                else if (Server.Misc.Worlds.GetRegionName(m.Map, m.Location) == "the Black Magic Guild")
                {
                    loc = new Point3D(2243, 251, 0); failMap = Map.Sosaria;   failPlace = "the Black Magic Guild";
                }
                else if (Server.Misc.Worlds.GetRegionName(m.Map, m.Location) == "the Wizards Guild")
                {
                    loc = new Point3D(2832, 1873, 55); failMap = Map.Sosaria;     failPlace = "the Wizards Guild";
                }
                else if (Server.Misc.Worlds.GetRegionName(m.Map, m.Location) == "the Thieves Guild")
                {
                    loc = new Point3D(3315, 2059, 40); failMap = Map.Sosaria; failPlace = "the Thieves Guild";
                }
                else if (Server.Misc.Worlds.GetRegionName(m.Map, m.Location) == "the Basement")
                {
                    loc = new Point3D(1831, 758, 12); failMap = Map.Sosaria;   failPlace = "the Basement";
                }
