...
public class UnidentifiedItem : LockableContainer
{
    ...
    public string Skill_Required {
        get { return SkillRequired; } set { SkillRequired = value; InvalidateProperties(); }
    }
    ...
    public string Vendor_CanID {
        get { return VendorCanID; } set { VendorCanID = value; InvalidateProperties(); }
    }
    ...
    public override void AddNameProperties(ObjectPropertyList list)
    {
        ...
        {
            VendorCanID = "Sage"; sVendorCanID = "Sage Can Identify"; SkillRequired = "ItemID";
        }
