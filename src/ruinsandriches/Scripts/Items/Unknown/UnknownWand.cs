	...
	public class UnknownWand : Item
	{
		...
		public static void WandType( Item wand, Mobile m, Mobile vendor )
		{
			if ( Utility.RandomMinMax( 1, 100 ) > 10 )
			{
				...
				if ( stickType == 0 ){ newWand = new IdentifyStaff(); stickName = "identification"; } // CIRCLE 0
				else if ( stickType == 1 ){ newWand = new ClumsyMagicStaff(); stickName = "clumsiness"; } // CIRCLE 1
