...
public class CanopicJar : Item
{
    ...
    public string Jar_Owner {
        get { return JarOwner; } set { JarOwner = value; InvalidateProperties(); }
    }
    ...
    public string Jar_Contents {
        get { return JarContents; } set { JarContents = value; InvalidateProperties(); }
    }
    ...
    public string Jar_Potion {
        get { return JarPotion; } set { JarPotion = value; InvalidateProperties(); }
    }
