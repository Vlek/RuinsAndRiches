        ...
        protected override void OnTarget(Mobile from, object targeted)
        {
            if (targeted is Item)
            {
                ...
                else if (iOil is BaseWeapon)
                {
                    ...
                    {
                        if (m_Oil.Hue == 0x555 || m_Oil.Name == "oil of leather enhancement ( deep sea )")
                        {
                            xOil.Resource = CraftResource.SpinedLeather;
                        }
                        else if (m_Oil.Hue == 0x586 || m_Oil.Name == "oil of leather enhancement ( lizard )")
                        {
                            xOil.Resource = CraftResource.HornedLeather;
                        }
                        else if (m_Oil.Hue == 0x7D1 || m_Oil.Name == "oil of leather enhancement ( serpent )")
                        {
                            xOil.Resource = CraftResource.BarbedLeather;
                        }
                        else if (m_Oil.Hue == 0xB97 || m_Oil.Name == "oil of leather enhancement ( necrotic )")
                        {
                            xOil.Resource = CraftResource.NecroticLeather;
                        }
                        else if (m_Oil.Hue == 0x4EB || m_Oil.Name == "oil of leather enhancement ( volcanic )")
                        {
                            xOil.Resource = CraftResource.VolcanicLeather;
                        }
                        else if (m_Oil.Hue == 0x47E || m_Oil.Name == "oil of leather enhancement ( frozen )")
                        {
                            xOil.Resource = CraftResource.FrozenLeather;
                        }
                        else if (m_Oil.Hue == 0x6DF || m_Oil.Name == "oil of leather enhancement ( goliath )")
                        {
                            xOil.Resource = CraftResource.GoliathLeather;
                        }
                        else if (m_Oil.Hue == 0x846 || m_Oil.Name == "oil of leather enhancement ( draconic )")
                        {
                            xOil.Resource = CraftResource.DraconicLeather;
                        }
                        else if (m_Oil.Hue == 0x5B5 || m_Oil.Name == "oil of leather enhancement ( hellish )")
                        {
                            xOil.Resource = CraftResource.HellishLeather;
                        }
                        else if (m_Oil.Hue == 0x430 || m_Oil.Name == "oil of leather enhancement ( dinosaur )")
                        {
                            xOil.Resource = CraftResource.DinosaurLeather;
                        }
