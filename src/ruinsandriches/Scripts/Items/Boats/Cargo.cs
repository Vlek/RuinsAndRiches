...
public class Cargo : Item
{
    ...
    public int Cargo_Value {
        get { return CargoValue; } set { CargoValue = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Cargo_Karma {
        get { return CargoKarma; } set { CargoKarma = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Cargo_Type {
        get { return CargoType; } set { CargoType = value; InvalidateProperties(); }
    }
    ...
    public int Cargo_Qty {
        get { return CargoQty; } set { CargoQty = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Cargo_Hue {
        get { return CargoHue; } set { CargoHue = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Cargo_From {
        get { return CargoFrom; } set { CargoFrom = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Cargo_Contains {
        get { return CargoContains; } set { CargoContains = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Cargo_Vendor {
        get { return CargoVendor; } set { CargoVendor = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Cargo_Ship {
        get { return CargoShip; } set { CargoShip = value; InvalidateProperties(); }
    }
    ...
    public class CargoGump : Gump
    {
        ...
        public CargoGump(Mobile from, Cargo cargo) : base(50, 50)
        {
            ...
            string karma = "<BODY><BASEFONT Color=#ff0000>Bad</BASEFONT></BODY>"; if (cargo.CargoKarma > 0)
            {
            ...
            string gotten = "pirated"; if (cargo.CargoKarma > 0)
            {
                gotten = "seized";
            }
            string boat = "the hold of a small boat"; if (cargo.CargoShip != null && cargo.CargoShip != "")
            {
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            if (info.ButtonID > 0 && m_Cargo.CargoQty > 0)
            {
                ...
                {
                    box.Delete(); box = new LargeCrate(); box.Name = "wooden crate";
                }
                ...
                {
                    box.ItemID = 0x0E83; box.Weight = 8.0; box.Name = "wooden tub";
                }
                ...
                else
                {
                    ...
                    if (item is DDRelicStatue)
                    {
                        ...
                        {
                            item.Name = "bust of " + RandomThings.GetRandomBoyName() + " the " + RandomThings.GetBoyGirlJob(0);
                        }
                        else
                        {
                            item.Name = "bust of " + RandomThings.GetRandomBoyName() + " the " + RandomThings.GetRandomBoyNoble();
                        }
    ...
    public void CreateCargo()
    {
        ...
        {
            CargoVendor = "Art Collector"; ItemID = Utility.RandomList(0x5080, 0x5081); Name = "royal vault of riches"; CargoFrom = "From the " + RandomThings.GetRandomKingdomName() + " " + RandomThings.GetRandomKingdom(); CargoBox = 0;
        }
        else if (CargoType == 3)
        {
            CargoVendor = "Shipwright"; ItemID = Utility.RandomList(0x545F, 0x5460, 0x5082, 0x5083); Name = "cargo container"; CargoFrom = "From the " + RandomThings.GetRandomKingdomName() + " " + RandomThings.GetRandomKingdom(); CargoBox = 0; Hue = Utility.RandomColor(0);
        }
        else if (CargoType == 4)
        {
            CargoVendor = "Stable Worker"; ItemID = 0x4F87; Name = "crate of hay"; CargoContains = "SheafOfHay"; CargoQty = (int)(CargoValue / 5);
        }
        else if (CargoType == 5)
        {
            CargoVendor = "Bowyer"; ItemID = 0x4F88; Name = "crate of bowcrafting tools"; CargoContains = "FletcherTools"; CargoQty = (int)(CargoValue / 5);
        }
        else if (CargoType == 6)
        {
            CargoVendor = "Butcher"; ItemID = 0x4F89; Name = "crate of raw ribs"; CargoContains = "RawRibs"; CargoQty = (int)(CargoValue / 16);
        }
        else if (CargoType == 7)
        {
            CargoVendor = "Carpenter"; ItemID = 0x4F8A; Name = "crate of woodworking saws"; CargoContains = "Saw"; if (Utility.RandomBool())
            {
        ...
        {
            CargoVendor = "Jeweler"; ItemID = 0x4F8B; Name = "crate of jeweler kits"; CargoContains = "TinkerTools"; CargoQty = (int)(CargoValue / 5);
        }
        else if (CargoType == 9)
        {
            CargoVendor   = "Mage";
        ...
        {
            CargoVendor = "Blacksmith"; ItemID = 0x4F8D; Name = "crate of smithing hammers"; CargoContains = "SmithHammer"; CargoQty = (int)(CargoValue / 16);
        }
        else if (CargoType == 11)
        {
            CargoVendor = "Provisioner"; ItemID = 0x4F8E; Name = "crate of torches"; CargoContains = "Torch"; CargoQty = (int)(CargoValue / 8);
        }
        else if (CargoType == 12)
        {
            CargoVendor = "Tailor"; ItemID = 0x4F8F; Name = "crate of sewing kits"; CargoContains = "SewingKit"; CargoQty = (int)(CargoValue / 5);
        }
        else if (CargoType == 13)
        {
            CargoVendor = "Tinker"; ItemID = 0x4F90; Name = "crate of tinker tools"; CargoContains = "TinkerTools"; CargoQty = (int)(CargoValue / 5);
        }
        else if (CargoType == 14)
        {
            CargoVendor = "Alchemist or Herbalist"; ItemID = 0x4F91; Name = "crate of mortars and pestles"; CargoContains = "MortarPestle"; CargoQty = (int)(CargoValue / 8);
        }
        else if (CargoType == 15)
        {
            CargoVendor = "Cook or Baker"; ItemID = 0x4F92; Name = "crate of skillets"; CargoContains = "Skillet"; CargoQty = (int)(CargoValue / 5);
        }
        ...
        {
            CargoVendor = "Beekeeper"; ItemID = 0x4F95; Name = "crate of beeswax"; CargoContains = "Beeswax"; CargoQty = (int)(CargoValue / 50);
        }
        else if (CargoType == 19)
        {
            CargoVendor = "Scribe"; ItemID = 0x4F96; Name = "crate of scribe pens"; CargoContains = "ScribesPen"; CargoQty = (int)(CargoValue / 8);
        }
        else if (CargoType == 20)
        {
            CargoVendor = "Bowyer"; ItemID = 0x4F97; Name = "crate of bowyer tools"; CargoContains = "FletcherTools"; CargoQty = (int)(CargoValue / 5);
        }
        else if (CargoType == 21)
        {
            CargoVendor = "Healer"; ItemID = 0x4F98; Name = "crate of bandages"; CargoContains = "Bandage"; CargoQty = (int)(CargoValue / 5);
        }
        ...
        {
            CargoVendor = "Mapmaker"; ItemID = 0x4F9B; Name = "crate of mapping pens"; CargoContains = "MapmakersPen"; CargoQty = (int)(CargoValue / 8);
        }
        ...
        {
            CargoVendor = "Beekeeper"; ItemID = 0x4F9D; Name = "crate of candles"; CargoContains = "Candle"; CargoQty = (int)(CargoValue / 6);
        }
        ...
        else if (CargoType == 28)
        {
            ...
            if (rare <= 1)
            {
                CargoMaterial = 14; Name = "crate of dwarven ore"; Hue = MaterialInfo.GetMaterialColor("dwarven", "", 0);                                   CargoContains = "DwarvenOre";           CargoQty = (int)(CargoValue / 96);
            }
            else if (rare <= 2)
            {
                CargoMaterial = 13; Name = "crate of xormite ore"; Hue = MaterialInfo.GetMaterialColor("xormite", "", 0);                              CargoContains = "XormiteOre";           CargoQty = (int)(CargoValue / 48);
            }
            else if (rare <= 4)
            {
                CargoMaterial = 12; Name = "crate of mithril ore"; Hue = MaterialInfo.GetMaterialColor("mithril", "", 0);                              CargoContains = "MithrilOre";           CargoQty = (int)(CargoValue / 48);
            }
            else if (rare <= 8)
            {
                CargoMaterial = 11; Name = "crate of obsidian ore"; Hue = MaterialInfo.GetMaterialColor("obsidian", "", 0);                    CargoContains = "ObsidianOre";          CargoQty = (int)(CargoValue / 36);
            }
            else if (rare <= 16)
            {
                CargoMaterial = 10; Name = "crate of nepturite ore"; Hue = MaterialInfo.GetMaterialColor("nepturite", "", 0);                 CargoContains = "NepturiteOre";         CargoQty = (int)(CargoValue / 36);
            }
            else if (rare <= 32)
            {
                CargoMaterial = 9; Name = "crate of valorite ore"; Hue = MaterialInfo.GetMaterialColor("valorite", "", 0);                    CargoContains = "ValoriteOre";          CargoQty = (int)(CargoValue / 36);
            }
            else if (rare <= 64)
            {
                CargoMaterial = 8; Name = "crate of verite ore"; Hue = MaterialInfo.GetMaterialColor("verite", "", 0);                                CargoContains = "VeriteOre";            CargoQty = (int)(CargoValue / 32);
            }
            else if (rare <= 128)
            {
                CargoMaterial = 7; Name = "crate of agapite ore"; Hue = MaterialInfo.GetMaterialColor("agapite", "", 0);                     CargoContains = "AgapiteOre";           CargoQty = (int)(CargoValue / 28);
            }
            else if (rare <= 256)
            {
                CargoMaterial = 6; Name = "crate of gold ore"; Hue = MaterialInfo.GetMaterialColor("gold", "", 0);                                   CargoContains = "GoldOre";                      CargoQty = (int)(CargoValue / 24);
            }
            else if (rare <= 512)
            {
                CargoMaterial = 5; Name = "crate of bronze ore"; Hue = MaterialInfo.GetMaterialColor("bronze", "", 0);                               CargoContains = "BronzeOre";            CargoQty = (int)(CargoValue / 20);
            }
            else if (rare <= 1024)
            {
                CargoMaterial = 4; Name = "crate of copper ore"; Hue = MaterialInfo.GetMaterialColor("copper", "", 0);                              CargoContains = "CopperOre";            CargoQty = (int)(CargoValue / 16);
            }
            else if (rare <= 2048)
            {
                CargoMaterial = 3; Name = "crate of shadow iron ore"; Hue = MaterialInfo.GetMaterialColor("shadow iron", "", 0);    CargoContains = "ShadowIronOre";        CargoQty = (int)(CargoValue / 12);
            }
            else if (rare <= 4096)
            {
                CargoMaterial = 2; Name = "crate of dull copper ore"; Hue = MaterialInfo.GetMaterialColor("dull copper", "", 0);    CargoContains = "DullCopperOre";        CargoQty = (int)(CargoValue / 8);
            }
            else
            {
                CargoMaterial = 1; ItemID = 0x5084; Name = "crate of iron ore"; CargoContains = "IronOre";       CargoQty = (int)(CargoValue / 5);
            }
        }
        ...
        {
            CargoVendor = "Tailor"; ItemID = 0x5089; Name = "crate of cloth"; CargoBox = 2; Hue = Utility.RandomColor(0); CargoHue = Hue; CargoContains = "BoltOfCloth"; CargoQty = (int)(CargoValue / 50);
        }
        else if (CargoType == 31)
        {
            CargoVendor = "Provisioner"; ItemID = 0x508A; Name = "crate of pouches"; CargoContains = "Pouch"; CargoQty = (int)(CargoValue / 5);
        }
        else if (CargoType == 32)
        {
            CargoVendor = "Alchemist or Herbalist"; ItemID = 0x5090; Name = "crate of bottles"; CargoContains = "Bottle"; CargoQty = (int)(CargoValue / 5);
        }
        else if (CargoType == 33)
        {
            ...
            if (rare <= 1)
            {
                CargoMaterial = 5; Name = "crate of lethal venom sacks"; CargoQty = (int)(CargoValue / 75);
            }
            else if (rare <= 2)
            {
                CargoMaterial = 4; Name = "crate of deadly venom sacks"; CargoQty = (int)(CargoValue / 60);
            }
            else if (rare <= 4)
            {
                CargoMaterial = 3; Name = "crate of greater venom sacks"; CargoQty = (int)(CargoValue / 45);
            }
            else if (rare <= 8)
            {
                CargoMaterial = 2; Name = "crate of venom sacks"; CargoQty = (int)(CargoValue / 30);
            }
            else
            {
                CargoMaterial = 1; Name = "crate of lesser venom sacks"; CargoQty = (int)(CargoValue / 15);
            }
        }
        else if (CargoType == 34)
        {
            CargoVendor = "Butcher"; ItemID = 0x50A8; Name = "crate of cleavers"; CargoContains = "Cleaver"; CargoQty = (int)(CargoValue / 15);
        }
        else if (CargoType == 35)
        {
            CargoVendor = "Art Collector"; ItemID = 0x50A9; Name = "crated stone bust"; Hue = Utility.RandomColor(0); CargoHue = Hue; CargoContains = "DDRelicStatue"; CargoQty = 1;
        }
        else if (CargoType == 36)
        {
            CargoVendor = "Sage"; ItemID = 0x50AB; Name = "crate of books"; CargoContains = "TanBook"; CargoQty = (int)(CargoValue / 15);
        }
        else if (CargoType == 37)
        {
            CargoVendor = "Provisioner"; ItemID = 0x50A0; Name = "crate of torches"; CargoContains = "Torch"; CargoQty = (int)(CargoValue / 8);
        }
        ...
        {
            CargoVendor = "Beekeeper"; ItemID = 0x50AC; Name = "crate of candles"; CargoContains = "CandleLong"; CargoQty = (int)(CargoValue / 6);
        }
        else if (CargoType == 40)
        {
            CargoVendor = "Healer"; ItemID = 0x5087; Name = "crate of bandages"; if (Utility.RandomBool())
            {
                ItemID = 0x50A6;
            }
            CargoContains = "Bandage"; CargoQty = (int)(CargoValue / 5);
        }
        ...
        {
            CargoVendor = "Scribe"; ItemID = 0x509E; Name = "crate of blank scrolls"; if (Utility.RandomBool())
            {
                ItemID = 0x50A5;
            }
            CargoContains = "BlankScroll"; CargoQty = (int)(CargoValue / 5);
        }
        ...
        else if (CargoType == 46)
        {
            ...
            if (rare <= 1)
            {
                CargoMaterial = 16; Name = "crate of dwarven ingots"; Hue = MaterialInfo.GetMaterialColor("dwarven", "", 0);                                        CargoContains = "DwarvenIngot";         CargoQty = (int)(CargoValue / 96);
            }
            else if (rare <= 2)
            {
                CargoMaterial = 15; Name = "crate of xormite ingots"; Hue = MaterialInfo.GetMaterialColor("xormite", "", 0);                           CargoContains = "XormiteIngot";         CargoQty = (int)(CargoValue / 48);
            }
            else if (rare <= 4)
            {
                CargoMaterial = 14; Name = "crate of mithril ingots"; Hue = MaterialInfo.GetMaterialColor("mithril", "", 0);                           CargoContains = "MithrilIngot";         CargoQty = (int)(CargoValue / 48);
            }
            else if (rare <= 8)
            {
                CargoMaterial = 13; Name = "crate of brass ingots"; Hue = MaterialInfo.GetMaterialColor("brass", "", 0);                                       CargoContains = "BrassIngot";           CargoQty = (int)(CargoValue / 44);
            }
            else if (rare <= 16)
            {
                CargoMaterial = 12; Name = "crate of steel ingots"; Hue = MaterialInfo.GetMaterialColor("steel", "", 0);                                      CargoContains = "SteelIngot";           CargoQty = (int)(CargoValue / 40);
            }
            else if (rare <= 32)
            {
                CargoMaterial = 11; Name = "crate of obsidian ingots"; Hue = MaterialInfo.GetMaterialColor("obsidian", "", 0);                        CargoContains = "ObsidianIngot";        CargoQty = (int)(CargoValue / 36);
            }
            else if (rare <= 64)
            {
                CargoMaterial = 10; Name = "crate of nepturite ingots"; Hue = MaterialInfo.GetMaterialColor("nepturite", "", 0);                      CargoContains = "NepturiteIngot";       CargoQty = (int)(CargoValue / 36);
            }
            else if (rare <= 128)
            {
                CargoMaterial = 9; Name = "crate of valorite ingots"; Hue = MaterialInfo.GetMaterialColor("valorite", "", 0);                        CargoContains = "ValoriteIngot";        CargoQty = (int)(CargoValue / 36);
            }
            else if (rare <= 256)
            {
                CargoMaterial = 8; Name = "crate of verite ingots"; Hue = MaterialInfo.GetMaterialColor("verite", "", 0);                            CargoContains = "VeriteIngot";          CargoQty = (int)(CargoValue / 32);
            }
            else if (rare <= 512)
            {
                CargoMaterial = 7; Name = "crate of agapite ingots"; Hue = MaterialInfo.GetMaterialColor("agapite", "", 0);                          CargoContains = "AgapiteIngot";         CargoQty = (int)(CargoValue / 28);
            }
            else if (rare <= 1024)
            {
                CargoMaterial = 6; Name = "crate of gold ingots"; Hue = MaterialInfo.GetMaterialColor("gold", "", 0);                                       CargoContains = "GoldIngot";            CargoQty = (int)(CargoValue / 24);
            }
            else if (rare <= 2048)
            {
                CargoMaterial = 5; Name = "crate of bronze ingots"; Hue = MaterialInfo.GetMaterialColor("bronze", "", 0);                           CargoContains = "BronzeIngot";          CargoQty = (int)(CargoValue / 20);
            }
            else if (rare <= 4096)
            {
                CargoMaterial = 4; Name = "crate of copper ingots"; Hue = MaterialInfo.GetMaterialColor("copper", "", 0);                           CargoContains = "CopperIngot";          CargoQty = (int)(CargoValue / 16);
            }
            else if (rare <= 8192)
            {
                CargoMaterial = 3; Name = "crate of shadow iron ingots"; Hue = MaterialInfo.GetMaterialColor("shadow iron", "", 0);         CargoContains = "ShadowIronIngot";      CargoQty = (int)(CargoValue / 12);
            }
            else if (rare <= 16384)
            {
                CargoMaterial = 2; Name = "crate of dull copper ingots"; Hue = MaterialInfo.GetMaterialColor("dull copper", "", 0);        CargoContains = "DullCopperIngot";      CargoQty = (int)(CargoValue / 8);
            }
            else
            {
                CargoMaterial = 2; ItemID = 0x5094; Name = "crate of iron ingots";                                                                                                                                                       CargoContains = "IronIngot";            CargoQty = (int)(CargoValue / 5);
            }
        }
        else if (CargoType == 47)
        {
            ...
            if (rare <= 1)
            {
                CargoMaterial = 12; Name = "crate of alien hides"; Hue = MaterialInfo.GetMaterialColor("alien", "", 0);                                     CargoContains = "AlienHides";           CargoQty = (int)(CargoValue / 14);
            }
            else if (rare <= 2)
            {
                CargoMaterial = 11; Name = "crate of dinosaur hides"; Hue = MaterialInfo.GetMaterialColor("dinosaur", "", 0);          CargoContains = "DinosaurHides";        CargoQty = (int)(CargoValue / 14);
            }
            else if (rare <= 4)
            {
                CargoMaterial = 10; Name = "crate of hellish hides"; Hue = MaterialInfo.GetMaterialColor("hellish", "", 0);            CargoContains = "HellishHides";         CargoQty = (int)(CargoValue / 14);
            }
            else if (rare <= 8)
            {
                CargoMaterial = 9; Name = "crate of draconic hides"; Hue = MaterialInfo.GetMaterialColor("draconic", "", 0);           CargoContains = "DraconicHides";        CargoQty = (int)(CargoValue / 12);
            }
            else if (rare <= 16)
            {
                CargoMaterial = 8; Name = "crate of goliath hides"; Hue = MaterialInfo.GetMaterialColor("goliath", "", 0);            CargoContains = "GoliathHides";         CargoQty = (int)(CargoValue / 12);
            }
            else if (rare <= 32)
            {
                CargoMaterial = 7; Name = "crate of frozen hides"; Hue = MaterialInfo.GetMaterialColor("frozen", "", 0);                      CargoContains = "FrozenHides";          CargoQty = (int)(CargoValue / 10);
            }
            else if (rare <= 64)
            {
                CargoMaterial = 6; Name = "crate of volcanic hides"; Hue = MaterialInfo.GetMaterialColor("volcanic", "", 0);          CargoContains = "VolcanicHides";        CargoQty = (int)(CargoValue / 10);
            }
            else if (rare <= 128)
            {
                CargoMaterial = 5; Name = "crate of necrotic hides"; Hue = MaterialInfo.GetMaterialColor("necrotic", "", 0);         CargoContains = "NecroticHides";        CargoQty = (int)(CargoValue / 8);
            }
            else if (rare <= 256)
            {
                CargoMaterial = 4; Name = "crate of serpent hides"; Hue = MaterialInfo.GetMaterialColor("serpent", "", 0);           CargoContains = "BarbedHides";          CargoQty = (int)(CargoValue / 8);
            }
            else if (rare <= 512)
            {
                CargoMaterial = 3; Name = "crate of lizard hides"; Hue = MaterialInfo.GetMaterialColor("lizard", "", 0);                     CargoContains = "HornedHides";          CargoQty = (int)(CargoValue / 6);
            }
            else if (rare <= 1024)
            {
                CargoMaterial = 2; Name = "crate of deep sea hides"; Hue = MaterialInfo.GetMaterialColor("deep sea", "", 0);        CargoContains = "SpinedHides";          CargoQty = (int)(CargoValue / 6);
            }
            else
            {
                CargoMaterial = 1; ItemID = 0x5092; Name = "crate of hides";                                                                                                                                                     CargoContains = "Hides";                        CargoQty = (int)(CargoValue / 5);
            }
        }
        else if (CargoType == 48)
        {
            ...
            if (logger == 2)
            {
                ItemID = 0x5096; woods = "logs"; ordin = 0x5097; CargoBox = 2;
            }
            ...
            if (rare <= 1)
            {
                CargoMaterial = 15; Name = "crate of elven " + woods; Hue = MaterialInfo.GetMaterialColor("elven", "", 0);                                          CargoContains = "ElvenBoard";           if (logger == 2)
                {
            ...
            {
                CargoMaterial = 14; Name = "crate of driftwood " + woods; Hue = MaterialInfo.GetMaterialColor("driftwood", "", 0);                     CargoContains = "DriftwoodBoard";       if (logger == 2)
                {
            ...
            {
                CargoMaterial = 13; Name = "crate of petrified " + woods; Hue = MaterialInfo.GetMaterialColor("petrified", "", 0);                     CargoContains = "PetrifiedBoard";       if (logger == 2)
                {
            ...
            {
                CargoMaterial = 12; Name = "crate of walnut " + woods; Hue = MaterialInfo.GetMaterialColor("walnut", "", 0);                           CargoContains = "WalnutBoard";          if (logger == 2)
                {
            ...
            {
                CargoMaterial = 11; Name = "crate of rosewood " + woods; Hue = MaterialInfo.GetMaterialColor("rosewood", "", 0);                      CargoContains = "RosewoodBoard";        if (logger == 2)
                {
            ...
            {
                CargoMaterial = 10; Name = "crate of ghostwood " + woods; Hue = MaterialInfo.GetMaterialColor("ghostwood", "", 0);            CargoContains = "GhostBoard";           if (logger == 2)
                {
            ...
            {
                CargoMaterial = 9; Name = "crate of pine " + woods; Hue = MaterialInfo.GetMaterialColor("pine", "", 0);                                       CargoContains = "PineBoard";            if (logger == 2)
                {
            ...
            {
                CargoMaterial = 8; Name = "crate of oak " + woods; Hue = MaterialInfo.GetMaterialColor("oak", "", 0);                                        CargoContains = "OakBoard";             if (logger == 2)
                {
            ...
            {
                CargoMaterial = 7; Name = "crate of mahogany " + woods; Hue = MaterialInfo.GetMaterialColor("mahogany", "", 0);                      CargoContains = "MahoganyBoard";        if (logger == 2)
                {
            ...
            {
                CargoMaterial = 6; Name = "crate of hickory " + woods; Hue = MaterialInfo.GetMaterialColor("hickory", "", 0);                        CargoContains = "HickoryBoard";         if (logger == 2)
                {
            ...
            {
                CargoMaterial = 5; Name = "crate of golden oak " + woods; Hue = MaterialInfo.GetMaterialColor("golden oak", "", 0);         CargoContains = "GoldenOakBoard";       if (logger == 2)
                {
            ...
            {
                CargoMaterial = 4; Name = "crate of ebony " + woods; Hue = MaterialInfo.GetMaterialColor("ebony", "", 0);                           CargoContains = "EbonyBoard";           if (logger == 2)
                {
            ...
            {
                CargoMaterial = 3; Name = "crate of cherry " + woods; Hue = MaterialInfo.GetMaterialColor("cherry", "", 0);                         CargoContains = "CherryBoard";          if (logger == 2)
                {
            ...
            {
                CargoMaterial = 2; Name = "crate of ash " + woods; Hue = MaterialInfo.GetMaterialColor("ash", "", 0);                                       CargoContains = "AshBoard";             if (logger == 2)
                {
            ...
            {
                CargoMaterial = 1; ItemID = ordin; Name = "crate of " + woods;                                                                                                                                                           CargoContains = "Board";                        if (logger == 2)
                {
                    CargoContains = "Log";
                }
                CargoQty = (int)(CargoValue / 5);
        ...
        else if (CargoType == 49)
        {
            ...
            if (rare <= 1)
            {
                CargoMaterial = 7; Name = "crate of dinosaur scales";   Hue = 0x430;    CargoContains = "DinosaurScales";       CargoQty = (int)(CargoValue / 36);
            }
            else if (rare <= 4)
            {
                CargoMaterial = 6; Name = "crate of blue scales";               Hue = 0x8B0;    CargoContains = "BlueScales";           CargoQty = (int)(CargoValue / 32);
            }
            else if (rare <= 8)
            {
                CargoMaterial = 5; Name = "crate of white scales";              Hue = 0x8FD;    CargoContains = "WhiteScales";          CargoQty = (int)(CargoValue / 28);
            }
            else if (rare <= 16)
            {
                CargoMaterial = 4; Name = "crate of green scales";              Hue = 0x851;    CargoContains = "GreenScales";          CargoQty = (int)(CargoValue / 24);
            }
            else if (rare <= 32)
            {
                CargoMaterial = 3; Name = "crate of black scales";              Hue = 0x455;    CargoContains = "BlackScales";          CargoQty = (int)(CargoValue / 20);
            }
            else if (rare <= 64)
            {
                CargoMaterial = 2; Name = "crate of yellow scales";     Hue = 0x8A8;    CargoContains = "YellowScales";         CargoQty = (int)(CargoValue / 16);
            }
            else
            {
                CargoMaterial = 1; Name = "crate of red scales";                Hue = 0x66D;    CargoContains = "RedScales";            CargoQty = (int)(CargoValue / 12);
            }
        }
    ...
    public static void GiveCargo(Cargo cargo, Mobile vendor, Mobile player)
    {
        if (VendorTest(cargo, vendor))
        {
            ...
            int fame = cargo.CargoKarma; if (fame < 0)
            {
                fame = fame * -1;
            }
    ...
    {
        if (cargo.CargoVendor == "Alchemist or Herbalist" && (vendor is AlchemistGuildmaster || vendor is Alchemist || vendor is Herbalist))
        {
            return true;
        }
        ...
        else if (cargo.CargoVendor == "Banker or Minter" && (vendor is Banker || vendor is Minter))
        {
            return true;
        }
        ...
        else if (cargo.CargoVendor == "Blacksmith" && (vendor is BlacksmithGuildmaster || vendor is Blacksmith))
        {
            return true;
        }
        ...
        else if (cargo.CargoVendor == "Carpenter" && (vendor is CarpenterGuildmaster || vendor is Carpenter))
        {
            return true;
        }
        ...
        else if (cargo.CargoVendor == "Healer" && (vendor is HealerGuildmaster || vendor is Healer))
        {
            return true;
        }
        ...
        else if (cargo.CargoVendor == "Leatherworker or Tanner" && (vendor is Tanner || vendor is LeatherWorker))
        {
            return true;
        }
        ...
        else if (cargo.CargoVendor == "Mapmaker" && (vendor is CartographersGuildmaster || vendor is Mapmaker))
        {
            return true;
        }
        else if (cargo.CargoVendor == "Necromancer or Witch" && (vendor is NecroMage || vendor is NecromancerGuildmaster || vendor is Necromancer || vendor is Witches))
        {
            return true;
        }
        ...
        else if (cargo.CargoVendor == "Scribe" && (vendor is LibrarianGuildmaster || vendor is Scribe))
        {
            return true;
        }
        else if (cargo.CargoVendor == "Shipwright" && (vendor is FisherGuildmaster || vendor is Shipwright))
        {
            return true;
        }
        else if (cargo.CargoVendor == "Stable Worker" && (vendor is Veterinarian || vendor is Rancher || vendor is AnimalTrainer))
        {
            return true;
        }
        else if (cargo.CargoVendor == "Tailor" && (vendor is TailorGuildmaster || vendor is Tailor))
        {
            return true;
        }
        else if (cargo.CargoVendor == "Tavern or Bar Keeper" && (vendor is Barkeeper || vendor is TavernKeeper))
        {
            return true;
        }
        else if (cargo.CargoVendor == "Thief or Assassin" && (vendor is AssassinGuildmaster || vendor is Thief || vendor is ThiefGuildmaster))
        {
            return true;
        }
        else if (cargo.CargoVendor == "Tinker" && (vendor is TinkerGuildmaster || vendor is Tinker))
        {
            return true;
        }
        else if (cargo.CargoVendor == "Weaponsmith or Armorer" && (vendor is Armorer || vendor is Weaponsmith))
        {
            return true;
        }
    ...
    {
        return (int)((cargo.CargoValue * (player.Skills[SkillName.Seafaring].Value * 0.01) / 3));
    }

    public static int CargoMerchantGold(Cargo cargo, Mobile player)
    {
        return (int)((cargo.CargoValue * (player.Skills[SkillName.Mercantile].Value * 0.01) / 3));
    }
    ...
    public static int CargoBeggingGold(Cargo cargo, Mobile player)
    {
        ...
        {
            return (int)((cargo.CargoValue * (player.Skills[SkillName.Begging].Value * 0.01) / 3));
        }
        return 0;
    }
    ...
    {
        PlayerMobile pm = (PlayerMobile)player; if (pm.NpcGuild == NpcGuild.FishermensGuild)
        {
