...
public class Plank : Item, ILockable
{
    ...
    public BaseBoat Boat {
        get { return m_Boat; } set { m_Boat = value; }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public PlankSide Side {
        get { return m_Side; } set { m_Side = value; }
    }
    ...
    [CommandProperty(AccessLevel.GameMaster)]
    public bool IsOpen {
        get { return ItemID == 0x5435 || ItemID == 0x5436 || ItemID == 0x5437 || ItemID == 0x5438 || ItemID == 0x3ED5 || ItemID == 0x3ED4 || ItemID == 0x3E84 || ItemID == 0x3E89; }
    }
