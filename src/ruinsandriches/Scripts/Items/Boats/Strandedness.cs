...
public class Strandedness
{
    ...
    public static void CabinGoneByeBye(Mobile from, string world)
    {
        ...
        {
            list = m_Lodor; map = Map.Lodor;
        }
        else if (world == "the Serpent Island")
        {
            list = m_SerpentIsland; map = Map.SerpentIsland;
        }
        else if (world == "the Isles of Dread")
        {
            list = m_IslesDread; map = Map.IslesDread;
        }
        else if (world == "the Savaged Empire")
        {
            list = m_SavagedEmpire; map = Map.SavagedEmpire;
        }
        else if (world == "the Bottle World of Kuldar")
        {
            list = m_Bottle; map = Map.Sosaria;
        }
        else if (world == "the Island of Umber Veil")
        {
            list = m_Umber; map = Map.Sosaria;
        }
        else if (world == "the Land of Ambrosia")
        {
            list = m_Ambrosia; map = Map.Sosaria;
        }
        else if (world == "the Underworld")
        {
            list = m_Underworld; map = Map.Underworld;
        }
        else
        {
            list = m_Sosaria; map = Map.Sosaria;
        }
