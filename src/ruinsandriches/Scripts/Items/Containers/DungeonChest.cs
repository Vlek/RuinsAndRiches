...
public class DungeonChest : LockableContainer
{
    ...
    public int Container_ID {
        get { return ContainerID; } set { ContainerID = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Container_Gump {
        get { return ContainerGump; } set { ContainerGump = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Container_Hue {
        get { return ContainerHue; } set { ContainerHue = value; InvalidateProperties(); }
    }
    ...
    public double Container_Weight {
        get { return ContainerWeight; } set { ContainerWeight = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Container_Name {
        get { return ContainerName; } set { ContainerName = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Container_Level {
        get { return ContainerLevel; } set { ContainerLevel = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Container_Touched {
        get { return ContainerTouched; } set { ContainerTouched = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Container_NoSpawn {
        get { return ContainerNoSpawn; } set { ContainerNoSpawn = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Container_Lockable {
        get { return ContainerLockable; } set { ContainerLockable = value; InvalidateProperties(); }
    }
    ...
    public DungeonChest(int level) : base(0xe43)
    {
        if (level == 99)
        {
            level = Utility.RandomMinMax(1, 3); ContainerNoSpawn = 1;
        }
        if (level > 10)
        {
            level = 10;
...
public class DungeonChestSpawner : Item
{
    ...
    public int Spawner_Level {
        get { return SpawnerLevel; } set { SpawnerLevel = value; InvalidateProperties(); }
    }
