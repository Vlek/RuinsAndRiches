...
/* DO NOTHING */
        ...
        {
            GumpID = 0x9; DropSound = 0x42;
        }
        else if (ItemID == 0xE76 || ItemID == 0x2256 || ItemID == 0x2257 || ItemID == 0x5777 || ItemID == 0x5776 || ItemID == 0x1E3F || ItemID == 0x1E52 || ItemID == 0x55DD || ItemID == 0x577E || ItemID == 0x1248 || ItemID == 0x1264 || ItemID == 0x541E || ItemID == 0x541F)
        {
            GumpID = 0x3D; DropSound = 0x48;
        }
        else if (ItemID == 0xE77 || ItemID == 0xE7F || ItemID == 0xFAE || ItemID == 0xE83 || ItemID == 0x4D05 || ItemID == 0x4D06 || ItemID == 0x50AF || ItemID == 0x50B0 || ItemID == 0x50B1 || ItemID == 0x50B2 || ItemID == 0x50B4 || ItemID == 0x50B6 || ItemID == 0x50B7 || ItemID == 0x50B8 || ItemID == 0x50BC || ItemID == 0x50BD || ItemID == 0x50BE || ItemID == 0x50BF || ItemID == 0x50C0 || ItemID == 0x50C1 || ItemID == 0x50C2 || ItemID == 0x50C3 || ItemID == 0x0C0F || ItemID == 0x0DB6)
        {
            GumpID = 0x3E; DropSound = 0x42;
        }
        else if (ItemID == 0xE7A || ItemID == 0x24D5 || ItemID == 0x24D6 || ItemID == 0x24D9 || ItemID == 0x24DA)
        {
            GumpID = 0x3F; DropSound = 0x4F;
        }
        else if (ItemID == 0x990 || ItemID == 0x9AC || ItemID == 0x9B1 || ItemID == 0x24D7 || ItemID == 0x24D8 || ItemID == 0x24DD)
        {
            GumpID = 0x41; DropSound = 0x4F;
        }
        ...
        {
            GumpID = 0x989; DropSound = 0x42;
        }
        else if (ItemID == 0x52FB || ItemID == 0x52FD || ItemID == 0x281F || ItemID == 0x2820 || ItemID == 0x2821 || ItemID == 0x2822 || ItemID == 0x2823 || ItemID == 0x2824 || ItemID == 0x2825 || ItemID == 0x2826 || ItemID == 0x4FE6 || ItemID == 0x4FE7)
        {
            GumpID = 0x2810; DropSound = 0x22B;
        }
        else if (ItemID == 0x2800 || ItemID == 0x2801 || ItemID == 0x27E9 || ItemID == 0x27EA)
        {
            GumpID = 0x41D; DropSound = 0x42;
        }
        else if (ItemID == 0x0ECA || ItemID == 0x0ECB || ItemID == 0x0ECC || ItemID == 0x0ECD || ItemID == 0x0ECE || ItemID == 0x0ECF || ItemID == 0x0ED0 || ItemID == 0x0ED1 || ItemID == 0x0ED2 || ItemID == 0x1236 || ItemID == 0x123F)
        {
            GumpID = 0x2A73; DropSound = 0x48;
        }
        else if (this is SmallHollowBook || this is LargeHollowBook)
        {
            GumpID = 0x2A74; DropSound = 0x42;
        }
    }
}
...
public class SmallHollowBook : BaseContainer
{
    ...
    public string Authors {
        get { return Author; } set { Author = value; InvalidateProperties(); }
    }
