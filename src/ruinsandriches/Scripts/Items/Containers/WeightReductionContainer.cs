...
public class SmallBagofHolding : WeightReductionContainer
{
    ...
    public override string AccessDelayMessage {
        get { return "The rift in the nether that separates the dimensions has that stabilized yet."; }
    }
    public override string AddAccessMessage {
        get { return "You slip your hand through the nether to place an item into another dimension."; }
    }
    public override string RemoveAccessMessage {
        get { return "You slip your hand through the nether to retrieve an item from another dimension."; }
    }
...
{
    public abstract double WeightReductionAmount {
        get;
    }
    public abstract int ContainerMaxItems {
        get;
    }
    ...
    public new int MaxItems {
        get { return ContainerMaxItems; } set { base.MaxItems = ContainerMaxItems; }
    }
