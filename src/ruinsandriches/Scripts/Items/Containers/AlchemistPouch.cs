...
public class AlchemistPouch : Bag
{
    ...
    public class ChemistBar : Gump
    {
        ...
        public ChemistBar(Mobile from, AlchemistPouch bag, bool vertical) : base(50, 50)
        {
            ...
            if (vertical)
            {
                ...
                btn++; img++; if (bag.v_01_Agility > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                {
                    abs = 33; val = 0;
                }
                btn++; img++; if (bag.v_02_GreaterAgility > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_03_Conflagration > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_04_GreaterConflagration > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_05_ConfusionBlast > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_06_GreaterConfusionBlast > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_07_LesserCure > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_09_GreaterCure > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_10_LesserExplosion > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_11_Explosion > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_12_GreaterExplosion > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_13_Frostbite > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_14_GreaterFrostbite > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_15_LesserHeal > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_17_GreaterHeal > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_18_LesserInvisibility > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_19_Invisibility > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_20_GreaterInvisibility > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_21_Invulnerability > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_22_LesserMana > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_24_GreaterMana > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_25_NightSight > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_27_TotalRefresh > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_28_LesserRejuvenate > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_29_Rejuvenate > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_30_GreaterRejuvenate > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_31_Strength > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                ...
                btn++; img++; if (bag.v_32_GreaterStrength > 0)
                {
                    cyc++; val = val + mod; AddButton(abs, val, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
            ...
            else
            {
                ...
                btn++; img++; if (bag.v_01_Agility > 0)
                {
                    cyc++; val = val + mod; AddButton(val, abs, img, img, btn, GumpButtonType.Reply, 0);
                }
                if (cyc > 15 && abs == 0)
                {
                    abs = 34; val = 0;
            ...
            if (bag.Titles > 0)
            {
                ...
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"Ag"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_02_GreaterAgility > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"AgG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_03_Conflagration > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"Cf"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_04_GreaterConflagration > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"CfG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_05_ConfusionBlast > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"Cb"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_06_GreaterConfusionBlast > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"CbG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_07_LesserCure > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"CuL"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_08_Cure > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"Cu"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_09_GreaterCure > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"CuG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_10_LesserExplosion > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"ExL"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_11_Explosion > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"Ex"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_12_GreaterExplosion > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"ExG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_13_Frostbite > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"Fb"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_14_GreaterFrostbite > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"FbG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_15_LesserHeal > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"HeL"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_16_Heal > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"He"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_17_GreaterHeal > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"HeG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_18_LesserInvisibility > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"InL"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_19_Invisibility > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"InG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_20_GreaterInvisibility > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"In"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_21_Invulnerability > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"<->"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_22_LesserMana > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"MnL"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_23_Mana > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"Mn"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_24_GreaterMana > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"MnG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_25_NightSight > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"NiS"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_26_Refresh > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"Rf"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_27_TotalRefresh > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"RfT"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_28_LesserRejuvenate > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"RjL"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_29_Rejuvenate > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"Rj"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_30_GreaterRejuvenate > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"RjG"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_31_Strength > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"St"); cyc++; hue = nameColor(hue);
                }
                if (bag.v_32_GreaterStrength > 0)
                {
                    AddLabel(cordVal(cyc, overHalf, vertical, 0), cordVal(cyc, overHalf, vertical, 1), hue, @"StG"); cyc++; hue = nameColor(hue);
                }
            }
        }
    ...
    public int m_01_Agility {
        get { return v_01_Agility; } set { v_01_Agility = value; InvalidateProperties(); }
    }

    public int v_02_GreaterAgility;
    [CommandProperty(AccessLevel.Owner)]
    public int m_02_GreaterAgility {
        get { return v_02_GreaterAgility; } set { v_02_GreaterAgility = value; InvalidateProperties(); }
    }

    public int v_03_Conflagration;
    [CommandProperty(AccessLevel.Owner)]
    public int m_03_Conflagration {
        get { return v_03_Conflagration; } set { v_03_Conflagration = value; InvalidateProperties(); }
    }

    public int v_04_GreaterConflagration;
    [CommandProperty(AccessLevel.Owner)]
    public int m_04_GreaterConflagration {
        get { return v_04_GreaterConflagration; } set { v_04_GreaterConflagration = value; InvalidateProperties(); }
    }

    public int v_05_ConfusionBlast;
    [CommandProperty(AccessLevel.Owner)]
    public int m_05_ConfusionBlast {
        get { return v_05_ConfusionBlast; } set { v_05_ConfusionBlast = value; InvalidateProperties(); }
    }

    public int v_06_GreaterConfusionBlast;
    [CommandProperty(AccessLevel.Owner)]
    public int m_06_GreaterConfusionBlast {
        get { return v_06_GreaterConfusionBlast; } set { v_06_GreaterConfusionBlast = value; InvalidateProperties(); }
    }

    public int v_07_LesserCure;
    [CommandProperty(AccessLevel.Owner)]
    public int m_07_LesserCure {
        get { return v_07_LesserCure; } set { v_07_LesserCure = value; InvalidateProperties(); }
    }

    public int v_08_Cure;
    [CommandProperty(AccessLevel.Owner)]
    public int m_08_Cure {
        get { return v_08_Cure; } set { v_08_Cure = value; InvalidateProperties(); }
    }

    public int v_09_GreaterCure;
    [CommandProperty(AccessLevel.Owner)]
    public int m_09_GreaterCure {
        get { return v_09_GreaterCure; } set { v_09_GreaterCure = value; InvalidateProperties(); }
    }

    public int v_10_LesserExplosion;
    [CommandProperty(AccessLevel.Owner)]
    public int m_10_LesserExplosion {
        get { return v_10_LesserExplosion; } set { v_10_LesserExplosion = value; InvalidateProperties(); }
    }

    public int v_11_Explosion;
    [CommandProperty(AccessLevel.Owner)]
    public int m_11_Explosion {
        get { return v_11_Explosion; } set { v_11_Explosion = value; InvalidateProperties(); }
    }

    public int v_12_GreaterExplosion;
    [CommandProperty(AccessLevel.Owner)]
    public int m_12_GreaterExplosion {
        get { return v_12_GreaterExplosion; } set { v_12_GreaterExplosion = value; InvalidateProperties(); }
    }

    public int v_13_Frostbite;
    [CommandProperty(AccessLevel.Owner)]
    public int m_13_Frostbite {
        get { return v_13_Frostbite; } set { v_13_Frostbite = value; InvalidateProperties(); }
    }

    public int v_14_GreaterFrostbite;
    [CommandProperty(AccessLevel.Owner)]
    public int m_14_GreaterFrostbite {
        get { return v_14_GreaterFrostbite; } set { v_14_GreaterFrostbite = value; InvalidateProperties(); }
    }

    public int v_15_LesserHeal;
    [CommandProperty(AccessLevel.Owner)]
    public int m_15_LesserHeal {
        get { return v_15_LesserHeal; } set { v_15_LesserHeal = value; InvalidateProperties(); }
    }

    public int v_16_Heal;
    [CommandProperty(AccessLevel.Owner)]
    public int m_16_Heal {
        get { return v_16_Heal; } set { v_16_Heal = value; InvalidateProperties(); }
    }

    public int v_17_GreaterHeal;
    [CommandProperty(AccessLevel.Owner)]
    public int m_17_GreaterHeal {
        get { return v_17_GreaterHeal; } set { v_17_GreaterHeal = value; InvalidateProperties(); }
    }

    public int v_18_LesserInvisibility;
    [CommandProperty(AccessLevel.Owner)]
    public int m_18_LesserInvisibility {
        get { return v_18_LesserInvisibility; } set { v_18_LesserInvisibility = value; InvalidateProperties(); }
    }

    public int v_19_Invisibility;
    [CommandProperty(AccessLevel.Owner)]
    public int m_19_Invisibility {
        get { return v_19_Invisibility; } set { v_19_Invisibility = value; InvalidateProperties(); }
    }

    public int v_20_GreaterInvisibility;
    [CommandProperty(AccessLevel.Owner)]
    public int m_20_GreaterInvisibility {
        get { return v_20_GreaterInvisibility; } set { v_20_GreaterInvisibility = value; InvalidateProperties(); }
    }

    public int v_21_Invulnerability;
    [CommandProperty(AccessLevel.Owner)]
    public int m_21_Invulnerability {
        get { return v_21_Invulnerability; } set { v_21_Invulnerability = value; InvalidateProperties(); }
    }
    ...
    public int m_23_Mana {
        get { return v_23_Mana; } set { v_23_Mana = value; InvalidateProperties(); }
    }

    public int v_24_GreaterMana;
    [CommandProperty(AccessLevel.Owner)]
    public int m_24_GreaterMana {
        get { return v_24_GreaterMana; } set { v_24_GreaterMana = value; InvalidateProperties(); }
    }
    ...
    public int m_26_Refresh {
        get { return v_26_Refresh; } set { v_26_Refresh = value; InvalidateProperties(); }
    }

    public int v_27_TotalRefresh;
    [CommandProperty(AccessLevel.Owner)]
    public int m_27_TotalRefresh {
        get { return v_27_TotalRefresh; } set { v_27_TotalRefresh = value; InvalidateProperties(); }
    }
    ...
    public int m_30_GreaterRejuvenate {
        get { return v_30_GreaterRejuvenate; } set { v_30_GreaterRejuvenate = value; InvalidateProperties(); }
    }
    ...
    public int m_32_GreaterStrength {
        get { return v_32_GreaterStrength; } set { v_32_GreaterStrength = value; InvalidateProperties(); }
    }
}
}
