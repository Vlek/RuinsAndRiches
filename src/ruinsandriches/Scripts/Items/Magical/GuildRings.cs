...
public class GuildRings : GoldRing
{
    ...
    public Mobile Ring_Owner {
        get { return RingOwner; } set { RingOwner = value; }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Ring_Guild {
        get { return RingGuild; } set { RingGuild = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Ring_Name {
        get { return RingName; } set { RingName = value; InvalidateProperties(); }
    }
