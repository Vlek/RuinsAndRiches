...
public class RuneOfVirtue : LevelTalismanHoly
{
    ...
    public Mobile Item_Owner {
        get { return ItemOwner; } set { ItemOwner = value; }
    }
    ...
    public int Item_Side {
        get { return ItemSide; } set { ItemSide = value; }
    }
    ...
    public static void RuneLook(RuneOfVirtue rune)
    {
        ...
        {
            rune.Name = "Rune of Honesty";                    rune.ItemID = 0x5304;   if (rune.ItemSide > 0)
            {
        ...
        {
            rune.Name = "Rune of Honor";                 rune.ItemID = 0x5305;   if (rune.ItemSide > 0)
            {
        ...
        {
            rune.Name = "Rune of Humility";              rune.ItemID = 0x5307;   if (rune.ItemSide > 0)
            {
        ...
        {
            rune.Name = "Rune of Justice";               rune.ItemID = 0x5306;   if (rune.ItemSide > 0)
            {
        ...
        {
            rune.Name = "Rune of Sacrifice";             rune.ItemID = 0x53C2;   if (rune.ItemSide > 0)
            {
        ...
        {
            rune.Name = "Rune of Spirituality";  rune.ItemID = 0x5302;   if (rune.ItemSide > 0)
            {
        ...
        {
            rune.Name = "Rune of Valor";                 rune.ItemID = 0x53C3;   if (rune.ItemSide > 0)
            {
        ...
        {
            rune.Name = "Rune of Compassion";                                                                rune.ItemID = 0x53C4;   if (rune.ItemSide > 0)
            {
