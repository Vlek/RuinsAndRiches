...
public class StaffFiveParts : QuarterStaff
{
    ...
    public Mobile Staff_Owner {
        get { return StaffOwner; } set { StaffOwner = value; }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Staff_Name {
        get { return StaffName; } set { StaffName = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Staff_Magic {
        get { return StaffMagic; } set { StaffMagic = value; InvalidateProperties(); }
    }
    ...
    public override void OnHit(Mobile attacker, Mobile defender, double damageBonus)
    {
        ...
        {
            case 0: this.Hue = 0x48F; if (StaffMagic > 0)
                {
                    this.Hue = 0x558;
                }
                this.AosElementDamages.Poison = 100; break;
            case 1: this.Hue = 0x48D; if (StaffMagic > 0)
                {
                    this.Hue = 0x554;
                }
                this.AosElementDamages.Cold = 100; break;
            case 2: this.Hue = 0x48E; if (StaffMagic > 0)
                {
                    this.Hue = 0x54D;
                }
                this.AosElementDamages.Fire = 100; break;
            case 3: this.Hue = 0x491; if (StaffMagic > 0)
                {
                    this.Hue = 0x96C;
                }
                this.AosElementDamages.Physical = 100; break;
            case 4: this.Hue = 0x490; if (StaffMagic > 0)
                {
                    this.Hue = 0x561;
                }
                this.AosElementDamages.Energy = 100; break;
        }
