...
public class ColoringBook : Item
{
    ...
    public string Magic_Color {
        get { return MagicColor; } set { MagicColor = value; InvalidateProperties(); }
    }
    ...
    public int Magic_Page {
        get { return MagicPage; } set { MagicPage = value; InvalidateProperties(); }
    }
    ...
    public class ColoringBookGump : Gump
    {
        ...
        public ColoringBookGump(Mobile from, ColoringBook book) : base(100, 100)
        {
            ...
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor1)); AddButton(x, y - 2, 4005, 4005, showColor1, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor2) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor2)); AddButton(x, y - 2, 4005, 4005, showColor2, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor3) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor3)); AddButton(x, y - 2, 4005, 4005, showColor3, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor4) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor4)); AddButton(x, y - 2, 4005, 4005, showColor4, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor5) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor5)); AddButton(x, y - 2, 4005, 4005, showColor5, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor6) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor6)); AddButton(x, y - 2, 4005, 4005, showColor6, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor7) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor7)); AddButton(x, y - 2, 4005, 4005, showColor7, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor8) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor8)); AddButton(x, y - 2, 4005, 4005, showColor8, GumpButtonType.Reply, 0);
            }
            y = y + o;
            ...
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor9)); AddButton(x, y - 2, 4005, 4005, showColor9, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor10) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor10)); AddButton(x, y - 2, 4005, 4005, showColor10, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor11) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor11)); AddButton(x, y - 2, 4005, 4005, showColor11, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor12) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor12)); AddButton(x, y - 2, 4005, 4005, showColor12, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor13) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor13)); AddButton(x, y - 2, 4005, 4005, showColor13, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor14) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor14)); AddButton(x, y - 2, 4005, 4005, showColor14, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor15) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor15)); AddButton(x, y - 2, 4005, 4005, showColor15, GumpButtonType.Reply, 0);
            }
            y = y + o;
            if (GetColorListForBook(showColor16) != "")
            {
                AddItem(i, y - 2, 7933, GetColorNumberForBook(showColor16)); AddButton(x, y - 2, 4005, 4005, showColor16, GumpButtonType.Reply, 0);
            }
            y = y + o;
        }
