...
public class HiddenTrap : Item
{
    ...
    public int Hidden_TrapType {
        get { return HiddenTrapType; } set { HiddenTrapType = value; InvalidateProperties(); }
    }
        ...
        if (m is PlayerMobile)
        {
            ...
            if (nSprung == 1)
            {
                ...
                else if (nTrapType == 1 && SavingThrow(m, "Magic", true) == false)                             // REVEALING TRAP
                {
                    ...
                    if (m.Hidden != false)
                    {
                        m.LocalOverheadMessage(MessageType.Emote, 0xB1F, true, textSay); sTrapType = textLog;
                    }
                }
                ...
                else if (nTrapType == 14 && SavingThrow(m, "Physical", true) == false)                             // FLOOR SPIKE TRAP
                {
                    ...
                    {
                        Effects.SendLocationEffect(this.Location, this.Map, 4506 + 1, 18, 3, 0, 0);
                    }
                    else
                    {
                        Effects.SendLocationEffect(this.Location, this.Map, 4512 + 1, 18, 3, 0, 0);
                    }
                ...
                else if (nTrapType == 15 && SavingThrow(m, "Physical", true) == false)                             // SAW TRAP
                {
                    if (Utility.RandomMinMax(1, 2) == 1)
                    {
                        Effects.SendLocationEffect(this.Location, this.Map, 0x11AC + 1, 6, 3, 0, 0);
                    }
                    else
                    {
                        Effects.SendLocationEffect(this.Location, this.Map, 0x11B1 + 1, 6, 3, 0, 0);
                    }
                ...
                else if (nTrapType == 23 && SavingThrow(m, "Magic", true) == false)                             // MELT JEWELS TRAP
                {
                    ...
                    {
                        jw = m.FindItemOnLayer(Layer.Bracelet); if (jw.LootType != LootType.Blessed && jw is BaseJewel && IsJewelryItem(jw))
                        {
                            jewelry.Add(jw);
                        }
                    }
                    ...
                    {
                        jw = m.FindItemOnLayer(Layer.Ring); if (jw.LootType != LootType.Blessed && jw is BaseJewel && IsJewelryItem(jw))
                        {
                            jewelry.Add(jw);
                        }
                    }
                    ...
                    {
                        jw = m.FindItemOnLayer(Layer.Helm); if (jw.LootType != LootType.Blessed && jw is BaseJewel && IsJewelryItem(jw))
                        {
                            jewelry.Add(jw);
                        }
                    }
                    ...
                    {
                        jw = m.FindItemOnLayer(Layer.Neck); if (jw.LootType != LootType.Blessed && jw is BaseJewel && IsJewelryItem(jw))
                        {
                            jewelry.Add(jw);
                        }
                    }
                    ...
                    {
                        jw = m.FindItemOnLayer(Layer.Earrings); if (jw.LootType != LootType.Blessed && jw is BaseJewel && IsJewelryItem(jw))
                        {
                            jewelry.Add(jw);
                        }
                    }
    ...
    public static Item GetMyItem(Mobile m)
    {
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.OuterTorso); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nOuterTorso = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.OneHanded); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nOneHanded = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.TwoHanded); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nTwoHanded = 1;
            }
        }
        if (m.FindItemOnLayer(Layer.Bracelet) != null)
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Bracelet); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nBracelet = 1;
            }
        }
        if (m.FindItemOnLayer(Layer.Ring) != null)
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Ring); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nRing = 1;
            }
        }
        if (m.FindItemOnLayer(Layer.Helm) != null)
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Helm); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nHelm = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Arms); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nArms = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.OuterLegs); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nOuterLegs = 1;
            }
        }
        if (m.FindItemOnLayer(Layer.Neck) != null)
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Neck); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nNeck = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Gloves); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nGloves = 1;
            }
        }
        if (m.FindItemOnLayer(Layer.Talisman) != null)
        {
            ...
            {
                myBlessCheck = m.FindItemOnLayer(Layer.Talisman); if (myBlessCheck.LootType == LootType.Blessed)
                {
                    nTalisman = 1;
                }
            }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Shoes); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nShoes = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Cloak); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nCloak = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.FirstValid); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nFirstValid = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Waist); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nWaist = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.InnerLegs); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nInnerLegs = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.InnerTorso); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nInnerTorso = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Pants); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nPants = 1;
            }
        }
        ...
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Shirt); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nShirt = 1;
            }
        }
        if (m.FindItemOnLayer(Layer.Earrings) != null)
        {
            myBlessCheck = m.FindItemOnLayer(Layer.Earrings); if (myBlessCheck.LootType == LootType.Blessed)
            {
                nEarrings = 1;
            }
        }
