...
public class PowerGump : Gump
{
    ...
    public PowerGump(string msg, Mobile from, Mobile merchant) : base(50, 50)
    {
        ...
        {
            cat = "WONDEROUS"; m_Price = 10000; skill = "105";
        }
        else if (merchant is ExaltedDealer)
        {
            cat = "EXALTED"; m_Price = 20000; skill = "110";
        }
        else if (merchant is MythicalDealer)
        {
            cat = "MYTHICAL"; m_Price = 40000; skill = "115";
        }
        else if (merchant is LegendaryDealer)
        {
            cat = "LEGENDARY"; m_Price = 80000; skill = "120";
        }
        else if (merchant is PowerDealer)
        {
            cat = "POWER"; m_Price = 160000; skill = "125";
        }
    ...
    public void GetLine(int val)
    {
        ...
        if (txt != "")
        {
            ...
            {
                x = 371; y = 25 + ((val - 17) * 28);
            }
            else
            {
                x = 706; y = 25 + ((val - 34) * 28);
            }
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        else if (info.ButtonID > 0)
        {
            ...
            if (cont != null && cont.ConsumeTotal(typeof(Gold), m_Price))
            {
                ...
                {
                    choice = choice + 50; msg = "Exalted";
                }
                else if (m_Merchant is MythicalDealer)
                {
                    choice = choice + 100; msg = "Mythical";
                }
                else if (m_Merchant is LegendaryDealer)
                {
                    choice = choice + 150; msg = "Legendary";
                }
                else if (m_Merchant is PowerDealer)
                {
                    choice = choice + 200; msg = "Power";
                }
