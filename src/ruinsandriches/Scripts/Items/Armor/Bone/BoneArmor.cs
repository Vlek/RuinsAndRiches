...
class BoneArmors
{
    public static void BoneType(Item i, string name)
    {
        switch (Utility.RandomMinMax(0, 35))
        {
            ...
            case 1: i.Hue = 0x485; i.Name = "demon bone " + name; if (i is MagicBoneHelm)
                {
            ...
            case 6: i.Hue = 0xB89; i.Name = "dracolich bone " + name; if (i is MagicBoneHelm)
                {
                    i.ItemID = Utility.RandomList(0x2645, 0x2646);
                }
                break;
            case 7: i.Hue = 0xB85; i.Name = "vampire bone " + name; break;
            case 8: i.Hue = 0x846; i.Name = "devil bone " + name; if (i is MagicBoneHelm)
                {
                    i.ItemID = Utility.RandomList(0x2645, 0x2646);
                }
                break;
            case 9: i.Hue = 0x89C; i.Name = "gargoyle bone " + name; if (i is MagicBoneHelm)
                {
                    i.ItemID = 0x1F0B;
                }
                break;
            ...
            case 17: i.Hue = 0x6EE; i.Name = "dragon bone " + name; if (i is MagicBoneHelm)
                {
                    i.ItemID = Utility.RandomList(0x2645, 0x2646);
                }
                break;
            case 18: i.Hue = 0xB8B; i.Name = "ancient bone " + name; break;
            case 19: i.Hue = 0xB8F; i.Name = "dinosaur bone " + name; if (i is MagicBoneHelm)
                {
                    i.ItemID = Utility.RandomList(0x2645, 0x2646);
                }
                break;
            ...
            case 27: i.Hue = 0x83F; i.Name = "minotaur bone " + name; if (i is MagicBoneHelm)
                {
                    i.ItemID = 0x1F0B;
                }
                break;
            ...
            case 35: i.Hue = 0x489; i.Name = "imp bone " + name; if (i is MagicBoneHelm)
                {
                    i.ItemID = 0x1F0B;
                }
                break;
