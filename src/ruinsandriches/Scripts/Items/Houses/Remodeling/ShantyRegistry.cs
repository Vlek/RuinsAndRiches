...
public class ShantyGumpEntry
{
    ...
    {
        int button = 2447; if (i == ItemID)
        {
            button = 2449;
        }
        int color = 1477; if (i == ItemID)
        {
            color = 1671;
        }
        y = y + 7;
...
class ShantyRegistry
{
    ...
    public static void RegisterItems()
    {
        ...
        while (cycle < 18)
        {
            ...
            if (cycle == 1)
            {
                x_ground = "Blood Rock";        x_name = "blood rock ground";
            }
            else if (cycle == 2)
            {
                x_ground = "Cave";                      x_name = "cavern ground";
            }
            else if (cycle == 3)
            {
                x_ground = "Desert";            x_name = "desert ground";
            }
            else if (cycle == 4)
            {
                x_ground = "Dirt";                      x_name = "dirt ground";
            }
            else if (cycle == 5)
            {
                x_ground = "Dirt Light";        x_name = "light dirt ground";
            }
            else if (cycle == 6)
            {
                x_ground = "Dirt Dark";         x_name = "dark dirt ground";
            }
            else if (cycle == 7)
            {
                x_ground = "Forest";            x_name = "forest ground";
            }
            else if (cycle == 8)
            {
                x_ground = "Grass";                     x_name = "grassy ground";
            }
            else if (cycle == 9)
            {
                x_ground = "Jungle";            x_name = "jungle ground";
            }
            else if (cycle == 10)
            {
                x_ground = "Lava Rock";         x_name = "lava rock ground";
            }
            else if (cycle == 11)
            {
                x_ground = "Lunar Rock";        x_name = "lunar rock ground";
            }
            else if (cycle == 12)
            {
                x_ground = "Magma Rock";        x_name = "magma rock ground";
            }
            else if (cycle == 13)
            {
                x_ground = "Mud";                       x_name = "muddy ground";
            }
            else if (cycle == 14)
            {
                x_ground = "Snow";                      x_name = "snowy ground";
            }
            else if (cycle == 15)
            {
                x_ground = "Stone";                     x_name = "stone ground";
            }
            else if (cycle == 16)
            {
                x_ground = "Stone Light";       x_name = "light stone ground";
            }
            else if (cycle == 17)
            {
                x_ground = "Stone Dark";        x_name = "dark stone ground";
            }
            else if (cycle == 18)
            {
                x_ground = "Swamp";                     x_name = "swampy ground";
            }
