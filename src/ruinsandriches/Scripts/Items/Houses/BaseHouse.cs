...
public abstract class BaseHouse : BaseMulti
{
    ...
    public static bool IsSouthFacingSight(int itemID)
    {
        if (itemID == 2979 || itemID == 2981 || itemID == 2983 || itemID == 2985 || itemID == 2987 || itemID == 2989
            ...
            || itemID == 2965 || itemID == 3139 || itemID == 2812)
        {
            return true;
        }
    ...
    public abstract Rectangle2D[] Area {
        get;
    }
    public abstract Point3D BaseBanLocation {
        get;
    }
    ...
    public ArrayList CoOwners {
        get { return m_CoOwners; } set { m_CoOwners = value; }
    }
    public ArrayList Friends {
        get { return m_Friends; } set { m_Friends = value; }
    }
    public ArrayList Access {
        get { return m_Access; } set { m_Access = value; }
    }
    public ArrayList Bans {
        get { return m_Bans; } set { m_Bans = value; }
    }
    public ArrayList Doors {
        get { return m_Doors; } set { m_Doors = value; }
    }
    ...
    public ArrayList Addons {
        get { return m_Addons; } set { m_Addons = value; }
    }
    ...
    public MovingCrate MovingCrate {
        get { return m_MovingCrate; } set { m_MovingCrate = value; }
    }
    ...
    [CommandProperty(AccessLevel.GameMaster)]
    public int Price {
        get { return m_Price; } set { m_Price = value; }
    }
