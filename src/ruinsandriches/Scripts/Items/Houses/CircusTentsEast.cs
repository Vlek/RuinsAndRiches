...
public class MyCircusTentEastAddon : BaseAddon
{
    ...
    public int Tent_Color1 {
        get { return TentColor1; } set { TentColor1 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Tent_Color2 {
        get { return TentColor2; } set { TentColor2 = value; InvalidateProperties(); }
    }
...
public class MyCircusTentEastAddonDeed : BaseAddonDeed
{
    ...
    public int Tent_Found {
        get { return TentFound; } set { TentFound = value; InvalidateProperties(); }
    }
    ...
    public MyCircusTentEastAddonDeed(int RelHue1, int RelHue2, int RelRolled)
    {
        ...
        if (TentFound > 0)
        {
            TentColor1 = Tent_Color1; TentColor2 = Tent_Color2; Hue = Tent_Color1;
        }
        else if (RelRolled > 0)
        {
            TentColor1 = RelHue1; TentColor2 = RelHue2; Hue = RelHue1;
        }
        else
        {
