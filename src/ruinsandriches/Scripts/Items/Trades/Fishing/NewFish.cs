...
public class NewFish : Item, ICarvable
{
    ...
    public int FishGold_Value {
        get { return FishGoldValue; } set { FishGoldValue = value; InvalidateProperties(); }
    }
    ...
    public NewFish() : base(0x09CC)
    {
        ...
        if (ItemID == 0x22A8)
        {
            sName = "marlin"; FishGoldValue = Utility.RandomMinMax(50, 200); Weight = 10.0;
        }
        ...
        {
            sName = "shark"; FishGoldValue = Utility.RandomMinMax(50, 200); Weight = 10.0;
        }
        else if (ItemID == 0x52DE)
        {
            sName = "sea horse"; FishGoldValue = Utility.RandomMinMax(50, 200);
        }
        else if (ItemID == 0x52DF || ItemID == 0x52E0)
        {
            sName = "manta ray"; FishGoldValue = Utility.RandomMinMax(50, 200); Weight = 5.0;
        }
        else if (ItemID == 0x52E1)
        {
            sName = "squid"; FishGoldValue = Utility.RandomMinMax(50, 200);
        }
        else if (ItemID == 0x52C9)
        {
            sName = "octopus"; FishGoldValue = Utility.RandomMinMax(50, 200);
        }
        else if (ItemID == 0x531F)
        {
            sName = "crab"; FishGoldValue = Utility.RandomMinMax(50, 200);
        }
