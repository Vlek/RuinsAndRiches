...
public class TreasureMap : MapItem
{
    ...
    public bool Completed {
        get { return m_Completed; } set { m_Completed = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public Mobile CompletedBy {
        get { return m_CompletedBy; } set { m_CompletedBy = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public Mobile Decoder {
        get { return m_Decoder; } set { m_Decoder = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public Map ChestMap {
        get { return m_Map; } set { m_Map = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public Point2D ChestLocation {
        get { return m_Location; } set { m_Location = value; InvalidateProperties(); }
    }
    ...
    public TreasureMap(int level, Map map, Point3D location, int x, int y)
    {
        ...
        {
            world = "the Land of Sosaria"; map = Map.Sosaria;
        }
    ...
    public virtual void Slice()
    {
        ...
        if (m_Decoder != null && Age >= 30)
        {
            ...
            if (loc == Point3D.Zero)
            {
                loc = new Point3D(1834, 1107, 2); map = Map.Sosaria;
            }
