...
public class WorldMap : MapItem
{
    ...
    public override void CraftInit(Mobile from)
    {
        ...
        {
            dist = 50 + (int)(skillValue * 10); size = 24 + (int)(skillValue * 2.8);
        }
        else if (MapWorld == "the Savaged Empire")
        {
            dist = 40 + (int)(skillValue * 9); size = 24 + (int)(skillValue * 2.4);
        }
        ...
        {
            dist = 40 + (int)(skillValue * 8); size = 24 + (int)(skillValue * 2);
        }
