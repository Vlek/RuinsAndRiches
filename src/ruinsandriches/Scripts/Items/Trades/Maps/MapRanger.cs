...
public class MapRanger : Item
{
    ...
    public MapRangerEffect Effect {
        get { return m_MapRangerEffect; } set { m_MapRangerEffect = value; InvalidateProperties(); }
    }
    ...
    public string MapDestination {
        get { return m_MapDestination; } set { m_MapDestination = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public Point3D PointDest {
        get { return m_PointDest; } set { m_PointDest = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public Map MapDest {
        get { return m_MapDest; } set { m_MapDest = value; InvalidateProperties(); }
    }
    ...
    public override void OnDoubleClick(Mobile from)
    {
        ...
        else if (GoToWorld == "the Island of Umber Veil" && PlayerSettings.GetDiscovered(from, "the Island of Umber Veil"))
        {
            CanUseMap = true;
        }
        else if (GoToWorld == "the Land of Ambrosia" && PlayerSettings.GetDiscovered(from, "the Land of Ambrosia"))
        {
            CanUseMap = true;
        }
        else if (GoToWorld == "the Land of Lodoria" && PlayerSettings.GetDiscovered(from, "the Land of Lodoria"))
        {
            CanUseMap = true;
        }
        else if (GoToWorld == "the Serpent Island" && PlayerSettings.GetDiscovered(from, "the Serpent Island"))
        {
            CanUseMap = true;
        }
        else if (GoToWorld == "the Isles of Dread" && PlayerSettings.GetDiscovered(from, "the Isles of Dread"))
        {
            CanUseMap = true;
        }
        else if (GoToWorld == "the Savaged Empire" && PlayerSettings.GetDiscovered(from, "the Savaged Empire"))
        {
            CanUseMap = true;
        }
        else if (GoToWorld == "the Bottle World of Kuldar" && PlayerSettings.GetDiscovered(from, "the Bottle World of Kuldar"))
        {
            CanUseMap = true;
        }
