...
class RelicItems
{
    public static string IdentifyRelicValue(Mobile examiner, Mobile customer, Item item)
    {
        ...
        {
            gold = ((DDRelicInstrument)item).RelicGoldValue; buyer = "a bard";
        }
        else if (item is DDRelicArmor)
        {
            gold = ((DDRelicArmor)item).RelicGoldValue; buyer = "an armorer";
        }
        else if (item is DDRelicWeapon)
        {
            gold = ((DDRelicWeapon)item).RelicGoldValue; buyer = "a weaponsmith";
        }
        else if (item is DDRelicAlchemy)
        {
            gold = ((DDRelicAlchemy)item).RelicGoldValue; buyer = "an alchemist";
        }
        else if (item is DDRelicArts)
        {
            gold = ((DDRelicArts)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is DDRelicBanner)
        {
            gold = ((DDRelicBanner)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is DDRelicBearRugsAddon)
        {
            gold = ((DDRelicBearRugsAddon)item).RelicGoldValue; buyer = "a fur trader";
        }
        else if (item is DDRelicBook)
        {
            gold = ((DDRelicBook)item).RelicGoldValue; buyer = "a scribe";
        }
        else if (item is DDRelicClock1)
        {
            gold = ((DDRelicClock1)item).RelicGoldValue; buyer = "a tinker";
        }
        else if (item is DDRelicClock2)
        {
            gold = ((DDRelicClock2)item).RelicGoldValue; buyer = "a tinker";
        }
        else if (item is DDRelicClock3)
        {
            gold = ((DDRelicClock3)item).RelicGoldValue; buyer = "a tinker";
        }
        else if (item is DDRelicCloth)
        {
            gold = ((DDRelicCloth)item).RelicGoldValue; buyer = "a tailor";
        }
        else if (item is DDRelicCoins)
        {
            gold = ((DDRelicCoins)item).RelicGoldValue; buyer = "a minter";
        }
        else if (item is DDRelicDrink)
        {
            gold = ((DDRelicDrink)item).RelicGoldValue; buyer = "a tavern keeper";
        }
        else if (item is DDRelicFur)
        {
            gold = ((DDRelicFur)item).RelicGoldValue; buyer = "a fur trader";
        }
        else if (item is DDRelicGem)
        {
            gold = ((DDRelicGem)item).RelicGoldValue; buyer = "a jeweler";
        }
        else if (item is DDRelicJewels)
        {
            gold = ((DDRelicJewels)item).RelicGoldValue; buyer = "a jeweler";
        }
        else if (item is DDRelicLight1)
        {
            gold = ((DDRelicLight1)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is DDRelicLight2)
        {
            gold = ((DDRelicLight2)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is DDRelicLight3)
        {
            gold = ((DDRelicLight3)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is DDRelicOrbs)
        {
            gold = ((DDRelicOrbs)item).RelicGoldValue; buyer = "a mage";
        }
        else if (item is DDRelicPainting)
        {
            gold = ((DDRelicPainting)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is DDRelicReagent)
        {
            gold = ((DDRelicReagent)item).RelicGoldValue; buyer = "an alchemist";
        }
        else if (item is DDRelicRugAddonDeed)
        {
            gold = ((DDRelicRugAddonDeed)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is DDRelicScrolls)
        {
            gold = ((DDRelicScrolls)item).RelicGoldValue; buyer = "a mage";
        }
        else if (item is DDRelicStatue)
        {
            gold = ((DDRelicStatue)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is DDRelicTablet)
        {
            gold = ((DDRelicTablet)item).RelicGoldValue; buyer = "a sage";
        }
        else if (item is DDRelicVase)
        {
            gold = ((DDRelicVase)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is DDRelicLeather)
        {
            gold = ((DDRelicLeather)item).RelicGoldValue; buyer = "a leather worker";
        }
        else if (item is DDRelicGrave)
        {
            gold = ((DDRelicGrave)item).RelicGoldValue; buyer = "a necromancer";
        }
        else if (item is EmptyCanopicJar)
        {
            gold = ((EmptyCanopicJar)item).RelicGoldValue; buyer = "an art collector";
        }
        else if (item is HighSeasRelic)
        {
            gold = ((HighSeasRelic)item).RelicGoldValue; buyer = "a shipwright";
        }
        else if (item is StatueGygaxAddonDeed)
        {
            gold = ((StatueGygaxAddonDeed)item).RelicGoldValue; buyer = "an art collector";
        }
    ...
    public static int RelicValue(Item relics, Mobile m)
    {
        ...
        {
            StatueGygaxAddonDeed relic = (StatueGygaxAddonDeed)relics; RelicValue = relic.RelicGoldValue;
        }                                                                                                                                                                                                   // ART COLLECTOR
