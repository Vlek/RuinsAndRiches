...
public abstract class BaseWizardStaff : BaseMeleeWeapon
{
    ...
    public int damage_Type {
        get { return damageType; } set { damageType = value; InvalidateProperties(); }
    }
    ...
    public void EnergyType()
    {
        ...
        damageType = 0;
        if (AosElementDamages.Fire > AosElementDamages.Cold && AosElementDamages.Fire > AosElementDamages.Poison && AosElementDamages.Fire > AosElementDamages.Energy && AosElementDamages.Fire > physical)
        {
            damageType = 1;
        }
        else if (AosElementDamages.Cold > AosElementDamages.Fire && AosElementDamages.Cold > AosElementDamages.Poison && AosElementDamages.Cold > AosElementDamages.Energy && AosElementDamages.Cold > physical)
        {
            damageType = 2;
        }
        else if (AosElementDamages.Energy > AosElementDamages.Cold && AosElementDamages.Energy > AosElementDamages.Fire && AosElementDamages.Energy > AosElementDamages.Poison && AosElementDamages.Energy > physical)
        {
            damageType = 3;
        }
        else if (AosElementDamages.Poison > AosElementDamages.Fire && AosElementDamages.Poison > AosElementDamages.Cold && AosElementDamages.Poison > AosElementDamages.Energy && AosElementDamages.Poison > physical)
        {
            damageType = 4;
        }
    }
    ...
    public static bool HasStaff(Mobile from)
    {
        if (from.FindItemOnLayer(Layer.OneHanded) != null)
        {
            ...
            if (oneHand is BaseWizardStaff || oneHand is BaseLevelStave || oneHand is BaseGiftStave)
            {
                return true;
            }
        }
        if (from.FindItemOnLayer(Layer.TwoHanded) != null)
        {
            ...
            if (twoHand is BaseWizardStaff || twoHand is BaseLevelStave || twoHand is BaseGiftStave)
            {
                return true;
            }
        }
