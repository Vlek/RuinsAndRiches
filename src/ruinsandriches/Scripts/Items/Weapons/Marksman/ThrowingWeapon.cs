...
public class ThrowingWeapon : Item
{
    ...
    public string Ammo {
        get { return ammo; } set { ammo = value; InvalidateProperties(); }
    }
    ...
    public override void OnDoubleClick(Mobile from)
    {
        ...
        else
        {
            ...
            {
                ammo = "Throwing Axes"; ItemID = 0x10B3; Name = "throwing axe";
            }
            else if (ammo == "Throwing Axes")
            {
                ammo = "Throwing Daggers"; ItemID = 0x10B7; Name = "throwing dagger";
            }
            else if (ammo == "Throwing Daggers")
            {
                ammo = "Throwing Darts"; ItemID = 0x10B5; Name = "throwing dart";
            }
            else if (ammo == "Throwing Darts")
            {
                ammo = "Throwing Stars"; ItemID = 0x10B2; Name = "throwing star";
            }
            else if (ammo == "Throwing Stars" && Server.Misc.GetPlayerInfo.isJester(from))
            {
                ammo = "Throwing Cards"; ItemID = 0x4C29; Name = "throwing card";
            }
            else if (ammo == "Throwing Cards" && Server.Misc.GetPlayerInfo.isJester(from))
            {
                ammo = "Throwing Tomatoes"; ItemID = 0x4C28; Name = "throwing tomato";
            }
            else
            {
                ammo = "Throwing Stones"; ItemID = 0x10B6; Name = "throwing stone";
            }
