...
public class DemonPrison : Item
{
        ...
        protected override void OnTarget(Mobile from, object targeted)
        {
            if (targeted is Gold)
            {
                ...
                else
                {
                    ...
                    if (cost >= coin)
                    {
                        m_DemonPrison.HaveGold = m_DemonPrison.HaveGold + coin; gold.Delete();
                    }
                    else
                    {
                        m_DemonPrison.HaveGold = m_DemonPrison.HaveGold + cost; gold.Amount = gold.Amount - cost;
                    }
    ...
    public static bool ProcessDemonPrison(Mobile m, Mobile wizard, Item dropped)
    {
        ...
        if (Server.Misc.Worlds.GetRegionName(wizard.Map, wizard.Location) != shard.WizardLocation)
        {
            return false;
        }
        ...
        if (GoldReturn > 0)
        {
            m.AddToBackpack(new Gold(GoldReturn)); wizard.Say("Here is " + GoldReturn.ToString() + " gold back for all of your help.");
        }
    ...
    public string g_WizardLocation {
        get { return WizardLocation; } set { WizardLocation = value; }
    }
    ...
    public int g_DaemonType {
        get { return DaemonType; } set { DaemonType = value; }
    }

    public int DaemonBody;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_DaemonBody {
        get { return DaemonBody; } set { DaemonBody = value; }
    }

    public string DaemonName;
    [CommandProperty(AccessLevel.GameMaster)]
    public string g_DaemonName {
        get { return DaemonName; } set { DaemonName = value; }
    }

    public string DaemonTitle;
    [CommandProperty(AccessLevel.GameMaster)]
    public string g_DaemonTitle {
        get { return DaemonTitle; } set { DaemonTitle = value; }
    }
    ...
    public int g_HaveShardA {
        get { return HaveShardA; } set { HaveShardA = value; }
    }
    ...
    public int g_HaveShardC {
        get { return HaveShardC; } set { HaveShardC = value; }
    }

    public int HaveShardB;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveShardB {
        get { return HaveShardB; } set { HaveShardB = value; }
    }

    public int HaveShardD;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveShardD {
        get { return HaveShardD; } set { HaveShardD = value; }
    }
}
}
...
public class Daemonic : BaseCreature
{
    ...
    public string r_Title {
        get { return rTitle; } set { rTitle = value; InvalidateProperties(); }
    }
