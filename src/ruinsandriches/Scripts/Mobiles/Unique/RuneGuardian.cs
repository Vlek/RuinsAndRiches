...
public class RuneGuardian : BaseCreature
{
    ...
    public override bool OnBeforeDeath()
    {
        ...
        if (gVirtue == 1)
        {
            myRune.Name = "Rune of Compassion"; myRune.ItemID = Utility.RandomList(0x5318, 0x5319);
        }
        else if (gVirtue == 2)
        {
            myRune.Name = "Rune of Honesty"; myRune.ItemID = Utility.RandomList(0x530E, 0x530F);
        }
        else if (gVirtue == 3)
        {
            myRune.Name = "Rune of Honor"; myRune.ItemID = Utility.RandomList(0x531A, 0x531B);
        }
        else if (gVirtue == 4)
        {
            myRune.Name = "Rune of Humility"; myRune.ItemID = Utility.RandomList(0x5312, 0x5313);
        }
        else if (gVirtue == 5)
        {
            myRune.Name = "Rune of Justice"; myRune.ItemID = Utility.RandomList(0x5310, 0x5311);
        }
        else if (gVirtue == 6)
        {
            myRune.Name = "Rune of Sacrifice"; myRune.ItemID = Utility.RandomList(0x5314, 0x5315);
        }
        else if (gVirtue == 7)
        {
            myRune.Name = "Rune of Spirituality"; myRune.ItemID = Utility.RandomList(0x530C, 0x530D);
        }
        else if (gVirtue == 8)
        {
            myRune.Name = "Rune of Valor"; myRune.ItemID = Utility.RandomList(0x5316, 0x5317);
        }
