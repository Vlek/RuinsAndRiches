...
public class AsianDragon : BaseCreature
{
    ...
    {
        Name = NameList.RandomName("tokuno male"); if (Utility.RandomBool())
        {
    ...
    public override void OnDeath(Container c)
    {
        ...
        if (killer != null)
        {
            ...
            if (killer is PlayerMobile)
            {
                if (Hue == 2900)
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, "", "Celestial", "", c, 25, 2900);
                }
                else if (Hue == 0xB42)
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, "", "Spirit", "", c, 25, 0xB42);
                }
                else
                {
                    Server.Mobiles.Dragons.DropSpecial(this, killer, "", "Coiled", "", c, 25, 0xB79);
                }
            }
        }
    }
