...
public class Wyrms : BaseCreature
{
    ...
    public void CreateDragon(string terrain)
    {
        if (rHue < 1)
        {
            ...
            if (rCategory == "cold")
            {
                phys = 45;      fire = 5;  cold = 70; pois = 20; engy = 20;
            }
            else if (rCategory == "electrical")
            {
                phys = 45;      fire = 20; cold = 20; pois = 5;  engy = 70;
            }
            else if (rCategory == "fire")
            {
                phys = 45;      fire = 70; cold = 5;  pois = 20; engy = 20;
            }
            else if (rCategory == "poison")
            {
                phys = 45;      fire = 20; cold = 20; pois = 70; engy = 5;
            }
            else if (rCategory == "radiation")
            {
                phys = 45;      fire = 25; cold = 5;  pois = 25; engy = 60;
            }
            else if (rCategory == "sand")
            {
                phys = 35;      fire = 60; cold = 20; pois = 5;  engy = 30;
            }
            else if (rCategory == "steam")
            {
            ...
            {
                phys = 35;      fire = 15; cold = 15; pois = 60; engy = 40;
            }

            else if (rCategory == "wind")
            {
                phys = 35;      fire = 20; cold = 25; pois = 20; engy = 60;
            }
            else if (rCategory == "storm")
            {
                phys = 35;      fire = 60; cold = 25; pois = 20; engy = 60;
            }
            else if (rCategory == "star")
            {
                phys = 35;      fire = 20; cold = 25; pois = 20; engy = 60;
