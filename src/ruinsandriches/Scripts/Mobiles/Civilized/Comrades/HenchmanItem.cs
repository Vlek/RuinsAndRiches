...
public class HenchmanItem : Item
{
    ...
    public int Hench_Serial {
        get { return HenchSerial; } set { HenchSerial = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_Timer {
        get { return HenchTimer; } set { HenchTimer = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_WeaponID {
        get { return HenchWeaponID; } set { HenchWeaponID = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_ShieldID {
        get { return HenchShieldID; } set { HenchShieldID = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_HelmID {
        get { return HenchHelmID; } set { HenchHelmID = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_ArmorType {
        get { return HenchArmorType; } set { HenchArmorType = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_WeaponType {
        get { return HenchWeaponType; } set { HenchWeaponType = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_CloakColor {
        get { return HenchCloakColor; } set { HenchCloakColor = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_Cloak {
        get { return HenchCloak; } set { HenchCloak = value; InvalidateProperties(); }
    }
    ...
    public int Hench_HatColor {
        get { return HenchHatColor; } set { HenchHatColor = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_Gloves {
        get { return HenchGloves; } set { HenchGloves = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_Speech {
        get { return HenchSpeech; } set { HenchSpeech = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_Dead {
        get { return HenchDead; } set { HenchDead = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_Body {
        get { return HenchBody; } set { HenchBody = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_Hue {
        get { return HenchHue; } set { HenchHue = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_Hair {
        get { return HenchHair; } set { HenchHair = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_HairHue {
        get { return HenchHairHue; } set { HenchHairHue = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_GearColor {
        get { return HenchGearColor; } set { HenchGearColor = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Hench_Name {
        get { return HenchName; } set { HenchName = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Hench_Title {
        get { return HenchTitle; } set { HenchTitle = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Hench_Bandages {
        get { return HenchBandages; } set { HenchBandages = value; InvalidateProperties(); }
    }
