...
public class HenchmanArcher : BaseCreature
{
    ...
    public DateTime Healing {
        get { return m_Healing; } set { m_Healing = value; }
    }

    private DateTime m_NextMorale;
    public DateTime NextMorale {
        get { return m_NextMorale; } set { m_NextMorale = value; }
    }
    ...
    public HenchmanArcher(int myBody, int nMounted, double nSkills, int nStats) : base(AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4)
    {
        ...
        int nArmor = (int)(nStats / 6); if (nArmor > 70)
        {
            nArmor = 70;
        }
        int nProtect = (int)(nStats / 3); if (nProtect > 70)
        {
            nProtect = 70;
        }
