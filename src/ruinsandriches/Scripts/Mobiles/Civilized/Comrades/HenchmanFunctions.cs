...
class HenchmanFunctions
{
            ...
            else
            {
                ...
                if (from.Fame < 0)
                {
                    ...
                    for (int i = 0; i < targets.Count; ++i)
                    {
                        ...
                        {
                            henchThing.Name = "creature henchman"; monster = true;
                        }
                        else
                        {
    ...
    public static void OnGive(Mobile from, Item dropped, Mobile henchman)
    {
        if (dropped is Bandage)
        {
            ...
            if (henchman is HenchmanMonster)
            {
                henchman.Say("I could use these bandages. I have " + henchman.Hunger.ToString() + " of them now.");
            }
            else
            {
                henchman.Say("Ahhh...bandages can be of great use. I have " + henchman.Hunger.ToString() + " of them now.");
            }
            dropped.Delete();
        }
        ...
        else
        {
            ...
            {
                double dGold = (nAmount / 5); nGold = (int)(Math.Floor(dGold));
            }
            else if (dropped is DDCopper)
            {
                double dGold = (nAmount / 10); nGold = (int)(Math.Floor(dGold));
            }
            ...
            if (nGold > 0)
            {
                if (henchman.Fame >= 1800)
                {
                    ...
                    {
                        henchman.Say("Thank you, " + from.Name + "...but my treasure bag is full.");
                    }
                }
                else
                {
                    ...
                    {
                        henchman.Say("Ahhh...a cut of the treasure. This journey is worth the risk.");
                    }
            ...
            else
            {
                ...
                {
                    henchman.Say("Sorry, " + from.Name + "...but I can't see much value in that.");
                }
            }
        }
    ...
    public static void NormalizeArmor(BaseCreature friend)
    {
        ...
        {
            friend.ColdResistSeed = friend.ColdResistSeed - (friend.ColdResistance - friend.ColdResistSeed);
        }
        if (friend.FireResistance > 70)
        {
            friend.FireResistSeed = friend.FireResistSeed - (friend.FireResistance - friend.FireResistSeed);
        }
        if (friend.PoisonResistance > 70)
        {
            friend.PoisonResistSeed = friend.PoisonResistSeed - (friend.PoisonResistance - friend.PoisonResistSeed);
        }
        if (friend.EnergyResistance > 70)
        {
            friend.EnergyResistSeed = friend.EnergyResistSeed - (friend.EnergyResistance - friend.EnergyResistSeed);
        }
        if (friend.PhysicalResistance > 70)
        {
            friend.PhysicalResistanceSeed = friend.PhysicalResistanceSeed - (friend.PhysicalResistance - friend.PhysicalResistanceSeed);
        }
    }
    ...
    public static void DressUp(HenchmanItem henchman, BaseCreature friend, Mobile from)
    {
        ...
        if (henchman is HenchmanWizardItem)
        {
            ...
            Gear1.ItemID = henchman.HenchHelmID; if (isOriental == true)
            {
                Gear1.ItemID = 0x2798;
            }
        ...
        else if (henchman is HenchmanFighterItem)
        {
            ...
            {
                Item Armor0 = new PlateArms(); if (isOriental == true)
                {
                ...
                Item Armor1 = new PlateLegs(); if (isOriental == true)
                {
                ...
                Item Armor3 = new PlateGorget(); if (isOriental == true)
                {
                ...
                {
                    Item Armor4 = new FemalePlateChest(); if (isOriental == true)
                    {
                ...
                {
                    Item Armor4 = new PlateChest(); if (isOriental == true)
                    {
                        Armor4.ItemID = 0x277D;
                    }
                    Armor4.Hue     = henchman.HenchGearColor;
            ...
            {
                Item Armor0 = new RingmailArms(); if (isOriental == true)
                {
                ...
                Item Armor1 = new RingmailLegs(); if (isOriental == true)
                {
                ...
                Item Armor4 = new ChainChest(); if (isOriental == true)
                {
                    Armor4.ItemID = 0x277D;
                }
                Armor4.Hue     = henchman.HenchGearColor;
        ...
        else
        {
            ...
            if (henchman.HenchArmorType != 1)
            {
                Item Armor0 = new LeatherArms(); if (isOriental == true)
                {
                ...
                Item Armor1 = new LeatherLegs(); if (isOriental == true)
                {
                ...
                Item Armor3 = new LeatherGorget(); if (isOriental == true)
                {
                ...
                if (henchman.HenchBody == 401)
                {
                    Item Armor4 = new FemaleLeatherChest(); if (isOriental == true)
                    {
                ...
                {
                    Item Armor4 = new LeatherChest(); if (isOriental == true)
                    {
                        Armor4.ItemID = 0x2793;
                    }
                    Armor4.Hue     = henchman.HenchGearColor;
            ...
            {
                Item Armor0 = new StuddedArms(); if (isOriental == true)
                {
                    Armor0.ItemID = 0x277F;
                }
                Armor0.Hue     = henchman.HenchGearColor;
                ...
                Item Armor1 = new StuddedLegs(); if (isOriental == true)
                {
                    Armor1.ItemID = 0x2791;
                }
                Armor1.Hue     = henchman.HenchGearColor;
                ...
                Item Armor3 = new StuddedGorget(); if (isOriental == true)
                {
                    Armor3.ItemID = 0x277A;
                }
                Armor3.Hue     = henchman.HenchGearColor;
                ...
                if (henchman.HenchBody == 401)
                {
                    Item Armor4 = new FemaleStuddedChest(); if (isOriental == true)
                    {
                        Armor4.ItemID = 0x2793;
                    }
                    Armor4.Hue     = henchman.HenchGearColor;
                ...
                {
                    Item Armor4 = new StuddedChest(); if (isOriental == true)
                    {
                        Armor4.ItemID = 0x2793;
                    }
                    Armor4.Hue     = henchman.HenchGearColor;
            ...
            {
                Item Gear3 = new Bow();
                Gear3.ItemID = henchman.HenchWeaponID; if (isOriental == true)
                {
                    Gear3.ItemID = 0x27A5;
                }
                Gear3.Movable = false;
    ...
    public static string GetTitle()
    {
        ...
        switch (Utility.RandomMinMax(0, 105))
        {
            ...
            case 33: myTitle = "the Fearless"; if (Utility.RandomBool())
                {
                    myTitle = "the Brave";
                }
                break;
            case 34: myTitle = "the Savage"; if (Utility.RandomBool())
                {
            ...
            case 47: myTitle = "the Strong"; if (Utility.RandomBool())
                {
                    myTitle = "the Weak";
                }
                break;
            ...
            case 60: myTitle = "the Calm"; if (Utility.RandomBool())
                {
                    myTitle = "the Frantic";
                }
                break;
            ...
            case 69: myTitle = "the Masked"; if (Utility.RandomBool())
                {
                    myTitle = "the Veiled";
                }
                break;
            case 70: myTitle = "the Merciful"; if (Utility.RandomBool())
                {
            ...
            case 75: myTitle = "the Mysterious"; if (Utility.RandomBool())
                {
                    myTitle = "the Unknown";
                }
                break;
            case 76: myTitle = "the Obscure"; break;
            case 77: myTitle = "the Old"; if (Utility.RandomBool())
                {
                    myTitle = "the Young";
                }
                break;
            ...
            case 82: myTitle = "the Quick"; if (Utility.RandomBool())
                {
                    myTitle = "the Slow";
                }
                break;
            ...
            case 90: myTitle = "the Short"; if (Utility.RandomBool())
                {
                    myTitle = "the Tall";
                }
                break;
            ...
            case 97: myTitle = "the Traveler"; if (Utility.RandomBool())
                {
            ...
            case 100: myTitle = "the Steady"; if (Utility.RandomBool())
                {
                    myTitle = "the Unready";
                }
                break;
            case 101: myTitle = "the Gentle"; if (Utility.RandomBool())
                {
                    myTitle = "the Cruel";
                }
                break;
            case 102: myTitle = "the Lost"; if (Utility.RandomBool())
                {
                    myTitle = "the Exiled";
                }
                break;
            case 103: myTitle = "the Careless"; if (Utility.RandomBool())
                {
                    myTitle = "the Clumsy";
                }
                break;
            case 104: myTitle = "the Hopeful"; if (Utility.RandomBool())
                {
                    myTitle = "the Trustful";
                }
                break;
            case 105: myTitle = "the Angry"; if (Utility.RandomBool())
                {
                    myTitle = "the Timid";
                }
                break;
