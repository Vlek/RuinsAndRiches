...
public class Actions : Item
{
    ...
    public int Acts {
        get { return m_Acts; } set { m_Acts = value; }
    }
    ...
    public override void OnDoubleClick(Mobile from)
    {
        ...
        else if (from is Baker)
        {
            ...
            else
            {
                ...
                if (ItemID == 0x103D)
                {
                    Name = "bread"; ItemID = Utility.RandomList(0x103C, 0x98C);
                }
                else
                {
                    Name = "cookies"; ItemID = Utility.RandomList(0x160B, 0x160C);
                }
                from.Animate(230, 5, 1, true, false, 0);
        ...
        else if (from is Miner || from is Blacksmith || from is Weaponsmith || from is IronWorker || from is Armorer)
        {
            if (ItemID == 0x1775 || ItemID == 0x1776 || ItemID == 0x1777 || ItemID == 0x1778 || ItemID == 0x19B9)
            {
                ...
                if (m_Acts == 0)
                {
                    ItemID = 0x1776; m_Acts++;
                }
                else if (m_Acts == 1)
                {
                    ItemID = 0x1775; m_Acts++;
                }
                else if (m_Acts == 2)
                {
                    ItemID = 0x1777; m_Acts++;
                }
                else if (m_Acts == 3)
                {
                    ItemID = 0x1778; m_Acts++;
                }
                else
                {
                    ItemID = 0x19B9; m_Acts = 0;
                }
            }
