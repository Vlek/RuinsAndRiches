...
public class Jester : BaseVendor
{
    ...
    public void BeginRepair(Mobile from)
    {
        ...
        {
            SayTo(from, "If you want me to alter your hat, robe, or shoes to be more foolish, it will cost you " + nCost.ToString() + " gold.");
        }
        ...
        protected override void OnTarget(Mobile from, object targeted)
        {
                    ...
                    ) && from.Backpack != null)
            {
                ...
                if (pack.ConsumeTotal(typeof(Gold), toConsume))
                {
                    ...
                    string cls = "jester "; if (Utility.RandomBool())
                    {
                        cls = "joker ";
                    }
                    ...
                    else if (targeted is ShinobiRobe || targeted is LeatherRobe || targeted is MagicRobe || targeted is BaseOuterTorso)
                    {
                        if (ba.ItemID == 0x4C16)
                        {
                            ba.ItemID = 0x4C17; ba.Name = adj + cls + "suit";
                        }
                        else if (ba.ItemID == 0x4C17)
                        {
                            ba.ItemID = 0x2B6B; ba.Name = adj + cls + "coat";
                        }
                        else
                        {
                            ba.ItemID = 0x4C16; ba.Name = adj + cls + "garb";
                        }
                    }
                }
                else
