...
public class EpicCharacter : BasePerson
{
    ...
    public string My_Alignment {
        get { return MyAlignment; } set { MyAlignment = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_ItemText {
        get { return MyItemText; } set { MyItemText = value; InvalidateProperties(); }
    }
    ...
    public int My_ItemPower {
        get { return MyItemPower; } set { MyItemPower = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public Map My_World {
        get { return MyWorld; } set { MyWorld = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int My_X {
        get { return MyX; } set { MyX = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int My_Y {
        get { return MyY; } set { MyY = value; InvalidateProperties(); }
    }
    ...
    public static void GiveGiftBonus(Item item, int val1, int val2, int val3, int val4, int val5, double sk1, double sk2, double sk3, double sk4, double sk5, int slay1, int slay2)
    {
        if (item is BaseWeapon)
        {
            ...
            {
                ((BaseWeapon)item).SkillBonuses.SetValues(0, MorphingItem.GetMorphSkill(5), sk1);
            }
            else if (val1 > 0)
            {
        ...
        else if (item is BaseClothing)
        {
            ...
            {
                ((BaseClothing)item).SkillBonuses.SetValues(0, MorphingItem.GetMorphSkill(5), sk1);
            }
            else if (val1 > 0)
            {
