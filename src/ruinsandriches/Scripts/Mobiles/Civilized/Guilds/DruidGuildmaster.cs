...
public class DruidGuildmaster : BaseGuildmaster
{
    ...
    public void BeginRepair(Mobile from)
    {
        ...
        {
            SayTo(from, "If you want me to tend to your pack animal for up to 5 journeys, it will cost you " + nCost.ToString() + " gold.");
        }
    ...
    public override bool OnDragDrop(Mobile from, Item dropped)
    {
        ...
        else if (dropped is PackBeastItem)
        {
            ...
            {
                ball.ItemID = 0x20DB; ball.PorterType = 23; ball.Hue = 0; sMessage = "You may like a pack brown bear instead.";
            }
