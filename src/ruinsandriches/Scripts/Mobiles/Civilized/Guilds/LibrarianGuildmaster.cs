...
public class LibrarianGuildmaster : BaseGuildmaster
{
    ...
    public void BeginRepair(Mobile from)
    {
        ...
        {
            SayTo(from, "If you want me to identify an item, wands cost " + nCost.ToString() + " gold and artifacts cost " + nCost2.ToString() + " gold. Or maybe identify another type item for " + idCost.ToString() + " gold?");
        }
