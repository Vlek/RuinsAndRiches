...
public class Citizens : BaseCreature
{
    ...
    public int Citizen_Service {
        get { return CitizenService; } set { CitizenService = value; InvalidateProperties(); }
    }

    public int CitizenType;
    [CommandProperty(AccessLevel.Owner)]
    public int Citizen_Type {
        get { return CitizenType; } set { CitizenType = value; InvalidateProperties(); }
    }

    public int CitizenCost;
    [CommandProperty(AccessLevel.Owner)]
    public int Citizen_Cost {
        get { return CitizenCost; } set { CitizenCost = value; InvalidateProperties(); }
    }

    public string CitizenPhrase;
    [CommandProperty(AccessLevel.Owner)]
    public string Citizen_Phrase {
        get { return CitizenPhrase; } set { CitizenPhrase = value; InvalidateProperties(); }
    }

    public string CitizenRumor;
    [CommandProperty(AccessLevel.Owner)]
    public string Citizen_Rumor {
        get { return CitizenRumor; } set { CitizenRumor = value; InvalidateProperties(); }
    }
    ...
    public DateTime NextTalk {
        get { return m_NextTalk; } set { m_NextTalk = value; }
    }
    ...
    public void SetupCitizen()
    {
        ...
        {
            CitizenRumor = preface + " " + Server.Misc.TavernPatrons.CommonTalk("", city, dungeon, this, adventurer, true) + ".";
        }
        ...
        if (this is TavernPatronNorth || this is TavernPatronSouth || this is TavernPatronEast || this is TavernPatronWest)
        {
        ...
        if (CitizenService == 1)
        {
            if (CitizenType == 1)
            {
                CitizenPhrase = phrase + " I can recharge any wands you may have with you, but only up to a certain amount. If you want my help, then simply hand me your wand so I can perform the ritual needed.";
            }
            else if (CitizenType == 2)
            {
                CitizenPhrase = phrase + " I am quite a skilled blacksmith, so if you need any metal armor repaired I can do it for you. Just hand me the armor and I will see what I can do.";
            }
            else
            {
                CitizenPhrase = phrase + " If you need a chest or box unlocked, I can help you with that. Just hand me the container and I will see what I can do. I promise to give it back.";
            }
        }
        else if (CitizenService == 2)
        {
            if (CitizenType == 2)
            {
                CitizenPhrase = phrase + " I am quite a skilled blacksmith, so if you need any metal weapons repaired I can do it for you. Just hand me the weapon and I will see what I can do.";
            }
            else
            {
                CitizenPhrase = phrase + " I am quite a skilled leather worker, so if you need any leather item repaired I can do it for you. Just hand me the item and I will see what I can do.";
            }
        }
        else if (CitizenService == 3)
        {
            if (CitizenType == 2)
            {
                CitizenPhrase = phrase + " I am quite a skilled wood worker, so if you need any wooden weapons repaired I can do it for you. Just hand me the weapon and I will see what I can do.";
            }
            else
            {
                CitizenPhrase = phrase + " I am quite a skilled wood worker, so if you need any wooden weapons repaired I can do it for you. Just hand me the weapon and I will see what I can do.";
        ...
        else if (CitizenService == 4)
        {
            if (CitizenType == 2)
            {
                CitizenPhrase = phrase + " I am quite a skilled wood worker, so if you need any wooden armor repaired I can do it for you. Just hand me the armor and I will see what I can do.";
            }
            else
            {
                CitizenPhrase = phrase + " I am quite a skilled wood worker, so if you need any wooden armor repaired I can do it for you. Just hand me the armor and I will see what I can do.";
        ...
        {
            string aty1 = "a magic item"; if (Utility.RandomBool())
            {
            ...
            string aty2 = "found"; if (Utility.RandomBool())
            {
                aty2 = "discovered";
            }
            string aty3 = "willing to part with"; if (Utility.RandomBool())
            {
        ...
        else if (CitizenType == 20 && CitizenService == 20)
        {
            ...
            if (ingot >= 32768)
            {
                metal = "iron"; steel = 0x5094; hue = 0; qty = 80; cost = 2;
            }
            else if (ingot >= 16384)
            {
                metal = "dull copper"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("dull copper", "", 0); qty = 75; cost = 4;
            }
            else if (ingot >= 8192)
            {
                metal = "shadow iron"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("shadow iron", "", 0); qty = 70; cost = 6;
            }
            else if (ingot >= 4096)
            {
                metal = "copper"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("copper", "", 0); qty = 65; cost = 8;
            }
            else if (ingot >= 2048)
            {
                metal = "bronze"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("bronze", "", 0); qty = 60; cost = 10;
            }
            else if (ingot >= 1024)
            {
                metal = "gold"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("gold", "", 0); qty = 55; cost = 12;
            }
            else if (ingot >= 512)
            {
                metal = "agapite"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("agapite", "", 0); qty = 50; cost = 14;
            }
            else if (ingot >= 256)
            {
                metal = "verite"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("verite", "", 0); qty = 45; cost = 16;
            }
            else if (ingot >= 128)
            {
                metal = "valorite"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("valorite", "", 0); qty = 40; cost = 18;
            }
            else if (ingot >= 64)
            {
                metal = "nepturite"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("nepturite", "", 0); qty = 35; cost = 20;
            }
            else if (ingot >= 32)
            {
                metal = "obsidian"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("obsidian", "", 0); qty = 30; cost = 22;
            }
            else if (ingot >= 16)
            {
                metal = "steel"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("steel", "", 0); qty = 25; cost = 24;
            }
            else if (ingot >= 8)
            {
                metal = "brass"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("brass", "", 0); qty = 20; cost = 26;
            }
            else if (ingot >= 4)
            {
                metal = "mithril"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("mithril", "", 0); qty = 15; cost = 28;
            }
            else if (ingot >= 2)
            {
                metal = "xormite"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("xormite", "", 0); qty = 10; cost = 30;
            }
            else
            {
                metal = "dwarven"; steel = 0x5095; hue = MaterialInfo.GetMaterialColor("dwarven", "", 0); qty = 5; cost = 32;
            }
            ...
            string sell = "willing to part with"; if (Utility.RandomBool())
            {
            ...
            string cave = "cave"; if (Utility.RandomBool())
            {
                cave = "mine";
            }
        ...
        else if (CitizenType == 21 && CitizenService == 21)
        {
            ...
            if (boards >= 32768)
            {
                wood = "regular"; tree = 0x5088; hue = 0; qty = 80; cost = 2;
            }
            else if (boards >= 16384)
            {
                wood = "ash"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("ash", "", 0); qty = 75; cost = 4;
            }
            else if (boards >= 8192)
            {
                wood = "cherry"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("cherry", "", 0); qty = 70; cost = 6;
            }
            else if (boards >= 4096)
            {
                wood = "ebony"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("ebony", "", 0); qty = 65; cost = 8;
            }
            else if (boards >= 2048)
            {
                wood = "golden oak"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("golden oak", "", 0); qty = 60; cost = 10;
            }
            else if (boards >= 1024)
            {
                wood = "hickory"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("hickory", "", 0); qty = 55; cost = 12;
            }
            else if (boards >= 512)
            {
                wood = "mahogany"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("mahogany", "", 0); qty = 50; cost = 14;
            }
            else if (boards >= 256)
            {
                wood = "oak"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("oak", "", 0); qty = 45; cost = 16;
            }
            else if (boards >= 128)
            {
                wood = "pine"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("pine", "", 0); qty = 40; cost = 18;
            }
            else if (boards >= 64)
            {
                wood = "ghostwood"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("ghostwood", "", 0); qty = 35; cost = 20;
            }
            else if (boards >= 32)
            {
                wood = "rosewood"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("rosewood", "", 0); qty = 30; cost = 22;
            }
            else if (boards >= 16)
            {
                wood = "walnut"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("walnut", "", 0); qty = 25; cost = 24;
            }
            else if (boards >= 8)
            {
                wood = "petrified"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("petrified", "", 0); qty = 20; cost = 26;
            }
            else if (boards >= 4)
            {
                wood = "driftwood"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("driftwood", "", 0); qty = 15; cost = 28;
            }
            else
            {
                wood = "elven"; tree = 0x5085; hue = MaterialInfo.GetMaterialColor("elven", "", 0); qty = 10; cost = 30;
            }
            ...
            string forest = "woods"; if (Utility.RandomBool())
            {
                forest = "forest";
            }
        ...
        else if (CitizenType == 22 && CitizenService == 22)
        {
            ...
            if (skin >= 32768)
            {
                flesh = "regular"; hide = 0x5092; hue = 0; qty = 80; cost = 2;
            }
            else if (skin >= 16384)
            {
                flesh = "deep sea"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("deep sea", "", 0); qty = 75; cost = 4;
            }
            else if (skin >= 8192)
            {
                flesh = "lizard"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("lizard", "", 0); qty = 70; cost = 6;
            }
            else if (skin >= 4096)
            {
                flesh = "serpent"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("serpent", "", 0); qty = 65; cost = 8;
            }
            else if (skin >= 2048)
            {
                flesh = "necrotic"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("necrotic", "", 0); qty = 60; cost = 10;
            }
            else if (skin >= 1024)
            {
                flesh = "volcanic"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("volcanic", "", 0); qty = 55; cost = 12;
            }
            else if (skin >= 512)
            {
                flesh = "frozen"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("frozen", "", 0); qty = 50; cost = 14;
            }
            else if (skin >= 256)
            {
                flesh = "goliath"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("goliath", "", 0); qty = 45; cost = 16;
            }
            else if (skin >= 128)
            {
                flesh = "draconic"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("draconic", "", 0); qty = 40; cost = 18;
            }
            else if (skin >= 64)
            {
                flesh = "hellish"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("hellish", "", 0); qty = 35; cost = 20;
            }
            else if (skin >= 32)
            {
                flesh = "dinosaur"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("dinosaur", "", 0); qty = 30; cost = 22;
            }
            else
            {
                flesh = "alien"; hide = 0x5093; hue = MaterialInfo.GetMaterialColor("alien", "", 0); qty = 10; cost = 30;
            }
        ...
        else if (CitizenType == 23 && CitizenService == 23)
        {
            ...
            if (ingot >= 32768)
            {
                metal = "iron"; steel = 0x5084; hue = 0; qty = 80; cost = 2;
            }
            else if (ingot >= 16384)
            {
                metal = "dull copper"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("dull copper", "", 0); qty = 75; cost = 4;
            }
            else if (ingot >= 8192)
            {
                metal = "shadow iron"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("shadow iron", "", 0); qty = 70; cost = 6;
            }
            else if (ingot >= 4096)
            {
                metal = "copper"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("copper", "", 0); qty = 65; cost = 8;
            }
            else if (ingot >= 2048)
            {
                metal = "bronze"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("bronze", "", 0); qty = 60; cost = 10;
            }
            else if (ingot >= 1024)
            {
                metal = "gold"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("gold", "", 0); qty = 55; cost = 12;
            }
            else if (ingot >= 512)
            {
                metal = "agapite"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("agapite", "", 0); qty = 50; cost = 14;
            }
            else if (ingot >= 256)
            {
                metal = "verite"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("verite", "", 0); qty = 45; cost = 16;
            }
            else if (ingot >= 128)
            {
                metal = "valorite"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("valorite", "", 0); qty = 40; cost = 18;
            }
            else if (ingot >= 64)
            {
                metal = "nepturite"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("nepturite", "", 0); qty = 35; cost = 20;
            }
            else if (ingot >= 32)
            {
                metal = "obsidian"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("obsidian", "", 0); qty = 30; cost = 22;
            }
            else if (ingot >= 16)
            {
                metal = "steel"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("steel", "", 0); qty = 25; cost = 24;
            }
            else if (ingot >= 8)
            {
                metal = "brass"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("brass", "", 0); qty = 20; cost = 26;
            }
            else if (ingot >= 4)
            {
                metal = "mithril"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("mithril", "", 0); qty = 15; cost = 28;
            }
            else if (ingot >= 2)
            {
                metal = "xormite"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("xormite", "", 0); qty = 10; cost = 30;
            }
            else
            {
                metal = "dwarven"; steel = 0x50B5; hue = MaterialInfo.GetMaterialColor("dwarven", "", 0); qty = 5; cost = 32;
            }
        ...
        {
            PackItem(new reagents_magic_jar1()); CitizenCost = Utility.RandomMinMax(70, 150) * 10;
        }
        else if (CitizenType == 1 && CitizenService == 3)
        {
            PackItem(new reagents_magic_jar2()); CitizenCost = Utility.RandomMinMax(50, 90) * 10;
        }
        else if (CitizenType == 1 && CitizenService == 4)
        {
            PackItem(new reagents_magic_jar3()); CitizenCost = Utility.RandomMinMax(180, 300) * 10;
        }
        ...
        else if (CitizenType == 1 && CitizenService == 7)
        {
            ...
            if (scroll is PainSpikeScroll || scroll is EvilOmenScroll || scroll is WraithFormScroll || scroll is ArchCureScroll || scroll is ArchProtectionScroll || scroll is CurseScroll || scroll is FireFieldScroll || scroll is GreaterHealScroll || scroll is LightningScroll || scroll is ManaDrainScroll || scroll is RecallScroll)
            {
                mult = 10;
            }

            else if (scroll is MindRotScroll || scroll is SummonFamiliarScroll || scroll is HorrificBeastScroll || scroll is AnimateDeadScroll || scroll is BladeSpiritsScroll || scroll is DispelFieldScroll || scroll is IncognitoScroll || scroll is MagicReflectScroll || scroll is MindBlastScroll || scroll is ParalyzeScroll || scroll is PoisonFieldScroll || scroll is SummonCreatureScroll)
            {
                mult = 20;
            }

            else if (scroll is DispelScroll || scroll is EnergyBoltScroll || scroll is ExplosionScroll || scroll is InvisibilityScroll || scroll is MarkScroll || scroll is MassCurseScroll || scroll is ParalyzeFieldScroll || scroll is RevealScroll)
            {
                mult = 40;
            }
        ...
        else if (CitizenService == 5)
        {
            ...
            if (chance < 80)
            {
                ...
                {
                    BaseRunicTool.ApplyAttributesTo((BaseWeapon)arty, false, luck, props, val, val);
                }
                else if (arty is BaseHat)
                {
                    BaseRunicTool.ApplyAttributesTo((BaseHat)arty, false, luck, props, val, val);
                }
                ...
                {
                    BaseRunicTool.ApplyAttributesTo((BaseArmor)arty, false, luck, props, val, val);
                }
                else if (arty is BaseJewel)
                {
                    BaseRunicTool.ApplyAttributesTo((BaseJewel)arty, false, luck, props, val, val);
                }
    ...
    public static void CreateCitizenss(Item spot)
    {
        ...
        else if (Worlds.IsSeaTown(spot.Location, spot.Map) && !reg.IsPartOf("the Port"))
        {
        }                                                                                                        // SEA AREAS BUT NOT THE MAIN PORT...NO HORSES
        ...
        if (spot is LawnItem && (spot.Map).CanSpawnMobile(cit1.X, cit1.Y, z_1) && !(Region.Find(cit1, spot.Map) is HouseRegion))
        {
            canSpawn1 = true; cit1 = new Point3D((spot.X - mod), (spot.Y), z_1);
        }
        else if (spot is ShantyItem && (spot.Map).CanSpawnMobile(cit1.X, cit1.Y, z_1) && Region.Find(cit1, spot.Map) is HouseRegion)
        {
            canSpawn1 = true; cit1 = new Point3D((spot.X - mod), (spot.Y), z_1);
        }
        else if (spot is LawnItem || spot is ShantyItem)
        ...
        if (spot is ShantyItem && (spot.Map).CanSpawnMobile(cit2.X, cit2.Y, z_2) && !(Region.Find(cit2, spot.Map) is HouseRegion))
        {
            canSpawn2 = true; cit2 = new Point3D((spot.X), (spot.Y - mod), z_2);
        }
        else if (spot is ShantyItem && (spot.Map).CanSpawnMobile(cit2.X, cit2.Y, z_2) && Region.Find(cit2, spot.Map) is HouseRegion)
        {
            canSpawn2 = true; cit2 = new Point3D((spot.X), (spot.Y - mod), z_2);
        }
        else if (spot is LawnItem || spot is ShantyItem)
        ...
        if (spot is LawnItem && (spot.Map).CanSpawnMobile(cit3.X, cit3.Y, z_3) && !(Region.Find(cit3, spot.Map) is HouseRegion))
        {
            canSpawn3 = true; cit3 = new Point3D((spot.X + mod), (spot.Y), z_3);
        }
        else if (spot is LawnItem && (spot.Map).CanSpawnMobile(cit3.X, cit3.Y, z_3) && Region.Find(cit3, spot.Map) is HouseRegion)
        {
            canSpawn3 = true; cit3 = new Point3D((spot.X + mod), (spot.Y), z_3);
        }
        else if (spot is LawnItem || spot is ShantyItem)
        ...
        if (spot is LawnItem && (spot.Map).CanSpawnMobile(cit4.X, cit4.Y, z_4) && !(Region.Find(cit4, spot.Map) is HouseRegion))
        {
            canSpawn4 = true; cit4 = new Point3D((spot.X), (spot.Y + mod), z_4);
        }
        else if (spot is LawnItem && (spot.Map).CanSpawnMobile(cit4.X, cit4.Y, z_4) && Region.Find(cit4, spot.Map) is HouseRegion)
        {
            canSpawn4 = true; cit4 = new Point3D((spot.X), (spot.Y + mod), z_4);
        }
        else if (spot is LawnItem || spot is ShantyItem)
        ...
        while (process)
        {
            ...
            if (Utility.RandomBool() && humanE == 0 && canSpawn1)
            {
                ...
                while (citizen == null)
                {
                    ...
                    {
                        humanE = 1;
                        if (MyServerSettings.Humanoids() && humanoids < 1 && !(spot is LawnItem) && !(spot is ShantyItem))
                        {
                            citizen.Delete(); citizen = new Humanoid(); humanoids++;
                        }
                        else if (spot is LawnItem || spot is ShantyItem)
                        {
                            citizen.Delete(); citizen = new HouseVisitor();
                        }
                        ...
                        {
                            Humanoid.HumanoidSetup(citizen, false); total = total - 1;
                        }
                        if (mount)
                        {
