...
public class StoveHit : Item
{
    ...
    public override void OnDoubleClick(Mobile from)
    {
        if (from is Citizens)
        {
            ...
            if (ItemID == 0x568B)
            {
                ItemID = Utility.RandomList(0x568C, 0x568D); from.PlaySound(Utility.RandomList(0x059, 0x057));
            }
            else if (ItemID == 0x568C)
            {
                ItemID = 0x568B; from.PlaySound(Utility.RandomList(0x5CF, 0x5CA, 0x345));
            }
            else if (ItemID == 0x568D)
            {
                ItemID = 0x568E; from.PlaySound(Utility.RandomList(0x5CF, 0x5CA, 0x345));
            }
