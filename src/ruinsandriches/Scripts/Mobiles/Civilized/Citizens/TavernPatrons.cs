...
class TavernPatrons
{
    public static void RemoveSomeGear(Mobile m, bool helm)
    {
        ...
        if (m.FindItemOnLayer(Layer.FirstValid) != null && m.FindItemOnLayer(Layer.FirstValid) is BaseShield)
        {
            m.FindItemOnLayer(Layer.FirstValid).Delete();
        }
        if (m.FindItemOnLayer(Layer.FirstValid) != null && m.FindItemOnLayer(Layer.FirstValid) is BaseWeapon)
        {
            m.FindItemOnLayer(Layer.FirstValid).Delete();
        }
    ...
    public static string GetTitle()
    {
        ...
        switch (Utility.RandomMinMax(0, 107))
        {
            ...
            case 33: myTitle = "the Fearless"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Brave";
                }
                break;
            case 34: myTitle = "the Savage"; if (Utility.RandomMinMax(1, 2) == 1)
                {
            ...
            case 47: myTitle = "the Strong"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Weak";
                }
                break;
            ...
            case 60: myTitle = "the Calm"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Frantic";
                }
                break;
            ...
            case 69: myTitle = "the Masked"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Veiled";
                }
                break;
            case 70: myTitle = "the Merciful"; if (Utility.RandomMinMax(1, 2) == 1)
                {
            ...
            case 75: myTitle = "the Mysterious"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Unknown";
                }
                break;
            case 76: myTitle = "the Obscure"; break;
            case 77: myTitle = "the Old"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Young";
                }
                break;
            ...
            case 82: myTitle = "the Quick"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Slow";
                }
                break;
            ...
            case 90: myTitle = "the Short"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Tall";
                }
                break;
            ...
            case 97: myTitle = "the Traveler"; if (Utility.RandomMinMax(1, 2) == 1)
                {
            ...
            case 100: myTitle = "the Steady"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Unready";
                }
                break;
            case 101: myTitle = "the Gentle"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Cruel";
                }
                break;
            case 102: myTitle = "the Lost"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Exiled";
                }
                break;
            case 103: myTitle = "the Careless"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Clumsy";
                }
                break;
            case 104: myTitle = "the Hopeful"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Trustful";
                }
                break;
            case 105: myTitle = "the Angry"; if (Utility.RandomMinMax(1, 2) == 1)
                {
                    myTitle = "the Timid";
                }
                break;
            ...
            foreach (Item target in World.Items.Values)
            {
                if (target is FlamesBase || target is BaneBase || target is PaganBase || target is RunesBase)
                {
                    if (target is FlamesBase)
                    {
                        if (rare == 2)
                        {
                            what = "the Book of Truth";                           FlamesBase targ2 = (FlamesBase)target; if (targ2.ItemType == 1)
                            {
                        ...
                        {
                            what = "the Bell of Courage";            FlamesBase targ3 = (FlamesBase)target; if (targ3.ItemType == 2)
                            {
                                where = Server.Misc.Worlds.GetRegionName(target.Map, target.Location);
                            }
                        }
                        ...
                        {
                            what = "the Candle of Love";             FlamesBase targ4 = (FlamesBase)target; if (targ4.ItemType == 3)
                            {
                                where = Server.Misc.Worlds.GetRegionName(target.Map, target.Location);
                            }
                        }
                    ...
                    else if (target is BaneBase)
                    {
                        if (rare == 5)
                        {
                            what = "the Scales of Ethicality";            BaneBase targ5 = (BaneBase)target; if (targ5.ItemType == 1)
                            {
                                where = Server.Misc.Worlds.GetRegionName(target.Map, target.Location);
                            }
                        }
                        ...
                        {
                            what = "the Orb of Logic";                       BaneBase targ6 = (BaneBase)target; if (targ6.ItemType == 2)
                            {
                                where = Server.Misc.Worlds.GetRegionName(target.Map, target.Location);
                            }
                        }
                        ...
                        {
                            what = "the Lantern of Discipline";      BaneBase targ7 = (BaneBase)target; if (targ7.ItemType == 3)
                            {
                                where = Server.Misc.Worlds.GetRegionName(target.Map, target.Location);
                            }
                        }
                    ...
                    else if (target is PaganBase)
                    {
                        if (rare == 8)
                        {
                            what = "the Breath of Air";                           PaganBase targ8 = (PaganBase)target; if (targ8.ItemType == 1)
                            {
                                where = Server.Misc.Worlds.GetRegionName(target.Map, target.Location);
                            }
                        }
                        ...
                        {
                            what = "the Tongue of Flame";            PaganBase targ9 = (PaganBase)target; if (targ9.ItemType == 2)
                            {
                                where = Server.Misc.Worlds.GetRegionName(target.Map, target.Location);
                            }
                        }
                        ...
                        {
                            what = "the Heart of Earth";            PaganBase targ10 = (PaganBase)target; if (targ10.ItemType == 3)
                            {
                                where = Server.Misc.Worlds.GetRegionName(target.Map, target.Location);
                            }
                        }
                        ...
                        {
                            what = "the Tear of the Seas";          PaganBase targ11 = (PaganBase)target; if (targ11.ItemType == 4)
                            {
                                where = Server.Misc.Worlds.GetRegionName(target.Map, target.Location);
                            }
                        }
    ...
    public static string CommonTalk(string sWords, string city, string dungeon, Mobile from, string adventurer, bool useAll)
    {
        ...
        switch (Utility.RandomMinMax(0, max))
        {
            ...
            case 154: sWords = GetRareLocation(from, false, true); if (from is HouseVisitor)
                {
    ...
    public static void GetChatter(Mobile patron)
    {
        ...
        switch (Utility.RandomMinMax(1, CommonTalkingCount))
        {
            ...
            case 20:
                string item20 = Server.Items.SomeRandomNote.GetSpecialItem(relic, 1);         if (patron is HouseVisitor)
                {
                    item20 = relics;
                }
            ...
            case 21:
                string item21 = Server.Items.SomeRandomNote.GetSpecialItem(relic, 1);         if (patron is HouseVisitor)
                {
                    item21 = relics;
                }
            ...
            case 22:
                string item22 = Server.Items.SomeRandomNote.GetSpecialItem(relic, 1);         if (patron is HouseVisitor)
                {
                    item22 = relics;
                }
            ...
            case 23: sSpeech = GetRareLocation(patron, false, false); if (patron is HouseVisitor)
                {
                    sSpeech = "We need to go to " + city + " if we are going to find the " + relics + ".";
                }
                break;
            ...
            case 48:
                ...
                if (Utility.RandomBool())
                {
                    sSpeech = "" + sSource + " a " + prize + " of " + RandomThings.GetRandomCoinReward() + " gold if we " + misc + " " + RandomThings.GetRandomGirlName() + " the " + RandomThings.GetBoyGirlJob(1) + ".";
                }
                else
                {
                    sSpeech = "" + sSource + " a " + prize + " of " + RandomThings.GetRandomCoinReward() + " gold if we " + misc + " " + RandomThings.GetRandomBoyName() + " the " + RandomThings.GetBoyGirlJob(0) + ".";
                }
                break;
            case 49:
                misc = "a war";
                ...
                if (Utility.RandomBool())
                {
                    sSpeech = "" + sSource + " " + misc + " between " + RandomThings.MadeUpCity() + " and " + RandomThings.MadeUpCity() + ".";
                }
                else
                {
                    sSpeech = "" + sSource + " " + misc + " between the " + RandomThings.GetRandomKingdomName() + " " + RandomThings.GetRandomKingdom() + " and the " + RandomThings.GetRandomKingdomName() + " " + RandomThings.GetRandomKingdom() + ".";
                }
                break;
            case 50:
                misc = "";      if (Utility.RandomBool())
                {
                    misc = RandomThings.GetRandomGirlNoble() + " ";
                }
                string mis2 = "";       if (Utility.RandomBool())
                {
            ...
            case 54:
                ...
                string gbv346 = RandomThings.GetRandomCity(); if (Utility.RandomBool())
                {
            ...
            case 55:
                ...
                string bjj311 = RandomThings.GetRandomCity(); if (Utility.RandomBool())
                {
        ...
        if (sWords == "")
        {
            ...
            {
                sWords = Server.Misc.LoggingFunctions.LogSpeakQuest(); LogReader = 2;
            }
        }
        ...
        else if (reg.Name == "the Basement" || reg.Name == "the Dungeon Room" || reg.Name == "the Camping Tent")
        {
            patron.Say(sTent);
        }
        else if (!(patron is TavernPatronNorth || patron is TavernPatronSouth || patron is TavernPatronEast || patron is TavernPatronWest))
        {
            patron.Say(sCitizen);
        }
        else
