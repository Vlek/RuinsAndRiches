...
public class NPCRace : Item
{
    ...
    public static void ConfigureCostume(int race, NPCRace costume)
    {
        ...
        if (configs.Length > 0)
        {
            ...
            foreach (string stats in setups)
            {
                ...
                {
                    costume.SpeciesItemID = Int32.Parse(stats); costume.ItemID = costume.SpeciesItemID;
                }
                else if (entry == 3)
                {
    ...
    public int SpeciesBody {
        get { return m_SpeciesBody; } set { m_SpeciesBody = value; }
    }

    public int m_SpeciesItemID;
    [CommandProperty(AccessLevel.GameMaster)]
    public int SpeciesItemID {
        get { return m_SpeciesItemID; } set { m_SpeciesItemID = value; }
    }
    ...
    public int SpeciesGender {
        get { return m_SpeciesGender; } set { m_SpeciesGender = value; }
    }
}
}
