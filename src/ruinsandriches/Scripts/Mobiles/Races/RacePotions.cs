    ...
    public class RacePotionsGump : Gump
    {
        ...
        public RacePotionsGump(Mobile from, int tavern) : base(50, 50)
        {
            ...
            else
            {
                ...
                while (g < 44)
                {
                    ...
                    if (g == 1 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Aquatic</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 2 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Bugbear</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 3 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Centaur</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 4 && go >= 2)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Cyclops</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 5 && go >= 2)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Daemon</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 6 && go >= 2)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Dagon</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 7 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Demon</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 8 && go >= 3)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Devil</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 9 && go >= 2)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Dragon</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 10 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Drakkul</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 11 && go >= 2)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Ettin</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 12 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Fey</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 13 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Gargoyle</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 14 && go >= 3)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Giant</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 15 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Gnoll</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 16 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Goblin</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 17 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Golem</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 18 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Hobgoblin</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 19 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Illithid</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 20 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Imp</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 21 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Kilrathi</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 22 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Kobold</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 23 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Minotaur</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 24 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Mummy</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 25 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Mushroom</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 26 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Naga</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 27 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Ogre</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 28 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Orc</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 29 && go >= 2)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Owlbear</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 30 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Plant</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 31 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Reptilian</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 32 && go >= 2)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Revenant</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 33 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Rodent</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 34 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Salamander</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 35 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Satyr</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 36 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Serpent</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 37 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Skeleton</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 38 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Sphinx</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 39 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Succubus</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 40 && go >= 2)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Titan</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 41 && go >= 2)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Tree</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 42 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Troll</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 43 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Vampyre</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                    else if (g == 44 && go >= 1)
                    {
                        gc++; AddButton(gx, gy, 2447, 2447, g + gb, GumpButtonType.Reply, 0); AddHtml(gx + 18, gy - 4, 98, 20, @"<BODY><BASEFONT Color=" + color + ">Zombi</BASEFONT></BODY>", (bool)false, (bool)false); gy = gy + gm;
                    }
                }
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            else if (info.ButtonID > 6000 && info.ButtonID < 6100)
            {
                ...
                {
                    move = 151; if (MyServerSettings.MonsterCharacters() > 1)
                    {
                        move = 150;
                    }
                }
