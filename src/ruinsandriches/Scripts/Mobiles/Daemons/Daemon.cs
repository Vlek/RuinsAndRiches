        ...
        else
        {
            ...
            else if (reg.IsPartOf("the Blood Temple"))
            {
                category = "blood";
                     ...
                     && this.Y > 21 && this.X < 6354 && this.Y < 40)
            {
                category = "toxic";
            }
            else if (reg.IsPartOf("the Tower of Brass")
                     && Server.Misc.SummonQuests.IsInLocation(this.Home.X, this.Home.Y, this.Map, 6519, 3572, Map.Sosaria))
            {
                category = "forest";
            }
            else if (reg.IsPartOf("the Temple of Osirus"))
            {
                category = "jungle"; if (Utility.RandomBool())
                {
                    category = "forest";
                }
            }
            ...
            else if (Server.Misc.SummonQuests.IsInLocation(this.Home.X, this.Home.Y, this.Map, 4261, 3410, Map.Lodor))
            {
                category = "dungeon";
            }
            else if (Server.Misc.SummonQuests.IsInLocation(this.Home.X, this.Home.Y, this.Map, 1094, 3384, Map.Sosaria))
            {
                category = "dungeon";
            }
            else if (Server.Misc.SummonQuests.IsInLocation(this.Home.X, this.Home.Y, this.Map, 6786, 317, Map.Sosaria))
            {
                category = "dungeon";
            }
            else if (Server.Misc.SummonQuests.IsInLocation(this.Home.X, this.Home.Y, this.Map, 6873, 202, Map.Sosaria))
            {
                category = "dungeon";
            }
            else if (reg.IsPartOf("the Forgotten Halls")
                     && Server.Misc.SummonQuests.IsInLocation(this.Home.X, this.Home.Y, this.Map, 409, 3670, Map.SavagedEmpire))
            {
                category = "swamp";
            }
