...
public class Balron : BaseCreature
{
    ...
    public Balron() : base(AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4)
    {
        ...
        Title = "balron"; if (Utility.RandomBool())
        {
            Title = "balrog";
        }
        Body        = 427;
    ...
    public override void OnAfterSpawn()
    {
        ...
        {
            this.WhisperHue = 666; this.Home = this.Location;
        }
    ...
    public string r_MainColor {
        get { return rMainColor; } set { rMainColor = value; InvalidateProperties(); }
    }
    ...
    public void CreateBalron(string terrain)
    {
        if (rHue < 1)
        {
            ...
            if (rCategory == "cold")
            {
                phys = 45;      fire = 5;  cold = 60; pois = 20; engy = 20;
            }
            else if (rCategory == "electrical")
            {
                phys = 45;      fire = 20; cold = 20; pois = 5;  engy = 60;
            }
            else if (rCategory == "fire")
            {
                phys = 45;      fire = 60; cold = 5;  pois = 20; engy = 20;
            }
            else if (rCategory == "poison")
            {
                phys = 45;      fire = 20; cold = 20; pois = 60; engy = 5;
            }
            else if (rCategory == "radiation")
            {
                phys = 45;      fire = 25; cold = 5;  pois = 25; engy = 55;
            }
            else if (rCategory == "sand")
            {
                phys = 35;      fire = 55; cold = 20; pois = 5;  engy = 30;
            }
            else if (rCategory == "steam")
            {
                phys = 45;      fire = 55; cold = 5;  pois = 20; engy = 20;
            }
            else if (rCategory == "void")
            {
                phys = 35;      fire = 40; cold = 40; pois = 40; engy = 40;
            }
            else if (rCategory == "weed")
            {
                phys = 35;      fire = 15; cold = 15; pois = 55; engy = 40;
            }

            else if (rCategory == "wind")
            {
                phys = 35;      fire = 20; cold = 25; pois = 20; engy = 55;
            }
            else if (rCategory == "storm")
            {
                phys = 35;      fire = 55; cold = 25; pois = 20; engy = 55;
            }
            else if (rCategory == "star")
            {
                phys = 35;      fire = 20; cold = 25; pois = 20; engy = 55;
            ...
            {
                phys = 45;      fire = 30; cold = 30; pois = 30; engy = 30;
            }
    ...
    public static void ExplodeDeath(Mobile from, int form)
    {
        ...
        if (form == 8)                   // LARGE SAND BREATH ----------------------------------------------------------------------------------------------
        {
            while (radius > count)
            {
                count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x5590, 30, 10, Utility.RandomList(0xB4D, 0xB4E), 0);
            }
        ...
        else if (form == 9)                   // LARGE FIRE BREATH ----------------------------------------------------------------------------------------------
        {
            while (radius > count)
            {
                count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x3709, 30, 10);
            }
        ...
        else if (form == 10)                   // LARGE POISON BREATH -------------------------------------------------------------------------------------------
        {
            if (Utility.RandomMinMax(1, 2) == 1)
            {
                while (radius > count)
                {
                    count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x3400, 60);
                }
            ...
            else
            {
                while (radius > count)
                {
                    count++; Effects.SendLocationParticles(EffectItem.Create(BlastZone(count, from.X, from.Y, from.Z), from.Map, EffectItem.DefaultDuration), 0x36B0, 1, 14, 63, 7, 9915, 0);
                }
        ...
        else if (form == 11)                   // LARGE RADIATION -----------------------------------------------------------------------------------------------
        {
            while (radius > count)
            {
                count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x3400, 60, 0xB96, 0);
            }
            Effects.PlaySound(from.Location, from.Map, 0x108);
        }
        else if (form == 12)                   // LARGE COLD BREATH ---------------------------------------------------------------------------------------------
        {
            while (radius > count)
            {
                count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x1A84, 30, 10, 0x9C1, 0);
            }
            from.PlaySound(0x10B);
        }
        else if (form == 13)                   // LARGE ELECTRICAL BREATH ---------------------------------------------------------------------------------------
        {
            while (radius > count)
            {
                count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, Utility.RandomList(0x3967, 0x3979), 30, 10);
            }
        ...
        else if (form == 16)                   // LARGE STEAM BREATH --------------------------------------------------------------------------------------------
        {
            while (radius > count)
            {
                count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x3400, 60, 10, 0x9C4, 0);
            }
            Effects.PlaySound(from.Location, from.Map, 0x108);
        }
        else if (form == 23 || form == 24 || form == 25)                   // LARGE VOID BREATH -----------------------------------------------------------------
        {
            ...
            while (radius > count)
            {
                count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x3400, 60, color, 0);
            }
            Effects.PlaySound(from.Location, from.Map, 0x108);
        }
        else if (form == 34)                   // LARGE WEED BREATH ---------------------------------------------------------------------------------------------
        {
            while (radius > count)
            {
                count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x3400, 60, 0xB97, 0);
            }
        ...
        else if (form == 45)                   // STAR CREATURE ATTACK ------------------------------------------------------------------------------------------
        {
            ...
            else
            {
                while (radius > count)
                {
                    count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x2A4E, 30, 10);
                }
                from.PlaySound(0x5C3);
            }
        }
        ...
        else if (form == 47)                   // AIR BLOWING BREATH --------------------------------------------------------------------------------------------
        {
            while (radius > count)
            {
                count++; Effects.SendLocationEffect(BlastZone(count, from.X, from.Y, from.Z), from.Map, 0x5590, 30, 10, 0xB24, 0);
            }
            from.PlaySound(0x10B);
        }
    }
...
public class DemonGate : Item
{
    ...
    public static void MakeDemonGate(Mobile m)
    {
        ...
        if (m is Balron)
        {
            Balron balron = (Balron)m; color = balron.rMainColor;
        }
        else if (m is Daemon)
        {
            Daemon daemon = (Daemon)m; color = daemon.rMainColor;
        }
