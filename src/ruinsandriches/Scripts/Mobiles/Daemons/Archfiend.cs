...
public class Archfiend : BaseCreature
{
    ...
    public override void OnAfterSpawn()
    {
        ...
        {
            this.Hue = 0xB17;       SetResistance(ResistanceType.Fire, 70, 80);   SetResistance(ResistanceType.Cold, 10, 20);
        }
        else if (Server.Misc.Worlds.IsIceDungeon(this.Location, this.Map))
        {
            this.Hue = Utility.RandomList(0xB33, 0xB34, 0xB35, 0xB36, 0xB37);     SetResistance(ResistanceType.Fire, 10, 20);   SetResistance(ResistanceType.Cold, 70, 80);
        }
        else if (Server.Misc.Worlds.IsSeaDungeon(this.Location, this.Map))
        {
            this.Hue = Utility.RandomList(0xB3D, 0xB3E, 0xB3F, 0xB40);    SetResistance(ResistanceType.Fire, 30, 40);   SetResistance(ResistanceType.Cold, 30, 40);   SetResistance(ResistanceType.Poison, 40, 50);
        }
