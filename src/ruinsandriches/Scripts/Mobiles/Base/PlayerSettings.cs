...
class PlayerSettings
{
    ...
    public static void LootContainer(Mobile m, Container box)               // -------------------------------------------------------------------------------------
    {
        ...
        if (looting == null)
        {
            Server.Misc.LootChoiceUpdates.InitializeLootChoice(m); looting = ((PlayerMobile)m).CharacterLoot;
        }
            ...
            foreach (string found in discoveries)
            {
                if (nEntry == 1 && found == "1")
                {
                    foreach (Item i in box.Items)
                    {
                        ...
                        {
                            belongings.Add(i); foundNuggets = 1;
                        }
                    }
                }
                else if (nEntry == 2 && found == "1")
                {
                    foreach (Item i in box.Items)
                    {
                        ...
                        {
                            belongings.Add(i); foundJewels = 1;
                        }
                ...
                else if (nEntry == 3 && found == "1")
                {
                    foreach (Item i in box.Items)
                    {
                        if (i is Arrow)
                        {
                            belongings.Add(i); foundArrows = 1;
                        }
                ...
                else if (nEntry == 5 && found == "1")
                {
                    foreach (Item i in box.Items)
                    {
                        if (i is Bandage)
                        {
                            belongings.Add(i); foundBandages = 1;
                        }
                    }
                }
                ...
                else if (nEntry == 8 && found == "1")
                {
                    foreach (Item i in box.Items)
                    {
                        if (i is BlackPearl)
                        {
                            belongings.Add(i); foundReagents = 1;
                        }
                ...
                else if (nEntry == 11 && found == "1")
                {
                    foreach (Item i in box.Items)
                    {
                        if (i is BasePotion)
                        {
                            belongings.Add(i); foundPotions = 1;
                        }
