...
public class BaseCreature : Mobile, IHonorTarget
{
    ...
    public int PhysicalResistanceSeed {
        get { return m_PhysicalResistance; } set { m_PhysicalResistance = value; UpdateResistances(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int FireResistSeed {
        get { return m_FireResistance; } set { m_FireResistance = value; UpdateResistances(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int ColdResistSeed {
        get { return m_ColdResistance; } set { m_ColdResistance = value; UpdateResistances(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int PoisonResistSeed {
        get { return m_PoisonResistance; } set { m_PoisonResistance = value; UpdateResistances(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int EnergyResistSeed {
        get { return m_EnergyResistance; } set { m_EnergyResistance = value; UpdateResistances(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int PhysicalDamage {
        get { return m_PhysicalDamage; } set { m_PhysicalDamage = value; }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int FireDamage {
        get { return m_FireDamage; } set { m_FireDamage = value; }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int ColdDamage {
        get { return m_ColdDamage; } set { m_ColdDamage = value; }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int PoisonDamage {
        get { return m_PoisonDamage; } set { m_PoisonDamage = value; }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int EnergyDamage {
        get { return m_EnergyDamage; } set { m_EnergyDamage = value; }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int ChaosDamage {
        get { return m_ChaosDamage; } set { m_ChaosDamage = value; }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int DirectDamage {
        get { return m_DirectDamage; } set { m_DirectDamage = value; }
    }
    ...
    public static void BeefUp(BaseCreature bc, int up)
    {
        ...
        if (Server.Misc.MyServerSettings.CreaturesSearching())
        {
            ...
            {
            }                                                                      // DON'T MODIFY THOSE THAT ALREADY HAVE THE SKILL
            else
            {
    ...
    public override void OnAfterSpawn()
    {
        ...
        if (this is Xurtzar || this is Surtaz || this is Vulcrum || this is Arachnar || this is CaddelliteDragon)
        {
            Heat = 4;
        ...
        if (reg.IsPartOf(typeof(BardDungeonRegion)))
        {
            ...
            else if (reg.IsPartOf("Kylearan's Tower"))
            {
                if (this is Gazer)
                {
                    this.Body = 674; this.BaseSoundID = 0x47D; this.Name = NameList.RandomName("drakkul"); this.Title = "the beholder";
                }
                if (this is MadDog)
                {
                    this.Name = "a wolf";
                ...
                {
                    this.Name = "a demon"; this.Hue = 0x5B5; this.Body = 4;
                }
            }
            else if (reg.IsPartOf("Mangar's Tower"))
            {
                ...
                if (this is Gazer)
                {
                    this.Name = "an evil eye"; this.Body = 83;
                }
                if (this is LowerDemon)
                {
                    this.Name = "a demon lord"; this.Title = ""; this.Body = 102;
                }
                if (this is Demon)
                {
                    this.Name = "a greater demon"; this.Title = ""; this.Hue = 0; this.Body = 40;
                }
                if (this is Daemon)
                {
                    this.Name = "a balrog"; this.Title = ""; this.Body = 38;
                }
        ...
        if (reg.IsPartOf("the Ancient Crash Site") || reg.IsPartOf("the Ancient Sky Ship"))
        {
            if (this is Fungal)
            {
                this.Name = "a mushroom man"; this.Hue = 0x48F; this.AddItem(new LightSource());
            }
            else if (this is FungalMage)
            {
                this.Name = "a psychic mushroom"; this.Hue = 0xABA; this.AddItem(new LightSource());
            }
            else if (this is ToxicElemental)
            {
                this.Name = "a toxic waste elemental"; this.Hue = 0xBA1; this.AddItem(new LighterSource()); this.Body = 707;
            }
            else if (this is PoisonBeetle)
            {
                this.Name = "a rad beetle"; this.Hue = 0xB07; this.AddItem(new LighterSource());
            }
            ...
            {
                this.Name = "a plasma elemental"; this.Hue = 0xB53;
            }
            else if (this is Stirge)
            {
                this.Name = "a mynock"; this.Body = 742;
            }
            else if (this is BloodElemental)
            {
                ...
                {
                    this.Name = "a coolant elemental"; this.Hue = 0xB73;
                }
                else
                {
                    this.Name = "a contaminated elemental"; this.Hue = 0xBAD;
                }
            }
        }
        ...
        if (reg.IsPartOf("the Forgotten Halls"))
        {
            ...
            {
                this.Name = "a sewage elemental"; this.Hue = Hue = 0xB97;
            }
            if (this is ForestGiant)
            {
                this.Hue = Hue = 0xB97; this.Title = "the sludge giant";
            }
            ...
            if (this is SkeletalKnight)
            {
                ...
                {
                    BattleAxe radaxe = new BattleAxe(); radaxe.Name = "rusty battle axe"; radaxe.Hue = 0xB97; radaxe.AosElementDamages.Poison = 50; this.PackItem(radaxe);
                }
                if (this.Body == 57)
                {
                    Scimitar radsim = new Scimitar(); radsim.Name = "rusty scimitar"; radsim.Hue = 0xB97;   radsim.AosElementDamages.Poison = 50; this.PackItem(radsim);
                }
                if (this.Body == 170 || this.Body == 327)
                {
                    Longsword radswd = new Longsword(); radswd.Name = "rusty longsword"; radswd.Hue = 0xB97;   radswd.AosElementDamages.Poison = 50; this.PackItem(radswd);
                }
                if (this.Body == 57 || this.Body == 168 || this.Body == 170)
                {
                    WoodenShield radshield = new WoodenShield(); radshield.Name = "rotting shield"; radshield.Hue = 0xB97; radshield.PoisonBonus = 5; this.PackItem(radshield);
                }
            }
        }
        ...
        if (reg.IsPartOf("the Dragon's Maw"))
        {
            if (this is BoneKnight)
            {
                ...
                if (this.Body == 56 || this.Body == 168)
                {
                    BattleAxe radaxe = new BattleAxe(); radaxe.Name = "irradiated battle axe"; radaxe.Hue = 0x48F; radaxe.AosElementDamages.Poison = 50; this.PackItem(radaxe);
                }
                if (this.Body == 57)
                {
                    Scimitar radsim = new Scimitar(); radsim.Name = "irradiated scimitar"; radsim.Hue = 0x48F;      radsim.AosElementDamages.Poison = 50; this.PackItem(radsim);
                }
                if (this.Body == 170 || this.Body == 327)
                {
                    Longsword radswd = new Longsword(); radswd.Name = "irradiated longsword"; radswd.Hue = 0x48F;      radswd.AosElementDamages.Poison = 50; this.PackItem(radswd);
                }
                if (this.Body == 57 || this.Body == 168 || this.Body == 170)
                {
                    WoodenShield radshield = new WoodenShield(); radshield.Name = "irradiated shield"; radshield.Hue = 0x48F; radshield.PoisonBonus = 5; this.PackItem(radshield);
                }
            }
            else if (this is CrystalElemental)
            {
            ...
            if (this.Backpack != null && !(this is Brigand) && !(this is GhostWarrior) && !(this is GhostWizard))
            {
                for (int i = 0; i < this.Items.Count; ++i)
                {
                    ...
                    if (item is BaseWeapon)
                    {
                        ...
                        if (Server.Misc.MaterialInfo.IsMetalItem(item) && Utility.RandomMinMax(1, 20) == 1)
                        {
                            iweapon.Resource = CraftResource.Brass; iweapon.Hue = MaterialInfo.GetMaterialColor("brass", "", 0);
                        }
                        else
                        {
                            item.Hue = Utility.RandomYellowHue();
                    ...
                    else if (item is BaseArmor)
                    {
                        ...
                        if (Server.Misc.MaterialInfo.IsMetalItem(item) && Utility.RandomMinMax(1, 20) == 1)
                        {
                            iarmor.Resource = CraftResource.Brass; iarmor.Hue = MaterialInfo.GetMaterialColor("brass", "", 0);
                        }
                        else
                        {
                            item.Hue = Utility.RandomYellowHue();
        ...
        if (reg.IsPartOf("Stonegate Castle"))
        {
            ...
            else if (this is BoneKnight)
            {
                ...
                if (this.Body == 56 || this.Body == 168)
                {
                    BattleAxe radaxe = new BattleAxe(); radaxe.Name = "burnt battle axe"; radaxe.Hue = 0xA78; radaxe.AosElementDamages.Fire = 50; this.PackItem(radaxe);
                }
                if (this.Body == 57)
                {
                    Scimitar radsim = new Scimitar(); radsim.Name = "burnt scimitar"; radsim.Hue = 0xA78;   radsim.AosElementDamages.Fire = 50; this.PackItem(radsim);
                }
                if (this.Body == 170 || this.Body == 327)
                {
                    Longsword radswd = new Longsword(); radswd.Name = "burnt longsword"; radswd.Hue = 0xA78;   radswd.AosElementDamages.Fire = 50; this.PackItem(radswd);
                }
                if (this.Body == 57 || this.Body == 168 || this.Body == 170)
                {
                    WoodenShield radshield = new WoodenShield(); radshield.Name = "burnt shield"; radshield.Hue = 0xA78; radshield.FireBonus = 5; this.PackItem(radshield);
                }
            }
        }
    ...
    public virtual int DamageMin {
        get { return m_DamageMin; } set { m_DamageMin = value; }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public virtual int DamageMax {
        get { return m_DamageMax; } set { m_DamageMax = value; }
    }
    ...
    public virtual void OnCarve(Mobile from, Corpse corpse, Item with)
    {
        ...
        else
        {
            ...
            if ((from.CheckSkill(SkillName.Forensics, 0, 100)) && (from.Skills[SkillName.Forensics].Base >= 5.0))
            {
                if (feathers > 0)
                {
                    feathers = feathers + (int)(from.Skills[SkillName.Forensics].Value / 25) + (int)(from.Skills[SkillName.Anatomy].Value / 25);
                }
                if (wool > 0)
                {
                    wool = wool + (int)(from.Skills[SkillName.Forensics].Value / 25) + (int)(from.Skills[SkillName.Anatomy].Value / 25);
                }
                if (hides > 0)
                {
                    hides = hides + (int)(from.Skills[SkillName.Forensics].Value / 25) + (int)(from.Skills[SkillName.Anatomy].Value / 25);
                }
                if (meat > 0)
                {
                    meat = meat + (int)(from.Skills[SkillName.Forensics].Value / 25) + (int)(from.Skills[SkillName.Anatomy].Value / 25);
                }
                if (scales > 0)
                {
                    scales = scales + (int)(from.Skills[SkillName.Forensics].Value / 25) + (int)(from.Skills[SkillName.Anatomy].Value / 25);
                }
                if (furs > 0)
                {
                    furs = furs + (int)(from.Skills[SkillName.Forensics].Value / 25) + (int)(from.Skills[SkillName.Anatomy].Value / 25);
                }
            }
            ...
            || (corpse.m_Owner is BlackGateDemon))
        {
            ...
            {
                DemonSkin goods = new DemonSkin(); goods.Amount = Utility.RandomMinMax(1, 3); corpse.DropItem(goods);
            }
        }
        if ((corpse.m_Owner is Unicorn) || (corpse.m_Owner is Dreadhorn) || (corpse.m_Owner is DarkUnicorn) || (corpse.m_Owner is DarkUnicornRiding))
        {
            ...
            {
                UnicornSkin goods = new UnicornSkin(); goods.Amount = Utility.RandomMinMax(1, 3); corpse.DropItem(goods);
            }
        }
        if (corpse.m_Owner is Nightmare || corpse.m_Owner is AncientNightmare || corpse.m_Owner is AncientNightmareRiding)
        {
            if (70 < Utility.Random(100))
            {
                NightmareSkin goods = new NightmareSkin(); goods.Amount = Utility.RandomMinMax(1, 3); corpse.DropItem(goods);
            }
        }
        if ((corpse.m_Owner is Troll) || (corpse.m_Owner is SeaTroll) || (corpse.m_Owner is SwampTroll) || (corpse.m_Owner is FrostTroll))
        {
            ...
            {
                TrollSkin goods = new TrollSkin(); goods.Amount = Utility.RandomMinMax(1, 2); corpse.DropItem(goods);
            }
        }
            ...
            || (corpse.m_Owner is GiantSerpent) || (corpse.m_Owner is GiantSnake) || (corpse.m_Owner is SeaSnake) || (corpse.m_Owner is LavaSerpent) || (corpse.m_Owner is LargeSnake) || (corpse.m_Owner is GiantAdder))
        {
            if (95 < Utility.Random(100))
            {
                SerpentSkin goods = new SerpentSkin(); goods.Amount = Utility.RandomMinMax(1, 2); corpse.DropItem(goods);
            }
        }
            ...
            || (corpse.m_Owner is WhiteWyrm))
        {
            if (95 < Utility.Random(100))
            {
                DragonSkin goods = new DragonSkin(); goods.Amount = Utility.RandomMinMax(1, 3); corpse.DropItem(goods);
            }
        }
    }
    ...
    public override void AddNameProperties(ObjectPropertyList list)
    {
        ...
        if (this is JediMirage || this is SythProjection || this is Clown || this is Clone)
        {
        }                                                                                                       // NO WORDS
    ...
    public DateTime NextReacquireTime {
        get { return m_NextReacquireTime; } set { m_NextReacquireTime = value; }
    }
    ...
    public void NameColor()
    {
        ...
        if (GetMaster() is PlayerMobile && NameHue > 0 && !(this is HenchmanMonster || this is HenchmanFighter || this is HenchmanWizard || this is HenchmanArcher))
        {
            NameHue = -1;
        }
    }
        ...
        foreach (Mobile m in master.GetMobilesInRange(10))
        {
            if (m is BaseCreature)
            {
                ...
                if (pet.Controlled && pet.ControlMaster == master)
                {
                    ...
                    else if (pet is HenchmanFamiliar || pet is AerialServant || pet is PackBeast || pet is Robot || pet is GolemPorter || pet is GolemFighter || pet is FrankenPorter || pet is FrankenFighter)
                    {
                        move.Add(pet);
                    }
                }
    ...
    public bool RemoveIfUntamed {
        get { return m_RemoveIfUntamed; } set { m_RemoveIfUntamed = value; }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public int RemoveStep {
        get { return m_RemoveStep; } set { m_RemoveStep = value; }
    }
}
