...
public class BaseStatueAddon : BaseAddon
{
    ...
    public int Statue_ID {
        get { return StatueID; } set { StatueID = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Statue_Color {
        get { return StatueColor; } set { StatueColor = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Statue_Material {
        get { return StatueMaterial; } set { StatueMaterial = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Statue_Maker {
        get { return StatueMaker; } set { StatueMaker = value; InvalidateProperties(); }
    }
