...
public class GuildCraftingProcess
{
    ...
    public bool IsCraftedByEnhancer(Item item, Mobile from)
    {
        ...
        {
            BaseClothing cloth = (BaseClothing)item; if (cloth.Crafter == from)
            {
                crafted = true;
            }
        }
        ...
        {
            BaseArmor armor = (BaseArmor)item; if (armor.Crafter == from)
            {
                crafted = true;
            }
        }
        ...
        {
            BaseWeapon weapon = (BaseWeapon)item; if (weapon.Crafter == from)
            {
                crafted = true;
            }
        }
