...
public class HeartOfIce : Item
{
    ...
    public string Heart_Where {
        get { return HeartWhere; } set { HeartWhere = value; InvalidateProperties(); }
    }
...
public class SkullMinotaur : Item
{
    ...
    public string Skull_Killer {
        get { return SkullKiller; } set { SkullKiller = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Skull_Where {
        get { return SkullWhere; } set { SkullWhere = value; InvalidateProperties(); }
    }
