...
public class BaseShoppe : Item, ISecurable
{
    ...
    public static void GiveNewShoppe(Mobile from, Mobile merchant)
    {
        ...
        if (merchant is NecroMage || merchant is Witches || merchant is Necromancer || merchant is NecromancerGuildmaster)
        {
            shoppe = new MorticianShoppe();
        }
        else if (merchant is Herbalist || merchant is DruidTree || merchant is Druid || merchant is DruidGuildmaster)
        {
        ...
        else if (merchant is Weaver || merchant is Tailor || merchant is LeatherWorker || merchant is TailorGuildmaster)
        {
    ...
    public override bool OnDragDrop(Mobile from, Item dropped)
    {
        ...
        else if ((dropped.ItemID >= 0x1BE3 && dropped.ItemID <= 0x1BFA) && this is TinkerShoppe)
        {
            procResource = true;
                  ...
                  || dropped is Cloth
                  || dropped is UncutCloth) && this is TailorShoppe)
        {
            procResource = true;
        }
        else if (Server.Misc.MaterialInfo.IsReagent(dropped) && Server.Items.WitchPouch.isWitchery(dropped) && this is MorticianShoppe)
        {
            procResource = true;
        }
        ...
        else if ((dropped is Dough) && this is BakerShoppe)
        {
            procResource = true;
                  ...
                  || dropped is BlankMap) && this is CartographyShoppe)
        {
            procResource = true;
        }
        else if ((dropped is BaseLog
                  || dropped is BaseWoodBoard) && this is CarpentryShoppe)
        {
            procResource = true;
        }
        else if ((dropped is BaseLog
                  || dropped is BaseWoodBoard) && this is BowyerShoppe)
        {
            procResource = true;
        }
        else if (Server.Misc.MaterialInfo.IsReagent(dropped) && Server.Items.DruidPouch.isDruidery(dropped) && this is HerbalistShoppe)
        {
            procResource = true;
        }
        else if (Server.Misc.MaterialInfo.IsReagent(dropped) && this is AlchemistShoppe)
        {
            procResource = true;
                  ...
                  || dropped is Tongs
                  || dropped is AncientSmithyHammer) && this is BlacksmithShoppe)
        {
            procTools = true;
        }
        else if (dropped is TinkerTools && this is TinkerShoppe)
        {
            procTools = true;
                  ...
                  || dropped is SewingKit) && this is TailorShoppe)
        {
            procTools = true;
        }
        ...
        else if (dropped is DruidCauldron && this is HerbalistShoppe)
        {
            procTools = true;
                  ...
                  || dropped is GodBrewing) && this is AlchemistShoppe)
        {
            procTools = true;
        }
        else if ((dropped is RollingPin
                  || dropped is Skillet) && this is BakerShoppe)
        {
            procTools = true;
        }
                  ...
                  || dropped is Saw
                  || dropped is Scorp
                  || dropped is SmoothingPlane) && this is CarpentryShoppe)
        {
            procTools = true;
        }
    ...
    public Mobile Shoppe_Owner {
        get { return ShoppeOwner; } set { ShoppeOwner = value; InvalidateProperties(); }
    }

    public string ShoppeName;
    [CommandProperty(AccessLevel.GameMaster)]
    public string Shoppe_Name {
        get { return ShoppeName; } set { ShoppeName = value; InvalidateProperties(); }
    }

    public int ShoppeGold;
    [CommandProperty(AccessLevel.Owner)]
    public int Shoppe_Gold {
        get { return ShoppeGold; } set { ShoppeGold = value; InvalidateProperties(); }
    }

    public int ShoppeTools;
    [CommandProperty(AccessLevel.Owner)]
    public int Shoppe_Tools {
        get { return ShoppeTools; } set { ShoppeTools = value; InvalidateProperties(); }
    }

    public int ShoppeResources;
    [CommandProperty(AccessLevel.Owner)]
    public int Shoppe_Resources {
        get { return ShoppeResources; } set { ShoppeResources = value; InvalidateProperties(); }
    }

    public int ShoppeReputation;
    [CommandProperty(AccessLevel.Owner)]
    public int Shoppe_Reputation {
        get { return ShoppeReputation; } set { ShoppeReputation = value; InvalidateProperties(); }
    }

    public int ShoppePage;
    [CommandProperty(AccessLevel.Owner)]
    public int Shoppe_Page {
        get { return ShoppePage; } set { ShoppePage = value; InvalidateProperties(); }
    }
    ...
    public string Shelf_Title {
        get { return ShelfTitle; } set { ShelfTitle = value; InvalidateProperties(); }
    }

    public int ShelfItem;
    [CommandProperty(AccessLevel.Owner)]
    public int Shelf_Item {
        get { return ShelfItem; } set { ShelfItem = value; InvalidateProperties(); }
    }

    public int ShelfSkill;
    [CommandProperty(AccessLevel.Owner)]
    public int Shelf_Skill {
        get { return ShelfSkill; } set { ShelfSkill = value; InvalidateProperties(); }
    }

    public NpcGuild ShelfGuild;
    [CommandProperty(AccessLevel.Owner)]
    public NpcGuild Shelf_Guild {
        get { return ShelfGuild; } set { ShelfGuild = value; InvalidateProperties(); }
    }

    public string ShelfTools;
    [CommandProperty(AccessLevel.Owner)]
    public string Shelf_Tools {
        get { return ShelfTools; } set { ShelfTools = value; InvalidateProperties(); }
    }

    public string ShelfResources;
    [CommandProperty(AccessLevel.Owner)]
    public string Shelf_Resources {
        get { return ShelfResources; } set { ShelfResources = value; InvalidateProperties(); }
    }

    public int ShelfSound;
    [CommandProperty(AccessLevel.Owner)]
    public int Shelf_Sound {
        get { return ShelfSound; } set { ShelfSound = value; InvalidateProperties(); }
    }
    ...
    public string Customer_02 {
        get { return Customer02; } set { Customer02 = value; InvalidateProperties(); }
    }

    public string Customer03;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_03 {
        get { return Customer03; } set { Customer03 = value; InvalidateProperties(); }
    }

    public string Customer04;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_04 {
        get { return Customer04; } set { Customer04 = value; InvalidateProperties(); }
    }

    public string Customer05;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_05 {
        get { return Customer05; } set { Customer05 = value; InvalidateProperties(); }
    }

    public string Customer06;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_06 {
        get { return Customer06; } set { Customer06 = value; InvalidateProperties(); }
    }

    public string Customer07;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_07 {
        get { return Customer07; } set { Customer07 = value; InvalidateProperties(); }
    }

    public string Customer08;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_08 {
        get { return Customer08; } set { Customer08 = value; InvalidateProperties(); }
    }

    public string Customer09;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_09 {
        get { return Customer09; } set { Customer09 = value; InvalidateProperties(); }
    }

    public string Customer10;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_10 {
        get { return Customer10; } set { Customer10 = value; InvalidateProperties(); }
    }

    public string Customer11;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_11 {
        get { return Customer11; } set { Customer11 = value; InvalidateProperties(); }
    }

    public string Customer12;
    [CommandProperty(AccessLevel.Owner)]
    public string Customer_12 {
        get { return Customer12; } set { Customer12 = value; InvalidateProperties(); }
    }
    ...
    public static int GetSkillValue(int job, Mobile from)
    {
        ...
        if (job > 0)
        {
            ...
            {
                return (int)((from.Skills[SkillName.Druidism].Value + from.Skills[SkillName.Veterinary].Value) / 2);
            }
            else if (job == 56)
            {
                return (int)((from.Skills[SkillName.Forensics].Value + from.Skills[SkillName.Necromancy].Value) / 2);
            }
...
public class ShoppeGump : Gump
{
    ...
    public ShoppeGump(BaseShoppe shoppe, Mobile from) : base(50, 50)
    {
        ...
        else
        {
            ...
            {
                guildBonus = 500 + (int)(Server.Items.BaseShoppe.GetSkillValue(shoppe.ShelfSkill, from) * 5);
            }
            ...
            int entries = 6;
            int line    = 0; if (shoppe.ShoppePage == 1)
            {
                line = 6;
            }
