...
public class SummonPrison : Item
{
    ...
    public string p_KeyA {
        get { return KeyA; } set { KeyA = value; }
    }

    public string KeyB;
    [CommandProperty(AccessLevel.GameMaster)]
    public string p_KeyB {
        get { return KeyB; } set { KeyB = value; }
    }

    public string KeyC;
    [CommandProperty(AccessLevel.GameMaster)]
    public string p_KeyC {
        get { return KeyC; } set { KeyC = value; }
    }

    public string ReagentNameA;
    [CommandProperty(AccessLevel.GameMaster)]
    public string p_ReagentNameA {
        get { return ReagentNameA; } set { ReagentNameA = value; }
    }

    public int ReagentQtyA;
    [CommandProperty(AccessLevel.GameMaster)]
    public int p_ReagentQtyA {
        get { return ReagentQtyA; } set { ReagentQtyA = value; }
    }

    public string ReagentNameB;
    [CommandProperty(AccessLevel.GameMaster)]
    public string p_ReagentNameB {
        get { return ReagentNameB; } set { ReagentNameB = value; }
    }

    public int ReagentQtyB;
    [CommandProperty(AccessLevel.GameMaster)]
    public int p_ReagentQtyB {
        get { return ReagentQtyB; } set { ReagentQtyB = value; }
    }

    public string Prisoner;
    [CommandProperty(AccessLevel.GameMaster)]
    public string p_Prisoner {
        get { return Prisoner; } set { Prisoner = value; }
    }

    public string PrisonerBase;
    [CommandProperty(AccessLevel.GameMaster)]
    public string p_PrisonerBase {
        get { return PrisonerBase; } set { PrisonerBase = value; }
    }

    public int PrisonerBody;
    [CommandProperty(AccessLevel.GameMaster)]
    public int p_PrisonerBody {
        get { return PrisonerBody; } set { PrisonerBody = value; }
    }

    public int PrisonerHue;
    [CommandProperty(AccessLevel.GameMaster)]
    public int p_PrisonerHue {
        get { return PrisonerHue; } set { PrisonerHue = value; }
    }

    public Mobile PrisonerSerial;
    [CommandProperty(AccessLevel.GameMaster)]
    public Mobile p_PrisonerSerial {
        get { return PrisonerSerial; } set { PrisonerSerial = value; }
    }

    public int PrisonerFullNameUsed;
    [CommandProperty(AccessLevel.GameMaster)]
    public int p_PrisonerFullNameUsed {
        get { return PrisonerFullNameUsed; } set { PrisonerFullNameUsed = value; }
    }

    public int PrisonerClothColorUsed;
    [CommandProperty(AccessLevel.GameMaster)]
    public int p_PrisonerClothColorUsed {
        get { return PrisonerClothColorUsed; } set { PrisonerClothColorUsed = value; }
    }

    public string Jailor;
    [CommandProperty(AccessLevel.GameMaster)]
    public string p_Jailor {
        get { return Jailor; } set { Jailor = value; }
    }

    public string Dungeon;
    [CommandProperty(AccessLevel.GameMaster)]
    public string p_Dungeon {
        get { return Dungeon; } set { Dungeon = value; }
    }

    public int RewardID;
    [CommandProperty(AccessLevel.GameMaster)]
    public int p_RewardID {
        get { return RewardID; } set { RewardID = value; }
    }

    public int RewardHue;
    [CommandProperty(AccessLevel.GameMaster)]
    public int p_RewardHue {
        get { return RewardHue; } set { RewardHue = value; }
    }

    public string RewardName;
    [CommandProperty(AccessLevel.GameMaster)]
    public string p_RewardName {
        get { return RewardName; } set { RewardName = value; }
    }
    ...
    public override bool OnDragLift(Mobile from)
    {
        if (from is PlayerMobile)
        {
            ...
            if (this.owner == null)
            {
                LoggingFunctions.LogGenericQuest(from, "has discovered " + sPrisoner + " locked in a Magical Prison");
            }
            this.owner = from;
        }
    ...
    public static bool CheckForItem(Mobile from, string item, int qty, bool remove)
    {
        ...
        else
        {
            ...
            for (int r = 0; r < targets.Count; ++r)
            {
                ...
                if (remove == true)
                {
                    Server.Items.QuestSouvenir.GiveReward(from, rid.Name, rid.Hue, rid.ItemID); rid.Delete();
                }
            }
        }
