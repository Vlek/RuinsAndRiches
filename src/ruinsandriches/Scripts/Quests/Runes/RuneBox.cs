...
public class RuneBox : Item
{
    ...
    public Mobile RuneBox_Owner {
        get { return RuneBoxOwner; } set { RuneBoxOwner = value; }
    }
    ...
    public int Has_Honesty {
        get { return HasHonesty; } set { HasHonesty = value; InvalidateProperties(); }
    }

    public int HasHonor;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_Honor {
        get { return HasHonor; } set { HasHonor = value; InvalidateProperties(); }
    }

    public int HasHumility;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_Humility {
        get { return HasHumility; } set { HasHumility = value; InvalidateProperties(); }
    }

    public int HasJustice;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_Justice {
        get { return HasJustice; } set { HasJustice = value; InvalidateProperties(); }
    }

    public int HasSacrifice;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_Sacrifice {
        get { return HasSacrifice; } set { HasSacrifice = value; InvalidateProperties(); }
    }

    public int HasSpirituality;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_Spirituality {
        get { return HasSpirituality; } set { HasSpirituality = value; InvalidateProperties(); }
    }

    public int HasValor;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_Valor {
        get { return HasValor; } set { HasValor = value; InvalidateProperties(); }
    }
