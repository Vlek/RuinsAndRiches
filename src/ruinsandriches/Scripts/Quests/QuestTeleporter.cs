...
public class QuestTeleporter : Item
{
    ...
    public int Teleporter_Open {
        get { return TeleporterOpen; } set { TeleporterOpen = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Teleporter_Sound {
        get { return TeleporterSound; } set { TeleporterSound = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Teleporter_Item {
        get { return TeleporterItem; } set { TeleporterItem = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Teleporter_Message {
        get { return TeleporterMessage; } set { TeleporterMessage = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Teleporter_Fail {
        get { return TeleporterFail; } set { TeleporterFail = value; InvalidateProperties(); }
    }
    ...
    public string Teleporter_Lock {
        get { return TeleporterLock; } set { TeleporterLock = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Teleporter_LockMsg {
        get { return TeleporterLockMsg; } set { TeleporterLockMsg = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public Point3D PointDest {
        get { return TeleporterPointDest; } set { TeleporterPointDest = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public Map MapDest {
        get { return TeleporterMapDest; } set { TeleporterMapDest = value; InvalidateProperties(); }
    }
