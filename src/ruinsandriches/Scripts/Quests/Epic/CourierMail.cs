...
public class CourierMail : Item
{
    ...
    public string Search_Message {
        get { return SearchMessage; } set { SearchMessage = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Search_Dungeon {
        get { return SearchDungeon; } set { SearchDungeon = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public Map Dungeon_Map {
        get { return DungeonMap; } set { DungeonMap = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Search_World {
        get { return SearchWorld; } set { SearchWorld = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Search_Item {
        get { return SearchItem; } set { SearchItem = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string For_Who {
        get { return ForWho; } set { ForWho = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string For_Where {
        get { return ForWhere; } set { ForWhere = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string For_Alignment {
        get { return ForAlignment; } set { ForAlignment = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Msg_Complete {
        get { return MsgComplete; } set { MsgComplete = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Msg_Reward {
        get { return MsgReward; } set { MsgReward = value; InvalidateProperties(); }
    }
