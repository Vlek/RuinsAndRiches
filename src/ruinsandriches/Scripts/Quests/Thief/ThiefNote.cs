...
public class ThiefNote : Item
{
    ...
    public Mobile Note_Owner {
        get { return NoteOwner; } set { NoteOwner = value; }
    }

    public string NoteItemCategory;
    [CommandProperty(AccessLevel.Owner)]
    public string Note_ItemCategory {
        get { return NoteItemCategory; } set { NoteItemCategory = value; InvalidateProperties(); }
    }

    public string NoteItem;
    [CommandProperty(AccessLevel.Owner)]
    public string Note_Item {
        get { return NoteItem; } set { NoteItem = value; InvalidateProperties(); }
    }

    public int NoteItemGot;
    [CommandProperty(AccessLevel.Owner)]
    public int Note_ItemGot {
        get { return NoteItemGot; } set { NoteItemGot = value; InvalidateProperties(); }
    }

    public string NoteItemArea;
    [CommandProperty(AccessLevel.Owner)]
    public string Note_ItemArea {
        get { return NoteItemArea; } set { NoteItemArea = value; InvalidateProperties(); }
    }

    public string NoteItemPerson;
    [CommandProperty(AccessLevel.Owner)]
    public string Note_ItemPerson {
        get { return NoteItemPerson; } set { NoteItemPerson = value; InvalidateProperties(); }
    }

    public int NoteDeliverType;
    [CommandProperty(AccessLevel.Owner)]
    public int Note_DeliverType {
        get { return NoteDeliverType; } set { NoteDeliverType = value; InvalidateProperties(); }
    }

    public string NoteDeliverTo;
    [CommandProperty(AccessLevel.Owner)]
    public string Note_DeliverTo {
        get { return NoteDeliverTo; } set { NoteDeliverTo = value; InvalidateProperties(); }
    }

    public int NoteReward;
    [CommandProperty(AccessLevel.Owner)]
    public int Note_Reward {
        get { return NoteReward; } set { NoteReward = value; InvalidateProperties(); }
    }
    ...
    public static void SetupNote(ThiefNote note, Mobile m)
    {
        ...
        if (Utility.RandomBool())                   // STEAL FROM TOWN
        {
            ...
            switch (Utility.RandomMinMax(0, 13))
            {
                ...
                case 3:         searchLocation = "the Land of Lodoria";                 rewardMod = 2;  if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 4:         searchLocation = "the Land of Lodoria";                 rewardMod = 2;  if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 5:         searchLocation = "the Land of Lodoria";                 rewardMod = 2;  if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 6:         searchLocation = "the Serpent Island";                  rewardMod = 3;  if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 7:         searchLocation = "the Serpent Island";                  rewardMod = 3;  if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 8:         searchLocation = "the Serpent Island";                  rewardMod = 3;  if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 9:         searchLocation = "the Isles of Dread";                  rewardMod = 4;  if (!(PlayerSettings.GetDiscovered(m, "the Isles of Dread")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 10:        searchLocation = "the Savaged Empire";                  rewardMod = 5;  if (!(PlayerSettings.GetDiscovered(m, "the Savaged Empire")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 11:        searchLocation = "the Savaged Empire";                  rewardMod = 5;  if (!(PlayerSettings.GetDiscovered(m, "the Savaged Empire")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 12:        searchLocation = "the Island of Umber Veil";    rewardMod = 2;  if (!(PlayerSettings.GetDiscovered(m, "the Island of Umber Veil")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 13:        searchLocation = "the Bottle World of Kuldar";  rewardMod = 4;  if (!(PlayerSettings.GetDiscovered(m, "the Bottle World of Kuldar")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
        ...
        else                 // STEAL FROM DUNGEON
        {
            ...
            switch (Utility.RandomMinMax(0, 15))
            {
                ...
                case 1:         searchLocation = "the Land of Sosaria";                 break;
                case 2:         searchLocation = "the Land of Sosaria";                 break;
                case 3:         searchLocation = "the Land of Lodoria";                 if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 4:         searchLocation = "the Land of Lodoria";                 if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 5:         searchLocation = "the Land of Lodoria";                 if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 6:         searchLocation = "the Serpent Island";                  if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 7:         searchLocation = "the Serpent Island";                  if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 8:         searchLocation = "the Serpent Island";                  if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 9:         searchLocation = "the Isles of Dread";                  if (!(PlayerSettings.GetDiscovered(m, "the Isles of Dread")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 10:        searchLocation = "the Savaged Empire";                  if (!(PlayerSettings.GetDiscovered(m, "the Savaged Empire")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 11:        searchLocation = "the Savaged Empire";                  if (!(PlayerSettings.GetDiscovered(m, "the Savaged Empire")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 12:        searchLocation = "the Island of Umber Veil";    if (!(PlayerSettings.GetDiscovered(m, "the Island of Umber Veil")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 13:        searchLocation = "the Bottle World of Kuldar";  if (!(PlayerSettings.GetDiscovered(m, "the Bottle World of Kuldar")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
                case 14:        searchLocation = "the Underworld";                              if (!(PlayerSettings.GetDiscovered(m, "the Underworld")))
                    {
                        searchLocation = "the Underworld";
                    }
                    break;
                case 15:        searchLocation = "the Land of Ambrosia";                if (!(PlayerSettings.GetDiscovered(m, "the Land of Ambrosia")))
                    {
                        searchLocation = "the Land of Sosaria";
                    }
                    break;
        ...
        switch (Utility.RandomMinMax(0, 13))
        {
            ...
            case 3:         dropLocation = "the Land of Lodoria";                   if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 4:         dropLocation = "the Land of Lodoria";                   if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 5:         dropLocation = "the Land of Lodoria";                   if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 6:         dropLocation = "the Serpent Island";                    if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 7:         dropLocation = "the Serpent Island";                    if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 8:         dropLocation = "the Serpent Island";                    if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 9:         dropLocation = "the Isles of Dread";                    if (!(PlayerSettings.GetDiscovered(m, "the Isles of Dread")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 10:        dropLocation = "the Savaged Empire";                    if (!(PlayerSettings.GetDiscovered(m, "the Savaged Empire")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 11:        dropLocation = "the Savaged Empire";                    if (!(PlayerSettings.GetDiscovered(m, "the Savaged Empire")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 12:        dropLocation = "the Island of Umber Veil";              if (!(PlayerSettings.GetDiscovered(m, "the Island of Umber Veil")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
            case 13:        dropLocation = "the Bottle World of Kuldar";    if (!(PlayerSettings.GetDiscovered(m, "the Bottle World of Kuldar")))
                {
                    dropLocation = "the Land of Sosaria";
                }
                break;
