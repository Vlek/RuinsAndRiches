...
public class StealBag : Bag
{
    ...
    public int Bag_Color {
        get { return BagColor; } set { BagColor = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Bag_Name {
        get { return BagName; } set { BagName = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Bag_Markings {
        get { return BagMarkings; } set { BagMarkings = value; InvalidateProperties(); }
    }
