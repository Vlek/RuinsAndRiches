...
public class Coffer : Container
{
    ...
    public int Coffer_Robbed {
        get { return CofferRobbed; } set { CofferRobbed = value; InvalidateProperties(); }
    }

    public string CofferRobber;
    [CommandProperty(AccessLevel.Owner)]
    public string Coffer_Robber {
        get { return CofferRobber; } set { CofferRobber = value; InvalidateProperties(); }
    }

    public int CofferGold;
    [CommandProperty(AccessLevel.Owner)]
    public int Coffer_Gold {
        get { return CofferGold; } set { CofferGold = value; InvalidateProperties(); }
    }

    public string CofferType;
    [CommandProperty(AccessLevel.Owner)]
    public string Coffer_Type {
        get { return CofferType; } set { CofferType = value; InvalidateProperties(); }
    }

    public Mobile CofferSnooperA;
    [CommandProperty(AccessLevel.Owner)]
    public Mobile Coffer_SnooperA {
        get { return CofferSnooperA; } set { CofferSnooperA = value; InvalidateProperties(); }
    }

    public Mobile CofferSnooperB;
    [CommandProperty(AccessLevel.Owner)]
    public Mobile Coffer_SnooperB {
        get { return CofferSnooperB; } set { CofferSnooperB = value; InvalidateProperties(); }
    }

    public Mobile CofferSnooperC;
    [CommandProperty(AccessLevel.Owner)]
    public Mobile Coffer_SnooperC {
        get { return CofferSnooperC; } set { CofferSnooperC = value; InvalidateProperties(); }
    }

    public Mobile CofferSnooperD;
    [CommandProperty(AccessLevel.Owner)]
    public Mobile Coffer_SnooperD {
        get { return CofferSnooperD; } set { CofferSnooperD = value; InvalidateProperties(); }
    }

    public Mobile CofferSnooperE;
    [CommandProperty(AccessLevel.Owner)]
    public Mobile Coffer_SnooperE {
        get { return CofferSnooperE; } set { CofferSnooperE = value; InvalidateProperties(); }
    }

    public string CofferTown;
    [CommandProperty(AccessLevel.Owner)]
    public string Coffer_Town {
        get { return CofferTown; } set { CofferTown = value; InvalidateProperties(); }
    }
