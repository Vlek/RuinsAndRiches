...
public class Museums : Item
{
    ...
    public string Discover_Name {
        get { return DiscoverName; } set { DiscoverName = value; InvalidateProperties(); }
    }

    public Mobile DiscoverOwner;
    [CommandProperty(AccessLevel.GameMaster)]
    public Mobile Discover_Owner {
        get { return DiscoverOwner; } set { DiscoverOwner = value; }
    }

    public string ThisDescription;
    [CommandProperty(AccessLevel.Owner)]
    public string This_Description {
        get { return ThisDescription; } set { ThisDescription = value; InvalidateProperties(); }
    }
    ...
    {
        PlayerMobile pm = (PlayerMobile)player; if (pm.NpcGuild == NpcGuild.MerchantsGuild)
        {
