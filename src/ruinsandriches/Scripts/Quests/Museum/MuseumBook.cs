...
public class MuseumBook : Item
{
    ...
    public Mobile Art_Owner {
        get { return ArtOwner; } set { ArtOwner = value; }
    }

    public int KnightTrophy;
    [CommandProperty(AccessLevel.GameMaster)]
    public int Knight_Trophy {
        get { return KnightTrophy; } set { KnightTrophy = value; }
    }

    public int KnightStatue;
    [CommandProperty(AccessLevel.GameMaster)]
    public int Knight_Statue {
        get { return KnightStatue; } set { KnightStatue = value; }
    }

    public string RumorWorld;
    [CommandProperty(AccessLevel.GameMaster)]
    public string Rumor_World {
        get { return RumorWorld; } set { RumorWorld = value; }
    }

    public string RumorDungeon;
    [CommandProperty(AccessLevel.GameMaster)]
    public string Rumor_Dungeon {
        get { return RumorDungeon; } set { RumorDungeon = value; }
    }

    public int RumorGoal;
    [CommandProperty(AccessLevel.GameMaster)]
    public int Rumor_Goal {
        get { return RumorGoal; } set { RumorGoal = value; }
    }

    public string RumorFrom;
    [CommandProperty(AccessLevel.GameMaster)]
    public string Rumor_From {
        get { return RumorFrom; } set { RumorFrom = value; }
    }
    ...
    public string Items_Found {
        get { return ItemsFound; } set { ItemsFound = value; }
    }
