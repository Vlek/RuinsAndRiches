...
public class ScrollClue : Item
{
    ...
    public string Scroll_Solved {
        get { return ScrollSolved; } set { ScrollSolved = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Scroll_Intelligence {
        get { return ScrollIntelligence; } set { ScrollIntelligence = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Scroll_Level {
        get { return ScrollLevel; } set { ScrollLevel = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Scroll_True {
        get { return ScrollTrue; } set { ScrollTrue = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Scroll_Describe {
        get { return ScrollDescribe; } set { ScrollDescribe = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Scroll_Quest {
        get { return ScrollQuest; } set { ScrollQuest = value; InvalidateProperties(); }
    }
    ...
    [CommandProperty(AccessLevel.Owner)]
    public int Scroll_X {
        get { return ScrollX; } set { ScrollX = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Scroll_Y {
        get { return ScrollY; } set { ScrollY = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.GameMaster)]
    public Map Scroll_Map {
        get { return ScrollMap; } set { ScrollMap = value; }
    }
    ...
    public ScrollClue( ) : base(0x4CC6)
    {
        ...
        else
        {
            ...
            ScrollTrue = 0; if (Utility.RandomMinMax(1, 2) == 1)
            {
                ScrollTrue = 1;
            }
    ...
    public override void OnDoubleClick(Mobile e)
    {
        ...
        else
        {
            ...
            if (ScrollIntelligence < 1)
            {
                ...
                {
                    e.SendGump(new ClueGump(e, this)); e.PlaySound(0x249);
                }
            }
            else
            {
