...
public class SomeRandomNote : Item
{
    ...
    public string Scroll_Message {
        get { return ScrollMessage; } set { ScrollMessage = value; InvalidateProperties(); }
    }
        ...
        else
        {
            switch (amnt)
            {
                ...
                case 15:
                    ...
                    {
                        ScrollMessage = "The " + RandomThings.GetRandomJob() + " in " + RandomThings.GetRandomCity() + " said that the assassins guild would pay a good price for some silver serpent venom, as it could be used as a deadly poison.";
                    }
                    break;
