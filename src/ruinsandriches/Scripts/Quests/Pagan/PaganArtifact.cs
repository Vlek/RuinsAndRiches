...
public class PaganArtifact : Item
{
    ...
    public int Pagan_Item {
        get { return PaganItem; } set { PaganItem = value; InvalidateProperties(); }
    }

    public int PaganColor;
    [CommandProperty(AccessLevel.Owner)]
    public int Pagan_Color {
        get { return PaganColor; } set { PaganColor = value; InvalidateProperties(); }
    }

    public string PaganName;
    [CommandProperty(AccessLevel.Owner)]
    public string Pagan_Name {
        get { return PaganName; } set { PaganName = value; InvalidateProperties(); }
    }

    public int PaganPoints;
    [CommandProperty(AccessLevel.Owner)]
    public int Pagan_Points {
        get { return PaganPoints; } set { PaganPoints = value; InvalidateProperties(); }
    }
    ...
    public void SetupArtifactInfo(int arty)
    {
        ...
        switch (arty)
        {
            case 1:         PaganItem = helms;              PaganColor = color;     PaganName = "Magic Helm Armour";                if (PaganColor == 0xB74)
                {
                    PaganName = "Ghost Helm Armour";
                }
                break;
            case 2:         PaganItem = 0x1410;             PaganColor = color;     PaganName = "Magic Arm Armour";                 if (PaganColor == 0xB74)
                {
                    PaganName = "Ghost Arm Armour";
                }
                break;
            case 3:         PaganItem = 0x46AA;             PaganColor = color;     PaganName = "Magic Leg Armour";                 if (PaganColor == 0xB74)
                {
                    PaganName = "Ghost Leg Armour";
                }
                break;
            case 4:         PaganItem = 0x1413;             PaganColor = color;     PaganName = "Magic Neck Armour";                if (PaganColor == 0xB74)
                {
                    PaganName = "Ghost Neck Armour";
                }
                break;
            case 5:         PaganItem = 0x1414;             PaganColor = color;     PaganName = "Magic Gauntlet Armour";    if (PaganColor == 0xB74)
                {
                    PaganName = "Ghost Gauntlet Armour";
                }
                break;
            case 6:         PaganItem = 0x1415;             PaganColor = color;     PaganName = "Magic Chest Armour";               if (PaganColor == 0xB74)
                {
    ...
    private class PaganArtifactGump : Gump
    {
        ...
        public PaganArtifactGump(Mobile from, PaganArtifact arty) : base(50, 50)
        {
            ...
            if (m_Artifact.PaganItem == 0x1408 || m_Artifact.PaganItem == 0x140A || m_Artifact.PaganItem == 0x140C || m_Artifact.PaganItem == 0x1412 || m_Artifact.PaganItem == 0x2645 || m_Artifact.PaganItem == 0x2FBB || m_Artifact.PaganItem == 0x140E)
            {
