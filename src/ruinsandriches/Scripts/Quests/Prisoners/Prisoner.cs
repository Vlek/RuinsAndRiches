...
public class Prisoner : Item
{
    ...
    public int Prisoner_Reward {
        get { return PrisonerReward; } set { PrisonerReward = value; InvalidateProperties(); }
    }

    private int PrisonerJoin;
    [CommandProperty(AccessLevel.GameMaster)]
    public int Prisoner_Join {
        get { return PrisonerJoin; } set { PrisonerJoin = value; InvalidateProperties(); }
    }
    ...
    public string Prisoner_Name {
        get { return PrisonerName; } set { PrisonerName = value; InvalidateProperties(); }
    }

    private string PrisonerTitle;
    [CommandProperty(AccessLevel.GameMaster)]
    public string Prisoner_Title {
        get { return PrisonerTitle; } set { PrisonerTitle = value; InvalidateProperties(); }
    }

    private int PrisonerBody;
    [CommandProperty(AccessLevel.GameMaster)]
    public int Prisoner_Body {
        get { return PrisonerBody; } set { PrisonerBody = value; InvalidateProperties(); }
    }

    private int PrisonerSound;
    [CommandProperty(AccessLevel.GameMaster)]
    public int Prisoner_Sound {
        get { return PrisonerSound; } set { PrisonerSound = value; InvalidateProperties(); }
    }
