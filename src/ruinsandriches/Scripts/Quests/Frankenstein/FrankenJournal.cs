...
public class FrankenJournal : Item
{
    ...
    public Mobile Journal_Owner {
        get { return JournalOwner; } set { JournalOwner = value; }
    }
    ...
    public int Has_Torso {
        get { return HasTorso; } set { HasTorso = value; InvalidateProperties(); }
    }

    public int HasBrain;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_Brain {
        get { return HasBrain; } set { HasBrain = value; InvalidateProperties(); }
    }

    public int HasArmLeft;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_ArmLeft {
        get { return HasArmLeft; } set { HasArmLeft = value; InvalidateProperties(); }
    }

    public int HasArmRight;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_ArmRight {
        get { return HasArmRight; } set { HasArmRight = value; InvalidateProperties(); }
    }

    public int HasLegLeft;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_LegLeft {
        get { return HasLegLeft; } set { HasLegLeft = value; InvalidateProperties(); }
    }

    public int HasLegRight;
    [CommandProperty(AccessLevel.Owner)]
    public int Has_LegRight {
        get { return HasLegRight; } set { HasLegRight = value; InvalidateProperties(); }
    }

    public string BrainFrom;
    [CommandProperty(AccessLevel.Owner)]
    public string Brain_From {
        get { return BrainFrom; } set { BrainFrom = value; InvalidateProperties(); }
    }
