...
public class FrankenPorterItem : Item
{
    ...
    public int Porter_Level {
        get { return PorterLevel; } set { PorterLevel = value; InvalidateProperties(); }
    }
    ...
    public override void OnDoubleClick(Mobile from)
    {
        ...
        else
        {
            ...
            {
                friend.Delete(); friend = new FrankenFighter(); ((FrankenFighter)friend).FighterLevel = this.PorterLevel;
            }
