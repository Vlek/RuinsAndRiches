...
class FishingQuestFunctions
{
    ...
    public static void CheckTarget(Mobile m, Mobile target, Item box)
    {
        ...
        if (PlayerSettings.GetQuestState(m, "FishingQuest"))
        {
            ...
            if (reg.IsPartOf(typeof(PirateRegion)) && (target is AncientLich || target is PirateCaptain || target is ElfPirateCaptain))
            {
                IsSeaTarget = true;
            }
    ...
    public static void FindTarget(Mobile m, int fee)
    {
        ...
        switch (WorldPick)
        {
            ...
            case 5:         searchLocation = "the Land of Lodoria";                 if (!(PlayerSettings.GetDiscovered(m, "the Land of Lodoria")))
                ...
                break;
            case 6:         searchLocation = "the Isles of Dread";                  if (!(PlayerSettings.GetDiscovered(m, "the Isles of Dread")))
                {
                    searchLocation = "the Land of Sosaria";
                }
                break;
            ...
            case 8:         searchLocation = "the Serpent Island";                  if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                ...
                break;
            case 9:         searchLocation = "the Serpent Island";                  if (!(PlayerSettings.GetDiscovered(m, "the Serpent Island")))
                {
                    searchLocation = "the Land of Sosaria";
                }
                break;
    ...
    public static string QuestStatus(Mobile m)
    {
        ...
        if (PlayerSettings.GetQuestState(m, "FishingQuest"))
        {
            ...
            if (nPCDone == 1)
            {
                sexplorerQuest = "Return to any sailor quest bulletin board for your " + sWorth + " gold payment";
            }
        }
