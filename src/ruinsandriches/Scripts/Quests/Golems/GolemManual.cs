...
public class GolemManual : Item
{
    ...
    public GolemManual() : base(0x225D)
    {
        ...
        if (Weight > 1.0)
        {
            ...
            if (iGolem >= 220)
            {
                sGolem = "a Valorite Golem"; iAdd = 9; sIngot = "valorite ingots"; Hue = MaterialInfo.GetMaterialColor("valorite", "classic", 0);
            }
            else if (iGolem >= 210)
            {
                sGolem = "a Verite Golem"; iAdd = 8; sIngot = "verite ingots"; Hue = MaterialInfo.GetMaterialColor("verite", "classic", 0);
            }
            else if (iGolem >= 195)
            {
                sGolem = "an Agapite Golem"; iAdd = 7; sIngot = "agapite ingots"; Hue = MaterialInfo.GetMaterialColor("agapite", "classic", 0);
            }
            else if (iGolem >= 175)
            {
                sGolem = "a Golden Golem"; iAdd = 6; sIngot = "golden ingots"; Hue = MaterialInfo.GetMaterialColor("gold", "classic", 0);
            }
            else if (iGolem >= 150)
            {
                sGolem = "a Bronze Golem"; iAdd = 5; sIngot = "bronze ingots"; Hue = MaterialInfo.GetMaterialColor("bronze", "classic", 0);
            }
            else if (iGolem >= 120)
            {
                sGolem = "a Copper Golem"; iAdd = 4; sIngot = "copper ingots"; Hue = MaterialInfo.GetMaterialColor("copper", "classic", 0);
            }
            else if (iGolem >= 85)
            {
                sGolem = "a Shadow Iron Golem"; iAdd = 3; sIngot = "shadow iron ingots"; Hue = MaterialInfo.GetMaterialColor("shadow iron", "classic", 0);
            }
            else if (iGolem >= 45)
            {
                sGolem = "a Dull Copper Golem"; iAdd = 2; sIngot = "dull copper ingots"; Hue = MaterialInfo.GetMaterialColor("dull copper", "classic", 0);
            }
    ...
    public override bool OnDragDrop(Mobile from, Item dropped)
    {
        ...
        if (from != null)
        {
            ...
            else if (dropped is BottleOil && NeedOil > HaveOil)
            {
                ...
                WhatIsExtra  = WhatIsDropped - WhatIsNeeded; if (WhatIsExtra < 1)
                {
                    WhatIsExtra = 0;
                }
    ...
    public string g_TinkerLocation {
        get { return TinkerLocation; } set { TinkerLocation = value; }
    }

    public string GolemType;
    [CommandProperty(AccessLevel.GameMaster)]
    public string g_GolemType {
        get { return GolemType; } set { GolemType = value; }
    }
    ...
    public string g_NeedMetalType {
        get { return NeedMetalType; } set { NeedMetalType = value; }
    }

    public int NeedMetalQty;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_NeedMetalQty {
        get { return NeedMetalQty; } set { NeedMetalQty = value; }
    }

    public int NeedSprings;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_NeedSprings {
        get { return NeedSprings; } set { NeedSprings = value; }
    }
    ...
    public int g_NeedOil {
        get { return NeedOil; } set { NeedOil = value; }
    }

    public int NeedCrystals;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_NeedCrystals {
        get { return NeedCrystals; } set { NeedCrystals = value; }
    }

    public int NeedClocks;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_NeedClocks {
        get { return NeedClocks; } set { NeedClocks = value; }
    }

    public int NeedGems;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_NeedGems {
        get { return NeedGems; } set { NeedGems = value; }
    }

    public int NeedGears;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_NeedGears {
        get { return NeedGears; } set { NeedGears = value; }
    }
    ...
    public int g_HaveMetalQty {
        get { return HaveMetalQty; } set { HaveMetalQty = value; }
    }

    public int HaveDarkCore;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveDarkCore {
        get { return HaveDarkCore; } set { HaveDarkCore = value; }
    }

    public int HaveSprings;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveSprings {
        get { return HaveSprings; } set { HaveSprings = value; }
    }
    ...
    public int g_HaveOil {
        get { return HaveOil; } set { HaveOil = value; }
    }

    public int HaveCrystals;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveCrystals {
        get { return HaveCrystals; } set { HaveCrystals = value; }
    }

    public int HaveClocks;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveClocks {
        get { return HaveClocks; } set { HaveClocks = value; }
    }

    public int HaveGems;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveGems {
        get { return HaveGems; } set { HaveGems = value; }
    }

    public int HaveGears;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveGears {
        get { return HaveGears; } set { HaveGears = value; }
    }
}
}
