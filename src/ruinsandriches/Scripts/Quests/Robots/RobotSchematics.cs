...
public class RobotSchematics : Item
{
    ...
    public int g_NeedBolts {
        get { return NeedBolts; } set { NeedBolts = value; }
    }

    public int NeedXormite;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_NeedXormite {
        get { return NeedXormite; } set { NeedXormite = value; }
    }
    ...
    public int g_NeedCircuitBoard {
        get { return NeedCircuitBoard; } set { NeedCircuitBoard = value; }
    }

    public int NeedEngineParts;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_NeedEngineParts {
        get { return NeedEngineParts; } set { NeedEngineParts = value; }
    }

    public int NeedTransistors;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_NeedTransistors {
        get { return NeedTransistors; } set { NeedTransistors = value; }
    }
    ...
    public int g_HaveBolts {
        get { return HaveBolts; } set { HaveBolts = value; }
    }

    public int HaveXormite;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveXormite {
        get { return HaveXormite; } set { HaveXormite = value; }
    }
    ...
    public int g_HaveCircuitBoard {
        get { return HaveCircuitBoard; } set { HaveCircuitBoard = value; }
    }

    public int HaveEngineParts;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveEngineParts {
        get { return HaveEngineParts; } set { HaveEngineParts = value; }
    }

    public int HaveTransistors;
    [CommandProperty(AccessLevel.GameMaster)]
    public int g_HaveTransistors {
        get { return HaveTransistors; } set { HaveTransistors = value; }
    }
