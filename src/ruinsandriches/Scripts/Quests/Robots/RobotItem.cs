...
public class RobotItem : Item
{
    ...
    public int Robot_Serial {
        get { return RobotSerial; } set { RobotSerial = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Robot_Owner {
        get { return RobotOwner; } set { RobotOwner = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string Robot_Name {
        get { return RobotName; } set { RobotName = value; InvalidateProperties(); }
    }
