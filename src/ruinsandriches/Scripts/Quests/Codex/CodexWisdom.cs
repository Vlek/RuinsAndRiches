...
public class CodexGump : Gump
{
    ...
    public CodexGump(CodexWisdom codex, string warn, Mobile from) : base(50, 50)
    {
        ...
        {
            title = "CHOOSE ONE SKILL TO STUDY OR ONE TO FORGET SO YOU CAN LEARN A DIFFERENT ONE";
        }
        else if (m_CodexWisdom.SkillFirst > 0 && m_CodexWisdom.SkillSecond == 0)
        {
            title = "CHOOSE ONE SKILL TO STUDY OR ONE TO FORGET SO YOU CAN LEARN A DIFFERENT ONE";
        ...
        if (warn == null)
        {
            warn = "If you change your skills and leave the chamber, the lenses will vanish and you may need to find others.";
        }
    ...
    public void GetLine(int val, int skill1, int skill2)
    {
        ...
        if (txt != "")
        {
            ...
            {
                x = 371; y = 25 + ((val - 23) * 28);
            }
            else
            {
                x = 706; y = 25 + ((val - 46) * 28);
            }
...
public class CodexWisdom : MagicTalisman
{
    ...
    public Mobile Codex_Owner {
        get { return CodexOwner; } set { CodexOwner = value; }
    }
    ...
    public int Skill_First {
        get { return SkillFirst; } set { SkillFirst = value; InvalidateProperties(); }
    }

    public int SkillSecond;
    [CommandProperty(AccessLevel.Owner)]
    public int Skill_Second {
        get { return SkillSecond; } set { SkillSecond = value; InvalidateProperties(); }
    }
    ...
    public int Previous_First {
        get { return PreviousFirst; } set { PreviousFirst = value; InvalidateProperties(); }
    }

    public int PreviousSecond;
    [CommandProperty(AccessLevel.Owner)]
    public int Previous_Second {
        get { return PreviousSecond; } set { PreviousSecond = value; InvalidateProperties(); }
    }
