...
public class HoardPiles : Item
{
    ...
    public int Uses {
        get { return m_Uses; } set { m_Uses = value; InvalidateProperties(); }
    }
    ...
    public string Hoard_Name {
        get { return HoardName; } set { HoardName = value; InvalidateProperties(); }
    }
        ...
        else if (m_Uses < 5)
        {
            ...
            switch (Utility.Random(17))
            {
                ...
                case 16:
                    ...
                    {
                        Item artys = Loot.RandomArty(); ((LootChest)item).DropItem(artys);
                    }
                    break;
            }
