...
public class PlantHerbalism_Leaf : Item
{
    ...
    public override void Deserialize(GenericReader reader)
    {
        ...
        {
            Hue = 0x845; ItemID = 0x2FE0;
        }
        else if (Name == "winter berry")
        {
            Hue = 0x47E; ItemID = 0x2FE0;
        }
        else if (Name == "earth stem")
        {
            Hue = 0x7D6; ItemID = 0xF88;
        }
        else if (Name == "tangle leaf")
        {
            Hue = 0x8A4; ItemID = 0x2066;
        }
        else if (Name == "eldritch leaf")
        {
            Hue = 0x48F; ItemID = 0x2066;
        }
...
public class PlantHerbalism_Flower : Item
{
    ...
    public override void Deserialize(GenericReader reader)
    {
        ...
        if (Name == "lotus petal")
        {
            Hue = 0x1A0; ItemID = 0x2FE8;
        }
        else if (Name == "life root")
        {
            Hue = 0x8A4; ItemID = 0xF85;
        }
        else if (Name == "snake weed")
        {
            Hue = 0x89F; ItemID = 0xF88;
        }
        Timer.DelayCall(TimeSpan.FromSeconds(15.0), new TimerCallback(Delete));
    }
}
...
public class PlantHerbalism_Mushroom : Item
{
    ...
    public override void Deserialize(GenericReader reader)
    {
        ...
        {
            Hue = 0x47E; ItemID = 0xB4D;
        }
        else if (Name == "dark toadstool")
        {
            Hue = 0x96A; ItemID = 0xB4D;
        }
        else if (Name == "purple fungus")
        {
            Hue = 0x13C; ItemID = 0xB4D;
        }
        Timer.DelayCall(TimeSpan.FromSeconds(15.0), new TimerCallback(Delete));
    }
}
...
public class PlantHerbalism_Lilly : Item
{
    ...
    public override void Deserialize(GenericReader reader)
    {
        ...
        {
            Hue = 0x89F; ItemID = 0x2066;
        }
        else if (Name == "lilly flower petal")
        {
            Hue = 0x47E; ItemID = 0x2FE8;
        }
        else if (Name == "deep water stem")
        {
            Hue = 0x60; ItemID = 0x0A96;
        }
        Timer.DelayCall(TimeSpan.FromSeconds(15.0), new TimerCallback(Delete));
    }
}
...
public class PlantHerbalism_Cactus : Item
{
    ...
    public override void Deserialize(GenericReader reader)
    {
        ...
        if (Name == "desert root")
        {
            Hue = 0x54E; ItemID = 0xF86;
        }
        else if (Name == "cactus sponge")
        {
            Hue = 0x89F; ItemID = 0x2065;
        }
        else if (Name == "vampire thorn")
        {
            Hue = 0x485; ItemID = 0x2069;
        }
        Timer.DelayCall(TimeSpan.FromSeconds(15.0), new TimerCallback(Delete));
    }
}
...
public class PlantHerbalism_Grass : Item
{
    ...
    public override void Deserialize(GenericReader reader)
    {
        ...
        if (Name == "forest hair")
        {
            Hue = 0x7D1; ItemID = 0x2064;
        }
        else if (Name == "fey seed")
        {
            Hue = 0x7D6; ItemID = 0x2067;
        }
        else if (Name == "druidic blade")
        {
            Hue = 0x7D6; ItemID = 0x0A96;
        }
        Timer.DelayCall(TimeSpan.FromSeconds(15.0), new TimerCallback(Delete));
    }
}
