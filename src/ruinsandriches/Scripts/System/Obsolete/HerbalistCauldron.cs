...
public class HerbalistCauldron : Item
{
    ...
    public string My_Ingredient2 {
        get { return MyIngredient2; } set { MyIngredient2 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Ingredient3 {
        get { return MyIngredient3; } set { MyIngredient3 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int My_Reagent {
        get { return MyReagent; } set { MyReagent = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int My_Water {
        get { return MyWater; } set { MyWater = value; InvalidateProperties(); }
    }
    ...
    public string My_Cauldron {
        get { return MyCauldron; } set { MyCauldron = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe01 {
        get { return MyRecipe01; } set { MyRecipe01 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe02 {
        get { return MyRecipe02; } set { MyRecipe02 = value; InvalidateProperties(); }
    }
    ...
    public string My_Recipe04 {
        get { return MyRecipe04; } set { MyRecipe04 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe05 {
        get { return MyRecipe05; } set { MyRecipe05 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe06 {
        get { return MyRecipe06; } set { MyRecipe06 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe07 {
        get { return MyRecipe07; } set { MyRecipe07 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe08 {
        get { return MyRecipe08; } set { MyRecipe08 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe09 {
        get { return MyRecipe09; } set { MyRecipe09 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe10 {
        get { return MyRecipe10; } set { MyRecipe10 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe11 {
        get { return MyRecipe11; } set { MyRecipe11 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe12 {
        get { return MyRecipe12; } set { MyRecipe12 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe13 {
        get { return MyRecipe13; } set { MyRecipe13 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe14 {
        get { return MyRecipe14; } set { MyRecipe14 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe15 {
        get { return MyRecipe15; } set { MyRecipe15 = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public string My_Recipe16 {
        get { return MyRecipe16; } set { MyRecipe16 = value; InvalidateProperties(); }
    }
        ...
        protected override void OnTarget(Mobile from, object targeted)
        {
            ...
            else if (m_Stage == 4)
            {
                ...
                if (obj is WaterVial || obj is WaterFlask || obj is Waterskin || obj is DirtyWaterskin)
                {
                    ...
                    {
                        from.AddToBackpack(new Waterskin()); jar.Delete();
                    }
            ...
            else if (m_Stage == 5 && obj is MixingSpoon)
            {
                ...
                {
                    from.SendMessage("Your cauldron mixer has gotten too soft from over use."); spoon.Delete();
                }
                ...
                if (from.CheckSkill(SkillName.Alchemy, 0, 100))
                {
                    ...
                    if (m_Pot.MyRecipe01 != "" && m_Pot.MyRecipe01 != null)
                    {
                        ...
                        if (((m_Pot.MyIngredient1 == sR1) || (m_Pot.MyIngredient1 == sR2)) && ((m_Pot.MyIngredient2 == sR1) || (m_Pot.MyIngredient2 == sR2)) && (m_Pot.MyIngredient3 == sR3))
                        {
                            sMk1 = true; potionName = sR4;
                        }
                    }
                    ...
                    else
                    {
                        ...
                        if (m_Pot.MyRecipe01 == "" || m_Pot.MyRecipe01 == null)
                        {
                            potionName = "liquid lure stone"; WhichPotion = 1;
                        }
                        else if (m_Pot.MyRecipe02 == "" || m_Pot.MyRecipe02 == null)
                        {
                            potionName = "nature passage mixture"; WhichPotion = 2;
                        }
                        else if (m_Pot.MyRecipe03 == "" || m_Pot.MyRecipe03 == null)
                        {
                            potionName = "shield of earth liquid"; WhichPotion = 3;
                        }
                        else if (m_Pot.MyRecipe04 == "" || m_Pot.MyRecipe04 == null)
                        {
                            potionName = "woodland protection oil"; WhichPotion = 4;
                        }
                        else if (m_Pot.MyRecipe05 == "" || m_Pot.MyRecipe05 == null)
                        {
                            potionName = "stone rising concoction"; WhichPotion = 5;
                        }
                        else if (m_Pot.MyRecipe06 == "" || m_Pot.MyRecipe06 == null)
                        {
                            potionName = "grasping roots mixture"; WhichPotion = 6;
                        }
                        else if (m_Pot.MyRecipe07 == "" || m_Pot.MyRecipe07 == null)
                        {
                            potionName = "druidic marking oil"; WhichPotion = 7;
                        }
                        else if (m_Pot.MyRecipe08 == "" || m_Pot.MyRecipe08 == null)
                        {
                            potionName = "herbal healing elixir"; WhichPotion = 8;
                        }
                        else if (m_Pot.MyRecipe09 == "" || m_Pot.MyRecipe09 == null)
                        {
                            potionName = "forest blending oil"; WhichPotion = 9;
                        }
                        else if (m_Pot.MyRecipe10 == "" || m_Pot.MyRecipe10 == null)
                        {
                            potionName = "firefly attraction potion"; WhichPotion = 10; PotionRegDifficult = 1;
                        }
                        else if (m_Pot.MyRecipe11 == "" || m_Pot.MyRecipe11 == null)
                        {
                            potionName = "mushroom gateway growth"; WhichPotion = 11; PotionRegDifficult = 1;
                        }
                        else if (m_Pot.MyRecipe12 == "" || m_Pot.MyRecipe12 == null)
                        {
                            potionName = "insect trapping mixture"; WhichPotion = 12; PotionRegDifficult = 1;
                        }
                        else if (m_Pot.MyRecipe13 == "" || m_Pot.MyRecipe13 == null)
                        {
                            potionName = "fairy pheromones"; WhichPotion = 13; PotionRegDifficult = 1;
                        }
                        else if (m_Pot.MyRecipe14 == "" || m_Pot.MyRecipe14 == null)
                        {
                            potionName = "treant fertilizer"; WhichPotion = 14; PotionRegDifficult = 1;
                        }
                        else if (m_Pot.MyRecipe15 == "" || m_Pot.MyRecipe15 == null)
                        {
                            potionName = "volcanic fluid"; WhichPotion = 15; PotionRegDifficult = 1;
                        }
                        else if (m_Pot.MyRecipe16 == "" || m_Pot.MyRecipe16 == null)
                        {
                            potionName = "magical mud"; WhichPotion = 16; PotionRegDifficult = 1;
                        }
            ...
            else if (m_Stage == 6 && obj is Jar)
            {
                ...
                {
                    from.AddToBackpack(new LureStonePotion()); sFillMessage = "You fill the jar with some of the liquid, and it forms a stone inside.";
                }
                ...
                {
                    from.AddToBackpack(new FireflyPotion()); sFillMessage = "You use some of the liquid, attracting fireflies and trapping them in the jar.";
                }
                ...
                {
                    from.AddToBackpack(new SwarmOfInsectsPotion()); sFillMessage = "You use some of the liquid, attracting insects and trapping them in the jar.";
                }
                else if (m_Pot.MyPotion == "fairy pheromones")
                {
                    from.AddToBackpack(new ProtectiveFairyPotion()); sFillMessage = "You use some of the liquid, attracting a fairy and trapping it in the jar.";
                }
                ...
                {
                    from.AddToBackpack(new RestorativeSoilPotion()); sFillMessage = "You fill a jar with the magical mud.";
                }
