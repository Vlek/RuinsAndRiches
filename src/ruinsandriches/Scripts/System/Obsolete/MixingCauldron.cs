...
public class MixingCauldron : Item
{
    ...
    public string My_Ingredient4 {
        get { return MyIngredient4; } set { MyIngredient4 = value; InvalidateProperties(); }
    }
    ...
    private class IngredientTarget : Target
    {
        ...
        protected override void OnTarget(Mobile from, object targeted)
        {
            ...
            else if (m_Stage == 6 && obj is MixingSpoon)
            {
                ...
                {
                    from.SendMessage("Your cauldron mixer has corroded away."); spoon.Delete();
                }
                ...
                if (from.CheckSkill(SkillName.Alchemy, 0, 100))
                {
                    ...
                    if (m_Pot.MyRecipe01 != "" && m_Pot.MyRecipe01 != null)
                    {
                        ...
                        if (((m_Pot.MyIngredient1 == sR1) || (m_Pot.MyIngredient1 == sR2)) && ((m_Pot.MyIngredient2 == sR1) || (m_Pot.MyIngredient2 == sR2)) && (m_Pot.MyIngredient3 == sR3) && (m_Pot.MyIngredient4 == sR4))
                        {
                            sMk1 = true; potionName = sR5;
                        }
                    }
                    ...
                    else
                    {
                        ...
                        if (m_Pot.MyRecipe01 == "" || m_Pot.MyRecipe01 == null)
                        {
                            potionName = "eyes of the dead mixture"; WhichPotion = 1; PotHue = 0x491;
                        }
                        else if (m_Pot.MyRecipe02 == "" || m_Pot.MyRecipe02 == null)
                        {
                            potionName = "tomb raiding concoction"; WhichPotion = 2; PotHue = 0x493;
                        }
                        else if (m_Pot.MyRecipe03 == "" || m_Pot.MyRecipe03 == null)
                        {
                            potionName = "disease draught"; WhichPotion = 3; PotHue = 0x4F8;
                        }
                        else if (m_Pot.MyRecipe04 == "" || m_Pot.MyRecipe04 == null)
                        {
                            potionName = "phantasm elixir"; WhichPotion = 4; PotHue = 0x6DE;
                        }
                        else if (m_Pot.MyRecipe05 == "" || m_Pot.MyRecipe05 == null)
                        {
                            potionName = "retched air elixir"; WhichPotion = 5; PotHue = 0xA97;
                        }
                        else if (m_Pot.MyRecipe06 == "" || m_Pot.MyRecipe06 == null)
                        {
                            potionName = "lich leech mixture"; WhichPotion = 6; PotHue = 0xB87;
                        }
                        else if (m_Pot.MyRecipe07 == "" || m_Pot.MyRecipe07 == null)
                        {
                            potionName = "wall of spikes draught"; WhichPotion = 7; PotHue = 0xB8F;
                        }
                        else if (m_Pot.MyRecipe08 == "" || m_Pot.MyRecipe08 == null)
                        {
                            potionName = "disease curing concoction"; WhichPotion = 8; PotHue = 0x8A2;
                        }
                        else if (m_Pot.MyRecipe09 == "" || m_Pot.MyRecipe09 == null)
                        {
                            potionName = "blood pact elixir"; WhichPotion = 9; PotHue = 0x5B5;
                        }
                        else if (m_Pot.MyRecipe10 == "" || m_Pot.MyRecipe10 == null)
                        {
                            potionName = "spectre shadow elixir"; WhichPotion = 10; PotionRegDifficult = 1; PotHue = 0x17E;
                        }
                        else if (m_Pot.MyRecipe11 == "" || m_Pot.MyRecipe11 == null)
                        {
                            potionName = "ghost phase concoction"; WhichPotion = 11; PotionRegDifficult = 1; PotHue = 0x47E;
                        }
                        else if (m_Pot.MyRecipe12 == "" || m_Pot.MyRecipe12 == null)
                        {
                            potionName = "demonic fire ooze"; WhichPotion = 12; PotionRegDifficult = 1; PotHue = 0x54F;
                        }
                        else if (m_Pot.MyRecipe13 == "" || m_Pot.MyRecipe13 == null)
                        {
                            potionName = "ghostly images draught"; WhichPotion = 13; PotionRegDifficult = 1; PotHue = 0xBF;
                        }
                        else if (m_Pot.MyRecipe14 == "" || m_Pot.MyRecipe14 == null)
                        {
                            potionName = "hellish branding ooze"; WhichPotion = 14; PotionRegDifficult = 1; PotHue = 0x54C;
                        }
                        else if (m_Pot.MyRecipe15 == "" || m_Pot.MyRecipe15 == null)
                        {
                            potionName = "black gate draught"; WhichPotion = 15; PotionRegDifficult = 1; PotHue = 0x2EA;
                        }
                        else if (m_Pot.MyRecipe16 == "" || m_Pot.MyRecipe16 == null)
                        {
                            potionName = "vampire blood draught"; WhichPotion = 16; PotionRegDifficult = 1; PotHue = 0xB85;
                        }
