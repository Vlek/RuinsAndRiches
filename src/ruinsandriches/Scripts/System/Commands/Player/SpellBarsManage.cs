...
public class SetupBarsMage1 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new Server.Engines.Help.HelpGump(from, 7)); from.SendSound(0x4A);
        }
        else if (info.ButtonID < 1)
        {
        }
        ...
        {
            from.SendGump(new SetupBarsMage1(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsMage2 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsMage2(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsMage3 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsMage3(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsMage4 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsMage4(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsElement1 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsElement1(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsElement2 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsElement2(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsNecro1 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsNecro1(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsNecro2 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsNecro2(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsKnight1 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsKnight1(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsKnight2 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsKnight2(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsBard1 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsBard1(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsBard2 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsBard2(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsDeath1 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsDeath1(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsDeath2 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsDeath2(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsPriest1 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsPriest1(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsPriest2 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsPriest2(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsMonk1 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsMonk1(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
...
public class SetupBarsMonk2 : Gump
{
    ...
    public override void OnResponse(NetState sender, RelayInfo info)
    {
        ...
        {
            from.SendGump(new SetupBarsMonk2(from, m_Origin)); from.SendSound(0x4A);
        }
    }
}
}
