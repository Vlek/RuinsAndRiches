...
public class MusicPlaylist : Gump
{
    ...
    public void GetLine(int val, string MySettings)
    {
        ...
        {
            num = 2; txt = "Buccaneer's Den";
        }
        else if (val == 3)
        {
            num = 3; txt = "Castle British*";
        }
        else if (val == 4)
        {
            num = 4; txt = "Castle of Knowledge*";
        }
        else if (val == 5)
        {
            num = 5; txt = "Death Gulch";
        }
        else if (val == 6)
        {
            num = 6; txt = "Devil Guard";
        }
        else if (val == 7)
        {
            num = 7; txt = "Elidor";
        ...
        {
            num = 41; txt = "Mines of Morinia";
        }
        else if (val == 28)
        {
            num = 42; txt = "Perinian Depths";
        }
        else if (val == 29)
        {
            num = 43; txt = "Shame";
        ...
        {
            num = 18; txt = "Adventure";
        }
        else if (val == 33)
        {
            num = 19; txt = "Expedition";
        }
        else if (val == 34)
        {
            num = 20; txt = "Explore";
        ...
        {
            num = 28; txt = "Traveling";
        }
        else if (val == 43)
        {
            num = 29; txt = "Wandering";
        }
        else if (val == 44)
        {
            num = 52; txt = "Alehouse";
        ...
        {
            num = 15; txt = "Time Lord";
        }
        else if (val == 60)
        {
            num = 16; txt = "Wizard Den";
        }
        ...
        if (txt != "")
        {
            ...
            {
                x = 331; y = 20 + ((val - 20) * 28);
            }
            else
            {
                x = 584; y = 20 + ((val - 40) * 28);
            }
