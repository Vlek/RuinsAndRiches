...
class Statistics
{
    ...
    public class StatisticsGump : Gump
    {
        ...
        public StatisticsGump(Mobile from, int origin) : base(50, 50)
        {
            ...
            AddHtml(13, 12, 434, 20, @"<BODY><BASEFONT Color=" + color + ">" + Server.Misc.MyServerSettings.ServerName() + "</BASEFONT></BODY>", (bool)false, (bool)false);
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            if (m_Origin > 0)
            {
                from.SendSound(0x4A); from.SendGump(new Server.Engines.Help.HelpGump(from, 1));
            }
        }
    }
}
