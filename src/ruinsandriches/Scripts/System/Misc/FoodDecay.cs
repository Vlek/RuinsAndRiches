            ...
            if (m is PlayerMobile)
            {
                ...
                else
                {
                    if (m.Hunger >= 1)
                    {
                        ...
                        if (m.Hunger < 5)
                        {
                            m.SendMessage("You are extremely hungry."); m.LocalOverheadMessage(MessageType.Emote, 0xB1F, true, "I am extremely hungry.");
                        }
                        else if (m.Hunger < 10)
                        {
                            m.SendMessage("You are getting very hungry."); m.LocalOverheadMessage(MessageType.Emote, 0xB1F, true, "I am getting very hungry.");
                        }
                    }
                    else
                    {
            ...
            if (m is PlayerMobile)
            {
                ...
                else
                {
                    if (m.Thirst >= 1)
                    {
                        ...
                        if (m.Thirst < 5)
                        {
                            m.SendMessage("You are extremely thirsty."); m.LocalOverheadMessage(MessageType.Emote, 0xB1F, true, "I am extremely thirsty.");
                        }
                        else if (m.Thirst < 10)
                        {
                            m.SendMessage("You are getting thirsty."); m.LocalOverheadMessage(MessageType.Emote, 0xB1F, true, "I am getting thirsty.");
                        }
                    }
                    else
                    {
