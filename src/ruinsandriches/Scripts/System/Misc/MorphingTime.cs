...
class MorphingTime
{
    ...
    public static void VampireDressUp(Mobile m, int body)
    {
        ...
        if (Utility.RandomMinMax(1, 2) == 1)
        {
            LeatherGloves gloves = new LeatherGloves(); gloves.Hue = Hue2; m.AddItem(gloves);
        }
    ...
    {
        if (m.FindItemOnLayer(Layer.OuterTorso) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.OuterTorso)))
        {
        ...
        if (m.FindItemOnLayer(Layer.MiddleTorso) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.MiddleTorso)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Bracelet) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Bracelet)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Ring) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Ring)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Helm) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Helm)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Arms) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Arms)))
        {
        ...
        if (m.FindItemOnLayer(Layer.OuterLegs) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.OuterLegs)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Neck) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Neck)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Gloves) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Gloves)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Talisman) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Talisman)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Shoes) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Shoes)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Cloak) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Cloak)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Waist) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Waist)))
        {
        ...
        if (m.FindItemOnLayer(Layer.InnerLegs) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.InnerLegs)))
        {
        ...
        if (m.FindItemOnLayer(Layer.InnerTorso) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.InnerTorso)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Pants) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Pants)))
        {
        ...
        if (m.FindItemOnLayer(Layer.Shirt) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.Shirt)))
        {
    ...
    public static void ColorMyClothes(Mobile m, int hue, int rndm)
    {
        ...
        if (m.FindItemOnLayer(Layer.OneHanded) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.OneHanded)))
        {
        ...
        if (m.FindItemOnLayer(Layer.TwoHanded) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.TwoHanded)))
        {
        ...
        if (m.FindItemOnLayer(Layer.FirstValid) != null && MyServerSettings.AlterArtifact(m.FindItemOnLayer(Layer.FirstValid)))
        {
    ...
    public static void MakeSpaceAceMetalArmorWeapon(Item item, string material)
    {
        ...
        if (item is BaseWeapon)
        {
            ...
            {
                Server.Misc.MorphingItem.MorphMyItem(item, "IGNORED", ("" + material + suffix + ""), "IGNORED", MorphingTemplates.TemplateSpaceAce("weapons"));
            }
            else
            {
        ...
        else if (item is BaseArmor)
        {
            ...
            if (Utility.RandomMinMax(1, 10) == 1)
            {
                Server.Misc.MorphingItem.MorphMyItem(item, "IGNORED", ("" + material + suffix + ""), "IGNORED", MorphingTemplates.TemplateSpaceAce("armors"));
            }
            else
            {
                RenameSpaceAceItem(item, ("" + material + suffix + ""));
        ...
        if (item is BaseWeapon)
        {
            BaseWeapon weapon = (BaseWeapon)item; weapon.Resource = CraftResource.None;
        }
        else if (item is BaseArmor)
        {
            BaseArmor armor = (BaseArmor)item; armor.Resource = CraftResource.None;
        }
    ...
    public static void MakeSpaceAceBoneArmor(Item item, string material, bool keepName)
    {
        ...
        {
            item.Name = "skeletal leggings"; item.ItemID = 0x49C2;
        }
        else if (item is BoneGloves || item is SavageGloves)
        {
            item.Name = "skeletal gauntlets"; item.ItemID = 0x499D;
        }
        else if (item is BoneArms || item is SavageArms)
        {
            item.Name = "skeletal bracers"; item.ItemID = 0x4988;
        }
        else if (item is BoneChest || item is SavageChest)
        {
            item.Name = "skeletal tunic"; item.ItemID = 0x498F;
        }
        ...
        {
            item.Name = "skeletal helm"; item.ItemID = 0x49C1;
        }
        ...
        if (item is BaseArmor)
        {
            ...
            if (Utility.RandomMinMax(1, 10) == 1)
            {
                Server.Misc.MorphingItem.MorphMyItem(item, "IGNORED", material, "IGNORED", MorphingTemplates.TemplateSpaceAce("armors"));
            }
            else
            {
    ...
    public static void MakeSpaceAceItem(Item item, Mobile m)
    {
        if (m != null)
        {
            ...
            if (Server.Misc.Worlds.IsOnSpaceship(m.Location, m.Map))
            {
                ...
                {
                    item.Name = "minimal access card"; item.ItemID = 0x3A75; item.Hue = 0x59A;
                }
                else if (item is MasterSkeletonsKey)
                {
                    item.Name = "full access card"; item.ItemID = 0x3A75; item.Hue = 0x66D;
                }
                else if (item is Lockpick)
                {
                    item.Name = "security card"; item.ItemID = 0x3A75; item.Hue = 0x53C; item.Amount = Utility.RandomMinMax(1, 3);
                }
                ...
                {
                    item.ItemID = 0x2023; item.Hue = 0xB51; item.Name = "soylent green";
                }
                else if (item is Ribs)
                {
                    item.ItemID = 0x2023; item.Hue = 0xB20; item.Name = "spam";
                }
                ...
                {
                    item.ItemID = 0x4971; item.Name = "empty canteen";
                }
                else if (item is DirtyWaterskin)
                {
                    item.ItemID = 0x48E4; item.Name = "old canteen";
                }
                ...
                {
                    item.ItemID = 0xF26; item.Hue = 0x996; item.Name = "kyber crystal";
                }
                else if (item is Emerald)
                {
                    item.ItemID = 0xF25; item.Hue = 0x950; item.Name = "etaan crystal";
                }
                else if (item is Sapphire)
                {
                    item.ItemID = 0xF2D; item.Hue = 0xB40; item.Name = "trilithium crystal";
                }
                else if (item is Ruby)
                {
                    item.ItemID = 0xF16; item.Hue = 0x94F; item.Name = "lava crystal";
                }
                else if (item is Citrine)
                {
                    item.ItemID = 0xF21; item.Hue = 0xB54; item.Name = "dilithium crystal";
                }
                else if (item is Amethyst)
                {
                    item.ItemID = 0xF10; item.Hue = 0x94A; item.Name = "dantari crystal";
                }
                else if (item is Tourmaline)
                {
                    item.ItemID = 0xF19; item.Hue = 0x86C; item.Name = "vexxtal crystal";
                }
                else if (item is Amber)
                {
                    item.ItemID = 0xF13; item.Hue = 0x8FC; item.Name = "nova crystal";
                }
                else if (item is Diamond)
                {
                    item.ItemID = 0xF15; item.Hue = 0x90F; item.Name = "permafrost crystal";
                }
                ...
                {
                    if (item is BoneSkirt || item is BoneLegs || item is BoneGloves || item is BoneArms || item is BoneChest || item is OrcHelm || item is BoneHelm)
                    {
                        MakeSpaceAceBoneArmor(item, null, false);
                    }
                    else if (item is SavageLegs || item is SavageGloves || item is SavageArms || item is SavageChest || item is SavageHelm)
                    {
                        MakeSpaceAceBoneArmor(item, null, false);
                    }
                    else if (Server.Misc.MaterialInfo.IsWoodenItem(item) && Utility.RandomMinMax(1, 20) == 1)
                    {
                    ...
                    else if (Server.Misc.MaterialInfo.IsLeatherItem(item) && Utility.RandomMinMax(1, 20) == 1)
                    {
                    ...
                    else if (Server.Misc.MaterialInfo.IsMetalItem(item) && Utility.RandomMinMax(1, 20) == 1)
                    {
                ...
                {
                    if (Server.Misc.MaterialInfo.IsLeatherItem(item) && Utility.RandomMinMax(1, 20) == 1)
                    {
                ...
                {
                    item.Name = "sleeping bag"; item.Hue = Utility.RandomColor(0);
                }
                ...
                {
                    item.Name = "binoculars"; item.ItemID = 0x3562;
                }
                else if (item is ArtifactManual)
                {
                    item.Name = "magnifying lense"; item.ItemID = 0x202F; item.Hue = 0; ((ArtifactManual)item).Charges = Utility.RandomMinMax(2, 10);
                }
            }
        }
    }
            ...
            if (Server.Misc.GetPlayerInfo.OrientalPlay(m) == true)
            {
                ...
                if (ninja > 0 && ninja >= samurai)
                {
                    if (item is LeatherCap)
                    {
                        switch (Utility.RandomMinMax(1, 5))
                        {
                            case 1: item.ItemID = 0x278E; item.Name = "leather hood"; if (item.Hue == 0)
                                {
                                    item.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                                }
                                break;
                            case 2: item.ItemID = 0x5C11; item.Name = "shinobi hood"; if (item.Hue == 0)
                                {
                                    item.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                                }
                                break;
                            case 3: item.ItemID = 0x5C12; item.Name = "shinobi mask"; if (item.Hue == 0)
                                {
                                    item.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                                }
                                break;
                            case 4: item.ItemID = 0x5C13; item.Name = "shinobi cowl"; if (item.Hue == 0)
                                {
                                    item.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                                }
                                break;
                    ...
                    else if (item is LeatherChest)
                    {
                        ...
                        {
                            item.ItemID = 0x2793; item.Name = "leather shitagi"; if (item.Hue == 0)
                            {
                                item.Hue = 0x83D;
                            }
                        }
                    ...
                    else if (item is LeatherGloves)
                    {
                        ...
                        {
                            item.ItemID = 0x2792; item.Name = "leather yugake"; if (item.Hue == 0)
                            {
                                item.Hue = 0x83D;
                            }
                        }
                    ...
                    else if (item is LeatherLegs)
                    {
                        ...
                        {
                            item.ItemID = 0x2791; item.Name = "leather hakama"; if (item.Hue == 0)
                            {
                                item.Hue = 0x83D;
                            }
                        }
                    ...
                    {
                        item.ItemID = 0x277A; item.Name = "leather nodowa"; if (item.Hue == 0)
                        {
                            item.Hue = 0x83D;
                        }
                    }
                    ...
                    {
                        item.ItemID = 0x5C10; item.Name = "shinobi robe"; if (item.Hue == 0)
                        {
                            item.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                        }
                    }
                    ...
                    {
                        item.ItemID = 0x2793; item.Name = "studded shitagi"; if (item.Hue == 0)
                        {
                            item.Hue = 0x837;
                        }
                    }
                    ...
                    {
                        item.ItemID = 0x2791; item.Name = "studded hakama"; if (item.Hue == 0)
                        {
                            item.Hue = 0x837;
                        }
                    }
                    ...
                    {
                        item.ItemID = 0x2792; item.Name = "studded yugake"; if (item.Hue == 0)
                        {
                            item.Hue = 0x837;
                        }
                    }
                    ...
                    {
                        item.ItemID = 0x2797; item.Name = "shinobi tabi";
                    }
                    else if (item is MagicHat)
                    {
                        item.ItemID = 0x27DA; item.Name = "shinobi hood"; if (item.Hue == 0)
                        {
                            item.Hue = Server.Misc.MaterialInfo.PlainLeatherColor();
                        }
                    }
                ...
                else if (samurai > 0 && samurai >= ninja)
                {
                    if (item is LeatherCap)
                    {
                        item.ItemID = 0x2798; item.Name = "leather kasa";
                    }
                    else if (item is LeatherChest)
                    {
                        item.ItemID = 0x277B; item.Name = "leather do";
                    }
                    else if (item is LeatherLegs && Utility.RandomMinMax(1, 2) == 1)
                    {
                        item.ItemID = 0x278A; item.Name = "leather haidate";
                    }
                    else if (item is LeatherLegs)
                    {
                        item.ItemID = 0x2786; item.Name = "leather suneate";
                    }
                    else if (item is LeatherGorget)
                    {
                        item.ItemID = 0x277A; item.Name = "leather mempo";
                    }
                    else if (item is LeatherArms)
                    {
                        item.ItemID = 0x277E; item.Name = "leather kote";
                    }
                    else if (item is StuddedChest)
                    {
                        item.ItemID = 0x27C7; item.Name = "studded do";
                    }
                    else if (item is StuddedLegs && Utility.RandomMinMax(1, 2) == 1)
                    {
                        item.ItemID = 0x278B; item.Name = "studded haidate";
                    }
                    else if (item is StuddedLegs)
                    {
                        item.ItemID = 0x27D2; item.Name = "studded suneate";
                    }
                    else if (item is StuddedGorget)
                    {
                        item.ItemID = 0x279D; item.Name = "studded mempo";
                    }
                    else if (item is StuddedArms)
                    {
                        item.ItemID = 0x277F; item.Name = "studded kote";
                    }
                ...
                {
                    item.ItemID = 0x2774; item.Name = "chain hatsuburi"; if (item.Hue == 0)
                    {
                        item.Hue = 0x836;
                    }
                }
                ...
                {
                    item.ItemID = 0x277F; item.Name = "ringmail kote"; if (item.Hue == 0)
                    {
                        item.Hue = 0x836;
                    }
                }
                ...
                {
                    item.ItemID = 0x278D; item.Name = "ringmail haidate"; if (item.Hue == 0)
                    {
                        item.Hue = 0x836;
                    }
                }
                ...
                {
                    item.ItemID = 0x2788; item.Name = "chain suneate"; if (item.Hue == 0)
                    {
                        item.Hue = 0x836;
                    }
                }
                ...
                {
                    item.ItemID = 0x27C7; item.Name = "ringmail do"; if (item.Hue == 0)
                    {
                        item.Hue = 0x836;
                    }
                }
                ...
                {
                    item.ItemID = 0x277D; item.Name = "chain do"; if (item.Hue == 0)
                    {
                        item.Hue = 0x836;
                    }
                }
                ...
                {
                    item.ItemID = 0x277D; item.Name = "plate do"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x277D; item.Name = "shogun do"; if (item.Hue == 0)
                    {
                        item.Hue = 0x846;
                    }
                }
                ...
                {
                    item.ItemID = 0x2778; item.Name = "scale kabuto";
                }
                else if (item is MagicDragonChest)
                {
                    item.ItemID = 0x277D; item.Name = "scale do";
                }
                else if (item is MagicDragonLegs)
                {
                    item.ItemID = 0x278D; item.Name = "scale haidate";
                }
                else if (item is MagicDragonArms)
                {
                    item.ItemID = 0x2780; item.Name = "scale kote";
                }
                ...
                {
                    item.ItemID = 0x2780; item.Name = "plate kote"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x2780; item.Name = "shogun kote"; if (item.Hue == 0)
                    {
                        item.Hue = 0x846;
                    }
                }
                ...
                {
                    item.ItemID = 0x2779; item.Name = "plate mempo"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x2779; item.Name = "shogun mempo"; if (item.Hue == 0)
                    {
                        item.Hue = 0x846;
                    }
                }
                ...
                {
                    item.ItemID = 0x2788; item.Name = "plate suneate"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x278D; item.Name = "shogun haidate"; if (item.Hue == 0)
                    {
                        item.Hue = 0x846;
                    }
                }
                ...
                {
                    item.ItemID = 0x2781; item.Name = "plate jingasa"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x2777; item.Name = "plate jingasa"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x2775; item.Name = "plate hatsuburi"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x2789; item.Name = "plate kabuto"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x2785; item.Name = "plate kabuto"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x2778; item.Name = "shogun kabuto"; if (item.Hue == 0)
                    {
                        item.Hue = 0x846;
                    }
                }
                ...
                {
                    item.ItemID = 0x2788; item.Name = "wooden suneate";
                }
                else if (item is WoodenPlateGorget)
                {
                    item.ItemID = 0x2779; item.Name = "wooden mempo";
                }
                else if (item is WoodenPlateArms)
                {
                    item.ItemID = 0x2780; item.Name = "wooden kote";
                }
                else if (item is WoodenPlateChest)
                {
                    item.ItemID = 0x277D; item.Name = "wooden do";
                }
                else if (item is WoodenPlateHelm)
                {
                    item.ItemID = 0x2785; item.Name = "wooden kabuto";
                }
                ...
                {
                    item.ItemID = 0x13C6; item.Name = "wushu gloves";
                }
                ...
                {
                    item.ItemID = Utility.RandomList(0x2AB5, 0x27A6); item.Name = "tetsubo";
                }
                ...
                {
                    item.ItemID = 0x27A4; item.Name = "wakizashi";
                }
                ...
                {
                    item.ItemID = 0x27A8; item.Name = "daito"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x27A6; item.Name = "kanabo"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x1B72; item.Name = "large shirudo"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x1B73; item.Name = "small shirudo"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x1B76; item.Name = "infantry shirudo"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
                ...
                {
                    item.ItemID = 0x1B7B; item.Name = "medium shirudo"; if (item.Hue == 0)
                    {
                        item.Hue = 0x539;
                    }
                }
    ...
    public static void ChangeMaterialType(Item item, Mobile from)
    {
        ...
        else
        {
            ...
            int originalColor = 0;
            if (item.Hue == 0x539 || item.Hue == 0x846 || item.Hue == 0x836 || item.Hue == 0x83D || item.Hue == 0x837 || item.Hue == Server.Misc.MaterialInfo.PlainLeatherColor())
            {
            ...
            if (Server.Misc.MaterialInfo.IsMetalItem(item) == true)
            {
                ...
                if (item is BaseWeapon)
                {
                    ...
                    if (chances == 1 && whichOne == 1 && Worlds.IsExploringSeaAreas(from) == true)
                    {
                        weapon.Resource = CraftResource.Nepturite;
                    }
                    else if (chances == 1 && whichOne == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Serpent Island")
                    {
                        weapon.Resource = CraftResource.Obsidian;
                    }
                    else if (chances == 1 && whichOne == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Savaged Empire")
                    {
                        weapon.Resource = CraftResource.Steel;
                    }
                    else if (chances == 1 && whichOne == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Island of Umber Veil")
                    {
                        weapon.Resource = CraftResource.Brass;
                    }
                    else if (chances == 1 && whichOne == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Underworld" && from.Map == Map.SavagedEmpire)
                    {
                        weapon.Resource = CraftResource.Xormite;
                    }
                    else if (chances == 1 && whichOne == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Underworld")
                    {
            ...
            else if (Server.Misc.MaterialInfo.IsLeatherItem(item) == true)
            {
                ...
                if (item is BaseWeapon)
                {
                    ...
                    else if (whichOne == 1 && chances == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Savaged Empire")
                    {
                        weapon.Resource = CraftResource.DinosaurLeather;
                    }
                    else if (whichOne == 1 && chances == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Underworld" && from.Map == Map.SavagedEmpire)
                    {
            ...
            else if (Server.Misc.MaterialInfo.IsWoodenItem(item) == true)
            {
                ...
                if (item is BaseWeapon)
                {
                    ...
                    else if (Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "Ravendark Woods" && chances == 1)
                    {
                        weapon.Resource = CraftResource.GhostTree;
                    }
                    else if (Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Island of Dracula" && chances == 1)
                    {
                        weapon.Resource = CraftResource.GhostTree;
                    }
                    else if (Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Castle of Dracula" && chances == 1)
                    {
                        weapon.Resource = CraftResource.GhostTree;
                    }
                    else if (Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Crypts of Dracula" && chances == 1)
                    {
                        weapon.Resource = CraftResource.GhostTree;
                    }
                    else if (Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Underworld" && chances == 1)
                    {
                ...
                else if (item is BaseInstrument)
                {
                    ...
                    if (item is Trumpet)
                    {
                        ...
                        else if (chances == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Serpent Island")
                        {
                            lute.Resource = CraftResource.Obsidian;
                        }
                        else if (chances == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Savaged Empire")
                        {
                            lute.Resource = CraftResource.Steel;
                        }
                        else if (chances == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Island of Umber Veil")
                        {
                            lute.Resource = CraftResource.Brass;
                        }
                        else if (chances == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Underworld" && from.Map == Map.SavagedEmpire)
                        {
                            lute.Resource = CraftResource.Xormite;
                        }
                        else if (chances == 1 && Worlds.GetMyWorld(from.Map, from.Location, from.X, from.Y) == "the Underworld")
                        {
