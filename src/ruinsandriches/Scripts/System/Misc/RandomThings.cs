...
class RandomThings
{
    ...
    public static string MadeUpDungeon()
    {
        ...
        {
            case 0: sPlace = "Dungeon"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Dungeons";
                }
                break;
            case 1: sPlace = "Cave"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Caves";
                }
                break;
            case 2: sPlace = "Tomb"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Tombs";
                }
                break;
            case 3: sPlace = "Labyrinth"; break;
            case 4: sPlace = "Hall"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Halls";
                }
                break;
            case 5: sPlace = "Crypt"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Crypts";
                }
                break;
            ...
            case 9: sPlace = "Mountain"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Mountains";
                }
                break;
            case 10: sPlace = "Mausoleum"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Catacombs";
                }
                break;
            case 11: sPlace = "Tunnel"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Tunnels";
                }
                break;
            case 12: sPlace = "Maze"; break;
            case 13: sPlace = "Pit"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Pits";
                }
                break;
            case 14: sPlace = "Vault"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Vaults";
                }
                break;
            case 15: sPlace = "Cavern"; if (Utility.RandomMinMax(0, 1) == 1)
                {
                    sPlace = "Caverns";
                }
                break;
    ...
    public static string GetRandomScenePainting()
    {
        ...
        switch (Utility.RandomMinMax(1, 5))
        {
            ...
            case 5: sceneName = GetRandomCreature();        sceneFinal = "the " + sceneType + " of the " + sceneName + "";
                ...
                {
                    sceneFinal = "the " + sceneType + " of the " + GetRandomColorName(0) + " " + sceneName + "";
                }
                break;
        }
