...
public class RunebookGump : Gump
{
    ...
    {
        // Page Buttons
        int btn0 = 3609; if (m_Page == 1)
        {
            btn0 = 4017;
        }
        int btn1 = 3609; if (m_Page == 2)
        {
            btn1 = 4017;
        }
        int btn2 = 3609; if (m_Page == 3)
        {
            btn2 = 4017;
        }
        int btn3 = 3609; if (m_Page == 4)
        {
            btn3 = 4017;
        }
        int btn4 = 3609; if (m_Page == 5)
        {
            btn4 = 4017;
        }
        int btn5 = 3609; if (m_Page == 6)
        {
            btn5 = 4017;
        }
        int btn6 = 3609; if (m_Page == 7)
        {
            btn6 = 4017;
        }
        int btn7 = 3609; if (m_Page == 8)
        {
            btn7 = 4017;
        }
        int btn8 = 3609; if (m_Page == 9)
        {
            btn8 = 4017;
        }
        int btn9 = 3609; if (m_Page == 10)
        {
            btn9 = 4017;
        }
