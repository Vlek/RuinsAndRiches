...
public class ItemIdentification
{
    ...
    public static void IDScroll(Mobile from, int scrollType, int scrollLevel, Mobile vendor)
    {
        ...
        if (scrollType == 1 || scrollType == 2 || scrollType == 3 || scrollType == 7)
        {
            ...
            {
                from.AddToBackpack(new Elemental_Armor_Scroll()); paperName = ElementalSpell.CommonInfo(300, 5);
            }
            else if (paperType == 99)
            {
                from.AddToBackpack(new Elemental_Bolt_Scroll()); paperName = ElementalSpell.CommonInfo(301, 5);
            }
            else if (paperType == 100)
            {
                from.AddToBackpack(new Elemental_Mend_Scroll()); paperName = ElementalSpell.CommonInfo(302, 5);
            }
            else if (paperType == 101)
            {
                from.AddToBackpack(new Elemental_Sanctuary_Scroll()); paperName = ElementalSpell.CommonInfo(303, 5);
            }
            else if (paperType == 102)
            {
                from.AddToBackpack(new Elemental_Pain_Scroll()); paperName = ElementalSpell.CommonInfo(304, 5);
            }
            else if (paperType == 103)
            {
                from.AddToBackpack(new Elemental_Protection_Scroll()); paperName = ElementalSpell.CommonInfo(305, 5);
            }
            else if (paperType == 104)
            {
                from.AddToBackpack(new Elemental_Purge_Scroll()); paperName = ElementalSpell.CommonInfo(306, 5);
            }
            else if (paperType == 105)
            {
                from.AddToBackpack(new Elemental_Steed_Scroll()); paperName = ElementalSpell.CommonInfo(307, 5);
            }
            else if (paperType == 106)
            {
                from.AddToBackpack(new Elemental_Call_Scroll()); paperName = ElementalSpell.CommonInfo(308, 5);
            }
            else if (paperType == 107)
            {
                from.AddToBackpack(new Elemental_Force_Scroll()); paperName = ElementalSpell.CommonInfo(309, 5);
            }
            else if (paperType == 108)
            {
                from.AddToBackpack(new Elemental_Wall_Scroll()); paperName = ElementalSpell.CommonInfo(310, 5);
            }
            else if (paperType == 109)
            {
                from.AddToBackpack(new Elemental_Warp_Scroll()); paperName = ElementalSpell.CommonInfo(311, 5);
            }
            else if (paperType == 110)
            {
                from.AddToBackpack(new Elemental_Field_Scroll()); paperName = ElementalSpell.CommonInfo(312, 5);
            }
            else if (paperType == 111)
            {
                from.AddToBackpack(new Elemental_Restoration_Scroll()); paperName = ElementalSpell.CommonInfo(313, 5);
            }
            else if (paperType == 112)
            {
                from.AddToBackpack(new Elemental_Strike_Scroll()); paperName = ElementalSpell.CommonInfo(314, 5);
            }
            else if (paperType == 113)
            {
                from.AddToBackpack(new Elemental_Void_Scroll()); paperName = ElementalSpell.CommonInfo(315, 5);
            }
            else if (paperType == 114)
            {
                from.AddToBackpack(new Elemental_Blast_Scroll()); paperName = ElementalSpell.CommonInfo(316, 5);
            }
            else if (paperType == 115)
            {
                from.AddToBackpack(new Elemental_Echo_Scroll()); paperName = ElementalSpell.CommonInfo(317, 5);
            }
            else if (paperType == 116)
            {
                from.AddToBackpack(new Elemental_Fiend_Scroll()); paperName = ElementalSpell.CommonInfo(318, 5);
            }
            else if (paperType == 117)
            {
                from.AddToBackpack(new Elemental_Hold_Scroll()); paperName = ElementalSpell.CommonInfo(319, 5);
            }
            else if (paperType == 118)
            {
                from.AddToBackpack(new Elemental_Barrage_Scroll()); paperName = ElementalSpell.CommonInfo(320, 5);
            }
            else if (paperType == 119)
            {
                from.AddToBackpack(new Elemental_Rune_Scroll()); paperName = ElementalSpell.CommonInfo(321, 5);
            }
            else if (paperType == 120)
            {
                from.AddToBackpack(new Elemental_Storm_Scroll()); paperName = ElementalSpell.CommonInfo(322, 5);
            }
            else if (paperType == 121)
            {
                from.AddToBackpack(new Elemental_Summon_Scroll()); paperName = ElementalSpell.CommonInfo(323, 5);
            }
            else if (paperType == 122)
            {
                from.AddToBackpack(new Elemental_Devastation_Scroll()); paperName = ElementalSpell.CommonInfo(324, 5);
            }
            else if (paperType == 123)
            {
                from.AddToBackpack(new Elemental_Fall_Scroll()); paperName = ElementalSpell.CommonInfo(325, 5);
            }
            else if (paperType == 124)
            {
                from.AddToBackpack(new Elemental_Gate_Scroll()); paperName = ElementalSpell.CommonInfo(326, 5);
            }
            else if (paperType == 125)
            {
                from.AddToBackpack(new Elemental_Havoc_Scroll()); paperName = ElementalSpell.CommonInfo(327, 5);
            }
            else if (paperType == 126)
            {
                from.AddToBackpack(new Elemental_Apocalypse_Scroll()); paperName = ElementalSpell.CommonInfo(328, 5);
            }
            else if (paperType == 127)
            {
                from.AddToBackpack(new Elemental_Lord_Scroll()); paperName = ElementalSpell.CommonInfo(329, 5);
            }
            else if (paperType == 128)
            {
                from.AddToBackpack(new Elemental_Soul_Scroll()); paperName = ElementalSpell.CommonInfo(330, 5);
            }
            else if (paperType == 129)
            {
                from.AddToBackpack(new Elemental_Spirit_Scroll()); paperName = ElementalSpell.CommonInfo(331, 5);
            }
