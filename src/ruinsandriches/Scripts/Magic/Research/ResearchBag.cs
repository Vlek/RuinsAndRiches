...
public class ResearchBag : Item
{
    ...
    public override bool OnDragDrop(Mobile from, Item dropped)
    {
        if (dropped is BlankScroll)
        {
            ...
            else
            {
                ...
                if (need >= have)
                {
                    BagScrolls = BagScrolls + have; dropped.Delete();
                }
                else
                {
                    BagScrolls = 500; dropped.Amount = dropped.Amount - need;
                }
    ...
    public class ResearchGump : Gump
    {
        ...
        public ResearchGump(ResearchBag bag, Mobile from) : base(50, 50)
        {
            ...
            if ((m_Page < 10 || m_Page > 20) && Research.GetRunes(bag, 26))                           /////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            {
                ...
                {
                    button_top_menu = 3609; if (m_Page == 6 || (m_Page > 40 && m_Page < 50))
                    {
                        button_top_menu = 4011;
                    }
            ...
            if (m_Page == 1)                       // MAIN SCREEN /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            {
                ...
                if (bag.BagInk < 500)
                {
                    msg = "More octopus ink is rumored to be at " + bag.BagInkLocation + " in " + bag.BagInkWorld + ".";
                }
            ...
            if (m_Page == 2)                       // RUNES FOUND /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            {
                ...
                r++;    Rune = Research.RuneName(r, 1);       rune = Research.RuneName(r, 0);       icon = 11277; if (Research.GetRunes(bag, r))
                {
                    icon = Research.RuneIndex(rune, 1);
                }
                else if (next > 0)
                {
                    icon = 11278; next = 0; missing = Rune;
                }
                ...
                if (missing != "")
                {
                    msg = "The Cube of " + missing + " is said to be in " + bag.RuneLocation + " in " + bag.RuneWorld + ".";
                }
            ...
            if (m_Page == 3 || (m_Page > 20 && m_Page < 30))                         // MAGERY RESEARCH
            {
                ...
                int mcircleIcon = 3609; if (m_Page == 21 || m_Page == 3)
                {
                    mcircleIcon = 4017;
                }
                ...
                if (m_Page == 22)
                {
                    spellName = 9; spellCircle = "second";
                }
                else if (m_Page == 23)
                {
                    spellName = 17; spellCircle = "third";
                }
                else if (m_Page == 24)
                {
                    spellName = 25; spellCircle = "fourth";
                }
                else if (m_Page == 25)
                {
                    spellName = 33; spellCircle = "fifth";
                }
                else if (m_Page == 26)
                {
                    spellName = 41; spellCircle = "sixth";
                }
                else if (m_Page == 27)
                {
                    spellName = 49; spellCircle = "seventh";
                }
                else if (m_Page == 28)
                {
                    spellName = 57; spellCircle = "eighth";
                }
            ...
            if (m_Page == 5 || (m_Page > 30 && m_Page < 40))                         // ANCIENT RESEARCH //////////////////////////////////////////////////////////////////////////////////////////////////////////////
            {
                ...
                int mcircleIcon = 3609; if (m_Page == 31 || m_Page == 5)
                {
                    mcircleIcon = 4017;
                }
                ...
                if (m_Page == 32)
                {
                    spellName = 2; spellCircle = "death";
                }
                else if (m_Page == 33)
                {
                    spellName = 3; spellCircle = "enchanting";
                }
                else if (m_Page == 34)
                {
                    spellName = 4; spellCircle = "sorcery";
                }
                else if (m_Page == 35)
                {
                    spellName = 5; spellCircle = "summoning";
                }
                else if (m_Page == 36)
                {
                    spellName = 6; spellCircle = "thaumaturgy";
                }
                else if (m_Page == 37)
                {
                    spellName = 7; spellCircle = "theurgy";
                }
                else if (m_Page == 38)
                {
                    spellName = 8; spellCircle = "wizardry";
                }
            ...
            if (m_Page == 6 || (m_Page > 40 && m_Page < 50))                         // ANCIENT PREPARED SPELLS ///////////////////////////////////////////////////////////////////////////////////////////////////////
            {
                ...
                int mcircleIcon = 3609; if (m_Page == 41 || m_Page == 6)
                {
                    mcircleIcon = 4017;
                }
                ...
                if (Research.GetResearch(bag, spellName))
                {
                    PrepareColor = "" + color + ""; IsPrepared = Research.GetPrepared(bag, spellName); if (IsPrepared > 10)
                    {
                        PrepareColor = "#15E650";
                    }
        ...
        public override void OnResponse(NetState state, RelayInfo info)
        {
            ...
            else if (info.ButtonID > 1200)
            {
                ...
                {
                    from.CloseGump(typeof(SetupBarsResearch1)); from.SendGump(new SetupBarsResearch1(from, 1));
                }
                else if (info.ButtonID == 1202)
                {
                    from.CloseGump(typeof(SetupBarsResearch2)); from.SendGump(new SetupBarsResearch2(from, 1));
                }
                else if (info.ButtonID == 1203)
                {
                    from.CloseGump(typeof(SetupBarsResearch3)); from.SendGump(new SetupBarsResearch3(from, 1));
                }
                else if (info.ButtonID == 1204)
                {
                    from.CloseGump(typeof(SetupBarsResearch4)); from.SendGump(new SetupBarsResearch4(from, 1));
                }
    ...
    public Mobile Bag_Owner {
        get { return BagOwner; } set { BagOwner = value; }
    }

    public int BagInk;
    [CommandProperty(AccessLevel.Owner)]
    public int Bag_Ink {
        get { return BagInk; } set { BagInk = value; InvalidateProperties(); }
    }

    public int BagScrolls;
    [CommandProperty(AccessLevel.Owner)]
    public int Bag_Scrolls {
        get { return BagScrolls; } set { BagScrolls = value; InvalidateProperties(); }
    }

    public int BagQuills;
    [CommandProperty(AccessLevel.Owner)]
    public int Bag_Quills {
        get { return BagQuills; } set { BagQuills = value; InvalidateProperties(); }
    }

    public int BagPage;
    [CommandProperty(AccessLevel.Owner)]
    public int Bag_Page {
        get { return BagPage; } set { BagPage = value; InvalidateProperties(); }
    }

    public string BagInkLocation;
    [CommandProperty(AccessLevel.Owner)]
    public string Bag_InkLocation {
        get { return BagInkLocation; } set { BagInkLocation = value; InvalidateProperties(); }
    }

    public string BagInkWorld;
    [CommandProperty(AccessLevel.Owner)]
    public string Bag_InkWorld {
        get { return BagInkWorld; } set { BagInkWorld = value; InvalidateProperties(); }
    }

    public int BagMessage;
    [CommandProperty(AccessLevel.Owner)]
    public int Bag_Message {
        get { return BagMessage; } set { BagMessage = value; InvalidateProperties(); }
    }

    public string BagMsgString;
    [CommandProperty(AccessLevel.Owner)]
    public string Bag_MsgString {
        get { return BagMsgString; } set { BagMsgString = value; InvalidateProperties(); }
    }
    ...
    public string Spells_Magery {
        get { return SpellsMagery; } set { SpellsMagery = value; InvalidateProperties(); }
    }

    public string SpellsMageLocation;
    [CommandProperty(AccessLevel.Owner)]
    public string Spells_MageLocation {
        get { return SpellsMageLocation; } set { SpellsMageLocation = value; InvalidateProperties(); }
    }

    public string SpellsMageWorld;
    [CommandProperty(AccessLevel.Owner)]
    public string Spells_MageWorld {
        get { return SpellsMageWorld; } set { SpellsMageWorld = value; InvalidateProperties(); }
    }

    public string SpellsMageItem;
    [CommandProperty(AccessLevel.Owner)]
    public string Spells_MageItem {
        get { return SpellsMageItem; } set { SpellsMageItem = value; InvalidateProperties(); }
    }

    public string SpellsNecromancy;
    [CommandProperty(AccessLevel.Owner)]
    public string Spells_Necromancy {
        get { return SpellsNecromancy; } set { SpellsNecromancy = value; InvalidateProperties(); }
    }

    public string SpellsNecroLocation;
    [CommandProperty(AccessLevel.Owner)]
    public string Spells_NecroLocation {
        get { return SpellsNecroLocation; } set { SpellsNecroLocation = value; InvalidateProperties(); }
    }

    public string SpellsNecroWorld;
    [CommandProperty(AccessLevel.Owner)]
    public string Spells_NecroWorld {
        get { return SpellsNecroWorld; } set { SpellsNecroWorld = value; InvalidateProperties(); }
    }

    public string SpellsNecroItem;
    [CommandProperty(AccessLevel.Owner)]
    public string Spells_NecroItem {
        get { return SpellsNecroItem; } set { SpellsNecroItem = value; InvalidateProperties(); }
    }
    ...
    public string Rune_Found {
        get { return RuneFound; } set { RuneFound = value; InvalidateProperties(); }
    }

    public string RuneLocation;
    [CommandProperty(AccessLevel.Owner)]
    public string Rune_Location {
        get { return RuneLocation; } set { RuneLocation = value; InvalidateProperties(); }
    }

    public string RuneWorld;
    [CommandProperty(AccessLevel.Owner)]
    public string Rune_World {
        get { return RuneWorld; } set { RuneWorld = value; InvalidateProperties(); }
    }
    ...
    public string Research_Spells {
        get { return ResearchSpells; } set { ResearchSpells = value; InvalidateProperties(); }
    }

    public string ResearchLocation;
    [CommandProperty(AccessLevel.Owner)]
    public string Research_Location {
        get { return ResearchLocation; } set { ResearchLocation = value; InvalidateProperties(); }
    }

    public string ResearchWorld;
    [CommandProperty(AccessLevel.Owner)]
    public string Research_World {
        get { return ResearchWorld; } set { ResearchWorld = value; InvalidateProperties(); }
    }

    public string ResearchItem;
    [CommandProperty(AccessLevel.Owner)]
    public string Research_Item {
        get { return ResearchItem; } set { ResearchItem = value; InvalidateProperties(); }
    }

    public string ResearchPrep1;
    [CommandProperty(AccessLevel.Owner)]
    public string Research_Prep1 {
        get { return ResearchPrep1; } set { ResearchPrep1 = value; InvalidateProperties(); }
    }

    public string ResearchPrep2;
    [CommandProperty(AccessLevel.Owner)]
    public string Research_Prep2 {
        get { return ResearchPrep2; } set { ResearchPrep2 = value; InvalidateProperties(); }
    }
    ...
    public string Bars_Cast1 {
        get { return BarsCast1; } set { BarsCast1 = value; InvalidateProperties(); }
    }

    public string BarsCast2;
    [CommandProperty(AccessLevel.GameMaster)]
    public string Bars_Cast2 {
        get { return BarsCast2; } set { BarsCast2 = value; InvalidateProperties(); }
    }

    public string BarsCast3;
    [CommandProperty(AccessLevel.GameMaster)]
    public string Bars_Cast3 {
        get { return BarsCast3; } set { BarsCast3 = value; InvalidateProperties(); }
    }

    public string BarsCast4;
    [CommandProperty(AccessLevel.GameMaster)]
    public string Bars_Cast4 {
        get { return BarsCast4; } set { BarsCast4 = value; InvalidateProperties(); }
    }
