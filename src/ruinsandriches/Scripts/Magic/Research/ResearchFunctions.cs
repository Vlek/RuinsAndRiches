...
class Research
{
    ...
    public static void FindLocation(Mobile m, int level, string category, ResearchBag bag)               ////////////////////////////////////////////////////
    {
        ...
        {
            sBook = Server.Misc.RandomThings.GetRandomBelongsTo("regular") + sEvil + " Spellbook";
        }
        if (sBook.Contains("  "))
        {
            sBook = sBook.Replace("  ", " ");
    ...
    public static void SetRunes(ResearchBag bag, Mobile from)               /////////////////////////////////////////////////////////////////////////////////
    {
        ...
        if (found.Length > 0)
        {
            ...
            foreach (string rune in runes)
            {
                if (rune == "0" && !updated)
                {
                    got = got + "1#"; cube = entry; updated = true;
                }
                else if (rune == "")
                {
                    got = got + "0#";
    ...
    public static void SetInk(ResearchBag bag, Mobile from)               //////////////////////////////////////////////////////////////////////////////
    {
        ...
        int level = GetMaxCircleResearched(bag) - 1; if (level < 0)
        {
            level = 0;
        }
    ...
    public static string SpellInformation(int index, int slice)               ///////////////////////////////////////////////////////////////////////////////
    {
        ...
        {
            circle = "4"; name = "Create Gold"; school = "Conjuration"; words = "rel ylem"; reagents = "Unicorn Horn, Sea Salt, Ginseng, Golden Serpent Venom"; mana = "35"; skill = "55";
        ...
        {
            circle = "5"; name = "Call Destruction"; school = "Thaumaturgy"; words = "kal vas grav por"; reagents = "Bat Wing, Black Pearl, Brimstone, Pig Iron"; mana = "25"; skill = "40";
        ...
        {
            circle = "7"; name = "Open Ground"; school = "Death"; words = "des por ylem"; reagents = "Brimstone, Grave Dust, Pig Iron, Mandrake Root"; mana = "65"; skill = "85";
        ...
        {
            circle = "8"; name = "Withstand Death"; school = "Death"; words = "vas an corp"; reagents = "Phoenix Feather, Demigod Blood, Enchanted Seaweed, Ghostly Dust"; mana = "70"; skill = "90";
        ...
        {
            circle = "8"; name = "Armageddon"; school = "Thaumaturgy"; words = "in vas ort corp"; reagents = "Butterfly Wings, Black Pearl, Demigod Blood, Demon Claw"; mana = "80"; skill = "100";
        ...
        {
            circle = "8"; name = "Mass Death"; school = "Wizardry"; words = "vas corp"; reagents = "Pixie Skull, Bat Wing, Dragon Tooth"; mana = "55"; skill = "90";
    ...
    public static string ScrollInformation(int index, int slice)               //////////////////////////////////////////////////////////////////////////////
    {
        ...
        if (index == 1)
        {
            name = "Clumsy"; circle = "1"; reagents = "Garlic, Spiders Silk, Sulfurous Ash"; mana = "8"; skill = "30";
        }
        else if (index == 2)
        {
            name = "Create Food"; circle = "1"; reagents = "Bloodmoss, Nightshade"; mana = "8"; skill = "30";
        }
        else if (index == 3)
        {
            name = "Feeblemind"; circle = "1"; reagents = "Garlic, Ginseng, Mandrake Root"; mana = "8"; skill = "30";
        }
        else if (index == 4)
        {
            name = "Heal"; circle = "1"; reagents = "Nightshade, Ginseng"; mana = "8"; skill = "30";
        }
        else if (index == 5)
        {
            name = "Magic Arrow"; circle = "1"; reagents = "Garlic, Ginseng, Spiders Silk"; mana = "8"; skill = "30";
        }
        else if (index == 6)
        {
            name = "Night Sight"; circle = "1"; reagents = "Sulfurous Ash"; mana = "8"; skill = "30";
        }
        else if (index == 7)
        {
            name = "Reactive Armor"; circle = "1"; reagents = "Spiders Silk, Sulfurous Ash"; mana = "8"; skill = "30";
        }
        else if (index == 8)
        {
            name = "Weaken"; circle = "1"; reagents = "Garlic, Nightshade"; mana = "8"; skill = "30";
        }
        else if (index == 9)
        {
            name = "Agility"; circle = "2"; reagents = "Bloodmoss, Mandrake Root"; mana = "16"; skill = "40";
        }
        else if (index == 10)
        {
            name = "Cunning"; circle = "2"; reagents = "Nightshade, Mandrake Root"; mana = "16"; skill = "40";
        }
        else if (index == 11)
        {
            name = "Cure"; circle = "2"; reagents = "Garlic, Ginseng"; mana = "16"; skill = "40";
        }
        else if (index == 12)
        {
            name = "Harm"; circle = "2"; reagents = "Nightshade, Spiders Silk"; mana = "16"; skill = "40";
        }
        else if (index == 13)
        {
            name = "Magic Trap"; circle = "2"; reagents = "Garlic, Spiders Silk, Sulfurous Ash"; mana = "16"; skill = "40";
        }
        else if (index == 14)
        {
            name = "Remove Trap"; circle = "2"; reagents = "Bloodmoss, Sulfurous Ash"; mana = "16"; skill = "40";
        }
        else if (index == 15)
        {
            name = "Protection"; circle = "2"; reagents = "Garlic, Ginseng, Sulfurous Ash"; mana = "16"; skill = "40";
        }
        else if (index == 16)
        {
            name = "Strength"; circle = "2"; reagents = "Nightshade, Mandrake Root"; mana = "16"; skill = "40";
        }
        else if (index == 17)
        {
            name = "Bless"; circle = "3"; reagents = "Garlic, Mandrake Root"; mana = "24"; skill = "50";
        }
        else if (index == 18)
        {
            name = "Fireball"; circle = "3"; reagents = "Black Pearl"; mana = "24"; skill = "50";
        }
        else if (index == 19)
        {
            name = "Magic Lock"; circle = "3"; reagents = "Bloodmoss, Garlic, Sulfurous Ash"; mana = "24"; skill = "50";
        }
        else if (index == 20)
        {
            name = "Poison"; circle = "3"; reagents = "Nightshade"; mana = "24"; skill = "50";
        }
        else if (index == 21)
        {
            name = "Telekinesis"; circle = "3"; reagents = "Bloodmoss, Mandrake Root"; mana = "24"; skill = "50";
        }
        else if (index == 22)
        {
            name = "Teleport"; circle = "3"; reagents = "Bloodmoss, Mandrake Root"; mana = "24"; skill = "50";
        }
        else if (index == 23)
        {
            name = "Unlock"; circle = "3"; reagents = "Bloodmoss, Sulfurous Ash"; mana = "24"; skill = "50";
        }
        else if (index == 24)
        {
            name = "Wall of Stone"; circle = "3"; reagents = "Bloodmoss, Garlic"; mana = "24"; skill = "50";
        }
        else if (index == 25)
        {
            name = "Arch Cure"; circle = "4"; reagents = "Garlic, Ginseng, Mandrake Root"; mana = "32"; skill = "60";
        }
        else if (index == 26)
        {
            name = "Arch Protection"; circle = "4"; reagents = "Garlic, Ginseng, Mandrake Root, Sulfurous Ash"; mana = "32"; skill = "60";
        }
        else if (index == 27)
        {
            name = "Curse"; circle = "4"; reagents = "Garlic, Nightshade, Sulfurous Ash"; mana = "32"; skill = "60";
        }
        else if (index == 28)
        {
            name = "Fire Field"; circle = "4"; reagents = "Black Pearl, Spiders Silk, Sulfurous Ash"; mana = "32"; skill = "60";
        }
        else if (index == 29)
        {
            name = "Greater Heal"; circle = "4"; reagents = "Garlic, Spiders Silk, Mandrake Root, Ginseng"; mana = "32"; skill = "60";
        }
        else if (index == 30)
        {
            name = "Lightning"; circle = "4"; reagents = "Mandrake Root, Sulfurous Ash"; mana = "32"; skill = "60";
        }
        else if (index == 31)
        {
            name = "Mana Drain"; circle = "4"; reagents = "Black Pearl, Spiders Silk, Mandrake Root"; mana = "32"; skill = "60";
        }
        else if (index == 32)
        {
            name = "Recall"; circle = "4"; reagents = "Black Pearl, Bloodmoss, Mandrake Root"; mana = "32"; skill = "60";
        }
        else if (index == 33)
        {
            name = "Blade Spirits"; circle = "5"; reagents = "Black Pearl, Nightshade, Mandrake Root"; mana = "40"; skill = "70";
        }
        else if (index == 34)
        {
            name = "Dispel Field"; circle = "5"; reagents = "Black Pearl, Garlic, Spiders Silk, Sulfurous Ash"; mana = "40"; skill = "70";
        }
        else if (index == 35)
        {
            name = "Incognito"; circle = "5"; reagents = "Bloodmoss, Garlic, Nightshade"; mana = "40"; skill = "70";
        }
        else if (index == 36)
        {
            name = "Magic Reflect"; circle = "5"; reagents = "Garlic, Mandrake Root, Spiders Silk"; mana = "40"; skill = "70";
        }
        else if (index == 37)
        {
            name = "Mind Blast"; circle = "5"; reagents = "Black Pearl, Mandrake Root, Nightshade, Sulfurous Ash"; mana = "40"; skill = "70";
        }
        else if (index == 38)
        {
            name = "Paralyze"; circle = "5"; reagents = "Garlic, Mandrake Root, Spiders Silk"; mana = "40"; skill = "70";
        }
        else if (index == 39)
        {
            name = "Poison Field"; circle = "5"; reagents = "Black Pearl, Nightshade, Spiders Silk"; mana = "40"; skill = "70";
        }
        else if (index == 40)
        {
            name = "Summon Creature"; circle = "5"; reagents = "Bloodmoss, Mandrake Root, Spiders Silk"; mana = "40"; skill = "70";
        }
        else if (index == 41)
        {
            name = "Dispel"; circle = "6"; reagents = "Garlic, Mandrake Root, Sulfurous Ash"; mana = "48"; skill = "80";
        }
        else if (index == 42)
        {
            name = "Energy Bolt"; circle = "6"; reagents = "Black Pearl, Nightshade"; mana = "48"; skill = "80";
        }
        else if (index == 43)
        {
            name = "Explosion"; circle = "6"; reagents = "Bloodmoss, Mandrake Root"; mana = "48"; skill = "80";
        }
        else if (index == 44)
        {
            name = "Invisibility"; circle = "6"; reagents = "Bloodmoss, Nightshade"; mana = "48"; skill = "80";
        }
        else if (index == 45)
        {
            name = "Mark"; circle = "6"; reagents = "Bloodmoss, Black Pearl, Mandrake Root"; mana = "48"; skill = "80";
        }
        else if (index == 46)
        {
            name = "Mass Curse"; circle = "6"; reagents = "Garlic, Mandrake Root, Nightshade, Sulfurous Ash"; mana = "48"; skill = "80";
        }
        else if (index == 47)
        {
            name = "Paralyze Field"; circle = "6"; reagents = "Black Pearl, Ginseng, Spiders Silk"; mana = "48"; skill = "80";
        }
        else if (index == 48)
        {
            name = "Reveal"; circle = "6"; reagents = "Bloodmoss, Sulfurous Ash"; mana = "48"; skill = "80";
        }
        else if (index == 49)
        {
            name = "Chain Lightning"; circle = "7"; reagents = "Black Pearl, Bloodmoss, Mandrake Root, Sulfurous Ash"; mana = "56"; skill = "90";
        }
        else if (index == 50)
        {
            name = "Energy Field"; circle = "7"; reagents = "Black Pearl, Mandrake Root, Spiders Silk, Sulfurous Ash"; mana = "56"; skill = "90";
        }
        else if (index == 51)
        {
            name = "Flame Strike"; circle = "7"; reagents = "Spiders Silk, Sulfurous Ash"; mana = "56"; skill = "90";
        }
        else if (index == 52)
        {
            name = "Gate Travel"; circle = "7"; reagents = "Black Pearl, Mandrake Root, Sulfurous Ash"; mana = "56"; skill = "90";
        }
        else if (index == 53)
        {
            name = "Mana Vampire"; circle = "7"; reagents = "Black Pearl, Bloodmoss, Mandrake Root, Spiders Silk"; mana = "56"; skill = "90";
        }
        else if (index == 54)
        {
            name = "Mass Dispel"; circle = "7"; reagents = "Black Pearl, Garlic, Mandrake Root, Sulfurous Ash"; mana = "56"; skill = "90";
        }
        else if (index == 55)
        {
            name = "Meteor Swarm"; circle = "7"; reagents = "Bloodmoss, Mandrake Root, Sulfurous Ash, Spiders Silk"; mana = "56"; skill = "90";
        }
        else if (index == 56)
        {
            name = "Polymorph"; circle = "7"; reagents = "Bloodmoss, Mandrake Root, Spiders Silk"; mana = "56"; skill = "90";
        }
        else if (index == 57)
        {
            name = "Earthquake"; circle = "8"; reagents = "Bloodmoss, Mandrake Root, Ginseng, Sulfurous Ash"; mana = "64"; skill = "100";
        }
        else if (index == 58)
        {
            name = "Energy Vortex"; circle = "8"; reagents = "Black Pearl, Bloodmoss, Mandrake Root, Nightshade"; mana = "64"; skill = "100";
        }
        else if (index == 59)
        {
            cliloc = "1061348"; name = "Resurrection"; circle = "8"; reagents = "Bloodmoss, Garlic, Ginseng"; mana = "64"; skill = "100";
        }
        else if (index == 60)
        {
            cliloc = "1061349"; name = "Air Elemental"; circle = "8"; reagents = "Bloodmoss, Mandrake Root, Spiders Silk"; mana = "64"; skill = "100";
        }
        else if (index == 61)
        {
            cliloc = "1061350"; name = "Summon Daemon"; circle = "8"; reagents = "Bloodmoss, Mandrake Root, Spiders Silk, Sulfurous Ash"; mana = "64"; skill = "100";
        }
        else if (index == 62)
        {
            cliloc = "1061351"; name = "Earth Elemental"; circle = "8"; reagents = "Bloodmoss, Mandrake Root, Spiders Silk"; mana = "64"; skill = "100";
        }
        else if (index == 63)
        {
            cliloc = "1061352"; name = "Fire Elemental"; circle = "8"; reagents = "Bloodmoss, Mandrake Root, Spiders Silk, Sulfurous Ash"; mana = "64"; skill = "100";
        }
        else if (index == 64)
        {
            cliloc = "1061353"; name = "Water Elemental"; circle = "8"; reagents = "Bloodmoss, Mandrake Root, Spiders Silk"; mana = "64"; skill = "100";
        }
        else if (index == 65)
        {
            cliloc = "1061391"; name = "Blood Oath"; circle = "1"; reagents = "Daemon Blood"; mana = "20"; skill = "30";
        }
        else if (index == 66)
        {
            cliloc = "1061392"; name = "Corpse Skin"; circle = "1"; reagents = "Bat Wing, Grave Dust"; mana = "17"; skill = "30";
        }
        else if (index == 67)
        {
            cliloc = "1061393"; name = "Curse Weapon"; circle = "1"; reagents = "Pig Iron"; mana = "11"; skill = "30";
        }
        else if (index == 68)
        {
            cliloc = "1061394"; name = "Evil Omen"; circle = "1"; reagents = "Bat Wing, Nox Crystal"; mana = "17"; skill = "30";
        }
        else if (index == 69)
        {
            cliloc = "1061398"; name = "Pain Spike"; circle = "1"; reagents = "Grave Dust, Pig Iron"; mana = "8"; skill = "30";
        }
        else if (index == 70)
        {
            cliloc = "1061397"; name = "Mind Rot"; circle = "2"; reagents = "Bat Wing, Daemon Blood, Pig Iron"; mana = "26"; skill = "45";
        }
        else if (index == 71)
        {
            cliloc = "1061401"; name = "Summon Familiar"; circle = "2"; reagents = "Bat Wing, Grave Dust, Daemon Blood"; mana = "26"; skill = "45";
        }
        else if (index == 72)
        {
            cliloc = "1061390"; name = "Animate Dead"; circle = "3"; reagents = "Grave Dust, Daemon Blood"; mana = "35"; skill = "55";
        }
        else if (index == 73)
        {
            cliloc = "1061395"; name = "Horrific Beast"; circle = "3"; reagents = "Bat Wing, Daemon Blood"; mana = "17"; skill = "55";
        }
        else if (index == 74)
        {
            cliloc = "1061399"; name = "Poison Strike"; circle = "4"; reagents = "Nox Crystal"; mana = "26"; skill = "65";
        }
        else if (index == 75)
        {
            cliloc = "1061404"; name = "Wither"; circle = "5"; reagents = "Grave Dust, Nox Crystal, Pig Iron"; mana = "35"; skill = "75";
        }
        else if (index == 76)
        {
            cliloc = "1061396"; name = "Lich Form"; circle = "6"; reagents = "Grave Dust, Daemon Blood, Nox Crystal"; mana = "35"; skill = "85";
        }
        else if (index == 77)
        {
            cliloc = "1061400"; name = "Strangle"; circle = "6"; reagents = "Daemon Blood, Nox Crystal"; mana = "44"; skill = "85";
        }
        else if (index == 78)
        {
            cliloc = "1061406"; name = "Exorcism"; circle = "7"; reagents = "Nox Crystal, Grave Dust"; mana = "60"; skill = "95";
        }
        else if (index == 79)
        {
            cliloc = "1061403"; name = "Vengeful Spirit"; circle = "7"; reagents = "Bat Wing, Grave Dust, Pig Iron"; mana = "62"; skill = "95";
        }
        else if (index == 80)
        {
            cliloc = "1061405"; name = "Wraith Form"; circle = "7"; reagents = "Nox Crystal, Pig Iron"; mana = "26"; skill = "95";
        }
        else if (index == 81)
        {
            cliloc = "1061402"; name = "Vampiric Embrace"; circle = "8"; reagents = "Bat Wing, Nox Crystal, Pig Iron"; mana = "35"; skill = "100";
        }
    ...
    public static bool CheckReagents(Mobile from, int spell, bool deplete, bool ancient, int qty)               ////////////////////////////////////////////////////////////////////
    {
        ...
        if (reagents.Length > 0)
        {
            ...
            foreach (string reg in regs)
            {
                if (deplete)
                {
                    if (reg == "Bat Wing" && from.Backpack.FindItemByType(typeof(BatWing)) != null)
                    {
                        pack.ConsumeTotal(typeof(BatWing), qty);
                    }
                    else if (reg == "Black Pearl" && from.Backpack.FindItemByType(typeof(BlackPearl)) != null)
                    {
                        pack.ConsumeTotal(typeof(BlackPearl), qty);
                    }
                    else if (reg == "Bloodmoss" && from.Backpack.FindItemByType(typeof(Bloodmoss)) != null)
                    {
                        pack.ConsumeTotal(typeof(Bloodmoss), qty);
                    }
                    else if (reg == "Daemon Blood" && from.Backpack.FindItemByType(typeof(DaemonBlood)) != null)
                    {
                        pack.ConsumeTotal(typeof(DaemonBlood), qty);
                    }
                    else if (reg == "Garlic" && from.Backpack.FindItemByType(typeof(Garlic)) != null)
                    {
                        pack.ConsumeTotal(typeof(Garlic), qty);
                    }
                    else if (reg == "Ginseng" && from.Backpack.FindItemByType(typeof(Ginseng)) != null)
                    {
                        pack.ConsumeTotal(typeof(Ginseng), qty);
                    }
                    else if (reg == "Grave Dust" && from.Backpack.FindItemByType(typeof(GraveDust)) != null)
                    {
                        pack.ConsumeTotal(typeof(GraveDust), qty);
                    }
                    else if (reg == "Mandrake Root" && from.Backpack.FindItemByType(typeof(MandrakeRoot)) != null)
                    {
                        pack.ConsumeTotal(typeof(MandrakeRoot), qty);
                    }
                    else if (reg == "Nightshade" && from.Backpack.FindItemByType(typeof(Nightshade)) != null)
                    {
                        pack.ConsumeTotal(typeof(Nightshade), qty);
                    }
                    else if (reg == "Nox Crystal" && from.Backpack.FindItemByType(typeof(NoxCrystal)) != null)
                    {
                        pack.ConsumeTotal(typeof(NoxCrystal), qty);
                    }
                    else if (reg == "Pig Iron" && from.Backpack.FindItemByType(typeof(PigIron)) != null)
                    {
                        pack.ConsumeTotal(typeof(PigIron), qty);
                    }
                    else if (reg == "Spiders Silk" && from.Backpack.FindItemByType(typeof(SpidersSilk)) != null)
                    {
                        pack.ConsumeTotal(typeof(SpidersSilk), qty);
                    }
                    else if (reg == "Sulfurous Ash" && from.Backpack.FindItemByType(typeof(SulfurousAsh)) != null)
                    {
                        pack.ConsumeTotal(typeof(SulfurousAsh), qty);
                    }
                    else if (reg == "Silver Serpent Venom" && from.Backpack.FindItemByType(typeof(SilverSerpentVenom)) != null)
                    {
                        pack.ConsumeTotal(typeof(SilverSerpentVenom), qty);
                    }
                    else if (reg == "Dragon Blood" && from.Backpack.FindItemByType(typeof(DragonBlood)) != null)
                    {
                        pack.ConsumeTotal(typeof(DragonBlood), qty);
                    }
                    else if (reg == "Enchanted Seaweed" && from.Backpack.FindItemByType(typeof(EnchantedSeaweed)) != null)
                    {
                        pack.ConsumeTotal(typeof(EnchantedSeaweed), qty);
                    }
                    else if (reg == "Dragon Tooth" && from.Backpack.FindItemByType(typeof(DragonTooth)) != null)
                    {
                        pack.ConsumeTotal(typeof(DragonTooth), qty);
                    }
                    else if (reg == "Golden Serpent Venom" && from.Backpack.FindItemByType(typeof(GoldenSerpentVenom)) != null)
                    {
                        pack.ConsumeTotal(typeof(GoldenSerpentVenom), qty);
                    }
                    else if (reg == "Lich Dust" && from.Backpack.FindItemByType(typeof(LichDust)) != null)
                    {
                        pack.ConsumeTotal(typeof(LichDust), qty);
                    }
                    else if (reg == "Demon Claw" && from.Backpack.FindItemByType(typeof(DemonClaw)) != null)
                    {
                        pack.ConsumeTotal(typeof(DemonClaw), qty);
                    }
                    else if (reg == "Pegasus Feather" && from.Backpack.FindItemByType(typeof(PegasusFeather)) != null)
                    {
                        pack.ConsumeTotal(typeof(PegasusFeather), qty);
                    }
                    else if (reg == "Phoenix Feather" && from.Backpack.FindItemByType(typeof(PhoenixFeather)) != null)
                    {
                        pack.ConsumeTotal(typeof(PhoenixFeather), qty);
                    }
                    else if (reg == "Unicorn Horn" && from.Backpack.FindItemByType(typeof(UnicornHorn)) != null)
                    {
                        pack.ConsumeTotal(typeof(UnicornHorn), qty);
                    }
                    else if (reg == "Demigod Blood" && from.Backpack.FindItemByType(typeof(DemigodBlood)) != null)
                    {
                        pack.ConsumeTotal(typeof(DemigodBlood), qty);
                    }
                    else if (reg == "Ghostly Dust" && from.Backpack.FindItemByType(typeof(GhostlyDust)) != null)
                    {
                        pack.ConsumeTotal(typeof(GhostlyDust), qty);
                    }
                    else if (reg == "Eye of Toad" && from.Backpack.FindItemByType(typeof(EyeOfToad)) != null)
                    {
                        pack.ConsumeTotal(typeof(EyeOfToad), qty);
                    }
                    else if (reg == "Fairy Egg" && from.Backpack.FindItemByType(typeof(FairyEgg)) != null)
                    {
                        pack.ConsumeTotal(typeof(FairyEgg), qty);
                    }
                    else if (reg == "Gargoyle Ear" && from.Backpack.FindItemByType(typeof(GargoyleEar)) != null)
                    {
                        pack.ConsumeTotal(typeof(GargoyleEar), qty);
                    }
                    else if (reg == "Beetle Shell" && from.Backpack.FindItemByType(typeof(BeetleShell)) != null)
                    {
                        pack.ConsumeTotal(typeof(BeetleShell), qty);
                    }
                    else if (reg == "Moon Crystal" && from.Backpack.FindItemByType(typeof(MoonCrystal)) != null)
                    {
                        pack.ConsumeTotal(typeof(MoonCrystal), qty);
                    }
                    else if (reg == "Pixie Skull" && from.Backpack.FindItemByType(typeof(PixieSkull)) != null)
                    {
                        pack.ConsumeTotal(typeof(PixieSkull), qty);
                    }
                    else if (reg == "Red Lotus" && from.Backpack.FindItemByType(typeof(RedLotus)) != null)
                    {
                        pack.ConsumeTotal(typeof(RedLotus), qty);
                    }
                    else if (reg == "Sea Salt" && from.Backpack.FindItemByType(typeof(SeaSalt)) != null)
                    {
                        pack.ConsumeTotal(typeof(SeaSalt), qty);
                    }
                    else if (reg == "Silver Widow" && from.Backpack.FindItemByType(typeof(SilverWidow)) != null)
                    {
                        pack.ConsumeTotal(typeof(SilverWidow), qty);
                    }
                    else if (reg == "Swamp Berries" && from.Backpack.FindItemByType(typeof(SwampBerries)) != null)
                    {
                        pack.ConsumeTotal(typeof(SwampBerries), qty);
                    }
                    else if (reg == "Brimstone" && from.Backpack.FindItemByType(typeof(Brimstone)) != null)
                    {
                        pack.ConsumeTotal(typeof(Brimstone), qty);
                    }
                    else if (reg == "Butterfly Wings" && from.Backpack.FindItemByType(typeof(ButterflyWings)) != null)
                    {
                ...
                else
                {
                    ...
                    else if (reg == "Mandrake Root" && RegCount(from, typeof(MandrakeRoot)) < qty)
                    {
                        HaveReagents = false;
                    }
                    ...
                    else if (reg == "Sulfurous Ash" && RegCount(from, typeof(SulfurousAsh)) < qty)
                    {
                        HaveReagents = false;
                    }
                    else if (reg == "Silver Serpent Venom" && RegCount(from, typeof(SilverSerpentVenom)) < qty)
                    {
                        HaveReagents = false;
                    }
                    ...
                    else if (reg == "Enchanted Seaweed" && RegCount(from, typeof(EnchantedSeaweed)) < qty)
                    {
                        HaveReagents = false;
                    }
                    ...
                    else if (reg == "Golden Serpent Venom" && RegCount(from, typeof(GoldenSerpentVenom)) < qty)
                    {
                        HaveReagents = false;
                    }
                    ...
                    else if (reg == "Demigod Blood" && RegCount(from, typeof(DemigodBlood)) < qty)
                    {
                        HaveReagents = false;
                    }
                    ...
                    else if (reg == "Swamp Berries" && RegCount(from, typeof(SwampBerries)) < qty)
                    {
                        HaveReagents = false;
                    }
                    ...
                    else if (reg == "Butterfly Wings" && RegCount(from, typeof(ButterflyWings)) < qty)
                    {
                        HaveReagents = false;
                    }
                }
    ...
    public static void CreateNormalSpell(ResearchBag bag, Mobile from, int spell)               /////////////////////////////////////////////////////////////
    {
        ...
        else if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(skill - 25, skill + 25) && canMake)
        {
            ...
            if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(0, 125))
            {
                bag.BagInk = bag.BagInk - 1; if (bag.BagInk < 1)
                {
                    bag.BagInk = 0;
                }
            }
            if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(0, 125))
            {
                bag.BagScrolls = bag.BagScrolls - 1; if (bag.BagScrolls < 1)
                {
                    bag.BagScrolls = 0;
                }
            }
            if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(0, 125))
            {
                bag.BagQuills = bag.BagQuills - 1; if (bag.BagQuills < 1)
                {
                    bag.BagQuills = 0;
                }
            }
        ...
        if (canMake)
        {
            from.CheckSkill(SkillName.Inscribe, 0, 125);
            from.Mana  = from.Mana - mana;
            bag.BagInk = bag.BagInk - ink; if (bag.BagInk < 1)
            {
                bag.BagInk = 0;
            }
            bag.BagScrolls = bag.BagScrolls - 1; if (bag.BagScrolls < 1)
    ...
    public static string NextWizardry(ResearchBag bag)               ///////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        if (found.Length > 0)
        {
            ...
            foreach (string spell in spells)
            {
                if (spell == "0" && check)
                {
                    scroll = ScrollInformation(entry, 2); check = false;
                }
                else if (spell == "1")
                {
                    count++;
    ...
    public static void SetWizardry(ResearchBag bag, Mobile from)               //////////////////////////////////////////////////////////////////////////////
    {
        ...
        if (found.Length > 0)
        {
            ...
            foreach (string spell in spells)
            {
                if (spell == "0" && !updated)
                {
                    got = got + "1#"; magic = entry; updated = true;
                }
                else if (spell == "")
                {
                    got = got + "0#";
    ...
    public static string NextNecromancy(ResearchBag bag)               //////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        if (found.Length > 0)
        {
            ...
            foreach (string spell in spells)
            {
                if (spell == "0" && check)
                {
                    scroll = ScrollInformation((entry + 64), 2); check = false;
                }
                else if (spell == "1")
                {
                    count++;
    ...
    public static string NextResearch(ResearchBag bag)               ///////////////////////////////////////////////////////////////////////////////////////////
    {
        ...
        if (found.Length > 0)
        {
            ...
            foreach (string spell in spells)
            {
                if (spell == "0" && check)
                {
                    scroll = SpellInformation(entry, 2) + " from the School of " + SpellInformation(entry, 3); check = false;
                }
                else if (spell == "1")
                {
                    count++;
    ...
    public static void CreateManySpells(ResearchBag bag, Mobile from, int spell)               ///////////////////////////////////////////////////////////
    {
        ...
        while (!stopAll)
        {
            ...
            else if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(skill - 25, skill + 25) && canMake)
            {
                from.CheckSkill(SkillName.Inscribe, 0, 125);
                canMake = false;
                if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(0, 125) && manaCheck)
                {
                    from.Mana = from.Mana - mana; manaCheck = false;
                }
                if (from.Skills[SkillName.Inscribe].Value < Utility.RandomMinMax(0, 125))
                {
                    bag.BagScrolls = bag.BagScrolls - 1; if (bag.BagScrolls < 1)
        ...
        if (total == 1)
        {
            bag.BagMsgString = "You successfully scribe a single " + name + " scroll."; bag.BagMessage = 2;
        }
        else if (total > 0)
        {
            bag.BagMsgString = "You successfully scribe " + total + " " + name + " scrolls."; bag.BagMessage = 2;
        }
        else
        {
            bag.BagMsgString = msg; bag.BagMessage = 1;
        }
        if (playSound)
        {
            from.PlaySound(0x249);
    ...
    public static void SetPrepared(ResearchBag bag, int index, int amount)               ////////////////////////////////////////////////////////////////////////////////
    {
        ...
        if (index > 32)
        {
            scrolls = bag.ResearchPrep2; cycle = 65; entry = 33;
        }
        ...
        if (scrolls.Length > 0)
        {
            ...
            foreach (string spell in spells)
            {
                if (entry < cycle)
                {
                    if (entry == index)
                    {
                        total = Int32.Parse(spell); if (amount < 0)
                        {
                            total--;
                        }
                        else
                        ...
                        sums = (total).ToString(); got = got + sums + "#";
                    }
                    else if (spell == "")
                    {
                        got = got + "0#";
