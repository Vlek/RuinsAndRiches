...
public class SythSpellbookGump : Gump
{
    ...
    public SythSpellbookGump(Mobile from, SythSpellbook book, int page) : base(25, 25)
    {
        ...
        if (page == 1)
        {
            ...
            {
                AddHtml(310, 85, 183, 20, @"<BODY><BASEFONT Color=#00FF06>You Are One With The Syth</BASEFONT></BODY>", (bool)false, (bool)false);
            }
            else
            {
                AddHtml(310, 85, 183, 20, @"<BODY><BASEFONT Color=#FF0000>You Are Not A Syth!</BASEFONT></BODY>", (bool)false, (bool)false);
            }
            ...
            int name_show = 3609; if (m_Book.names > 0)
            {
                name_show = 4017;
            }
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 380, 4005, 4005, 370, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 430, 4005, 4005, 371, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 480, 4005, 4005, 372, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 530, 4005, 4005, 373, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 580, 4005, 4005, 374, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 380, 4005, 4005, 375, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 430, 4005, 4005, 376, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 480, 4005, 4005, 377, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 530, 4005, 4005, 378, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 580, 4005, 4005, 379, GumpButtonType.Reply, 0);
            }
            else
            {
        ...
        else if (page == 6)
        {
            ...
            if (m_Book.steel > 0)
            {
                AddHtml(325, 81, 190, 20, @"<BODY><BASEFONT Color=#00FF06>You Have Durasteel</BASEFONT></BODY>", (bool)false, (bool)false);
            }
            else
            {
                AddHtml(325, 81, 190, 20, @"<BODY><BASEFONT Color=#FF0000>You Need Durasteel!</BASEFONT></BODY>", (bool)false, (bool)false);
            }

            int jewel = 0xB38;
            if (m_Book.gem > 0)
            {
                jewel = m_Book.gem; AddHtml(325, 126, 190, 20, @"<BODY><BASEFONT Color=#00FF06>You Have A Gem</BASEFONT></BODY>", (bool)false, (bool)false);
            }
            else
            {
                AddHtml(325, 126, 190, 20, @"<BODY><BASEFONT Color=#FF0000>You Need A Gem!</BASEFONT></BODY>", (bool)false, (bool)false);
            }
        ...
        else if (page >= 270 && page < 280)
        {
            ...
            int prev = m_Book.page - 1; if (prev < 270)
            {
                prev = 279;
            }
            int next = m_Book.page + 1; if (next > 279)
            {
                next = 270;
            }
            ...
            {
                AddHtml(352, 82, 154, 20, @"<BODY><BASEFONT Color=#00FF06>Learned</BASEFONT></BODY>", (bool)false, (bool)false);
            }
            else
            {
            ...
            {
                AddHtml(352, 226, 300, 20, @"<BODY><BASEFONT Color=#FF0000>You Are Not A Syth!</BASEFONT></BODY>", (bool)false, (bool)false);
            }
        }
    }
