...
public class IronFlaskFilled : Item
{
    ...
    public string Trapped_Name {
        get { return TrappedName; } set { TrappedName = value; InvalidateProperties(); }
    }
    ...
    public int Trapped_Body {
        get { return TrappedBody; } set { TrappedBody = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_BaseSoundID {
        get { return TrappedBaseSoundID; } set { TrappedBaseSoundID = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Hue {
        get { return TrappedHue; } set { TrappedHue = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_AI {
        get { return TrappedAI; } set { TrappedAI = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Str {
        get { return TrappedStr; } set { TrappedStr = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Dex {
        get { return TrappedDex; } set { TrappedDex = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Int {
        get { return TrappedInt; } set { TrappedInt = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Hits {
        get { return TrappedHits; } set { TrappedHits = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Stam {
        get { return TrappedStam; } set { TrappedStam = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Mana {
        get { return TrappedMana; } set { TrappedMana = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_DmgMin {
        get { return TrappedDmgMin; } set { TrappedDmgMin = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_DmgMax {
        get { return TrappedDmgMax; } set { TrappedDmgMax = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_ColdDmg {
        get { return TrappedColdDmg; } set { TrappedColdDmg = value; InvalidateProperties(); }
    }
    ...
    public int Trapped_FireDmg {
        get { return TrappedFireDmg; } set { TrappedFireDmg = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_PhysicalDmg {
        get { return TrappedPhysicalDmg; } set { TrappedPhysicalDmg = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_PoisonDmg {
        get { return TrappedPoisonDmg; } set { TrappedPoisonDmg = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_ColdRst {
        get { return TrappedColdRst; } set { TrappedColdRst = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_EnergyRst {
        get { return TrappedEnergyRst; } set { TrappedEnergyRst = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_FireRst {
        get { return TrappedFireRst; } set { TrappedFireRst = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_PhysicalRst {
        get { return TrappedPhysicalRst; } set { TrappedPhysicalRst = value; InvalidateProperties(); }
    }
    ...
    public int Trapped_VirtualArmor {
        get { return TrappedVirtualArmor; } set { TrappedVirtualArmor = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public bool Trapped_CanSwim {
        get { return TrappedCanSwim; } set { TrappedCanSwim = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public bool Trapped_CantWalk {
        get { return TrappedCantWalk; } set { TrappedCantWalk = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Skills {
        get { return TrappedSkills; } set { TrappedSkills = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Poison {
        get { return TrappedPoison; } set { TrappedPoison = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_Immune {
        get { return TrappedImmune; } set { TrappedImmune = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_AngerSound {
        get { return TrappedAngerSound; } set { TrappedAngerSound = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_IdleSound {
        get { return TrappedIdleSound; } set { TrappedIdleSound = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_DeathSound {
        get { return TrappedDeathSound; } set { TrappedDeathSound = value; InvalidateProperties(); }
    }

    [CommandProperty(AccessLevel.Owner)]
    public int Trapped_AttackSound {
        get { return TrappedAttackSound; } set { TrappedAttackSound = value; InvalidateProperties(); }
    }
