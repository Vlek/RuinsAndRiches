...
public class DruidPouch : Bag
{
    ...
    public class DruidBag : Gump
    {
        ...
        public DruidBag(Mobile from, DruidPouch bag) : base(50, 50)
        {
            ...
            int b1 = 3609; if (bag.LureStone > 0)
            {
                b1 = 4017;
            }
            ...
            int b2 = 3609; if (bag.NaturesPassage > 0)
            {
                b2 = 4017;
            }
            ...
            int b3 = 3609; if (bag.ShieldOfEarth > 0)
            {
                b3 = 4017;
            }
            ...
            int b4 = 3609; if (bag.WoodlandProtection > 0)
            {
                b4 = 4017;
            }
            ...
            int b5 = 3609; if (bag.StoneCircle > 0)
            {
                b5 = 4017;
            }
            ...
            int b6 = 3609; if (bag.GraspingRoots > 0)
            {
                b6 = 4017;
            }
            ...
            int b7 = 3609; if (bag.DruidicRune > 0)
            {
                b7 = 4017;
            }
            ...
            int b8 = 3609; if (bag.HerbalHealing > 0)
            {
                b8 = 4017;
            }
            ...
            int b9 = 3609; if (bag.BlendWithForest > 0)
            {
                b9 = 4017;
            }
            ...
            int b11 = 3609; if (bag.MushroomGateway > 0)
            {
                b11 = 4017;
            }
            ...
            int b12 = 3609; if (bag.SwarmOfInsects > 0)
            {
                b12 = 4017;
            }
            ...
            int b13 = 3609; if (bag.ProtectiveFairy > 0)
            {
                b13 = 4017;
            }
            ...
            int b14 = 3609; if (bag.Treefellow > 0)
            {
                b14 = 4017;
            }
            ...
            int b15 = 3609; if (bag.VolcanicEruption > 0)
            {
                b15 = 4017;
            }
            ...
            int b16 = 3609; if (bag.RestorativeSoil > 0)
            {
                b16 = 4017;
            }
    ...
    public class DruidBar : Gump
    {
        ...
        public DruidBar(Mobile from, DruidPouch bag, bool vertical) : base(25, 25)
        {
            ...
            if (vertical)
            {
                ...
                if (bag.LureStone > 0)
                {
                    val = val + 50; AddButton(15, val, 11446, 11446, 1, GumpButtonType.Reply, 0);
                }
                if (bag.NaturesPassage > 0)
                {
                    val = val + 50; AddButton(15, val, 11449, 11449, 2, GumpButtonType.Reply, 0);
                }
                if (bag.ShieldOfEarth > 0)
                {
                    val = val + 50; AddButton(15, val, 11450, 11450, 3, GumpButtonType.Reply, 0);
                }
                if (bag.WoodlandProtection > 0)
                {
                    val = val + 50; AddButton(15, val, 11454, 11454, 4, GumpButtonType.Reply, 0);
                }
                if (bag.StoneCircle > 0)
                {
                    val = val + 50; AddButton(15, val, 11451, 11451, 5, GumpButtonType.Reply, 0);
                }
                if (bag.GraspingRoots > 0)
                {
                    val = val + 50; AddButton(15, val, 11443, 11443, 6, GumpButtonType.Reply, 0);
                }
                if (bag.DruidicRune > 0)
                {
                    val = val + 50; AddButton(15, val, 11439, 11439, 7, GumpButtonType.Reply, 0);
                }
                if (bag.HerbalHealing > 0)
                {
                    val = val + 50; AddButton(15, val, 11444, 11444, 8, GumpButtonType.Reply, 0);
                }
                if (bag.BlendWithForest > 0)
                {
                    val = val + 50; AddButton(15, val, 11442, 11442, 9, GumpButtonType.Reply, 0);
                }
                if (bag.Firefly > 0)
                {
                    val = val + 50; AddButton(15, val, 11445, 11445, 10, GumpButtonType.Reply, 0);
                }
                if (bag.MushroomGateway > 0)
                {
                    val = val + 50; AddButton(15, val, 11448, 11448, 11, GumpButtonType.Reply, 0);
                }
                if (bag.SwarmOfInsects > 0)
                {
                    val = val + 50; AddButton(15, val, 11441, 11441, 12, GumpButtonType.Reply, 0);
                }
                if (bag.ProtectiveFairy > 0)
                {
                    val = val + 50; AddButton(15, val, 11440, 11440, 13, GumpButtonType.Reply, 0);
                }
                if (bag.Treefellow > 0)
                {
                    val = val + 50; AddButton(15, val, 11452, 11452, 14, GumpButtonType.Reply, 0);
                }
                if (bag.VolcanicEruption > 0)
                {
                    val = val + 50; AddButton(15, val, 11453, 11453, 15, GumpButtonType.Reply, 0);
                }
                if (bag.RestorativeSoil > 0)
                {
                    val = val + 50; AddButton(15, val, 11447, 11447, 16, GumpButtonType.Reply, 0);
                }
                ...
                if (bag.Titles > 0)
                {
                    if (bag.LureStone > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Stone in a Jar");
                    }
                    if (bag.NaturesPassage > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Nature Passage");
                    }
                    if (bag.ShieldOfEarth > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Shield of Earth");
                    }
                    if (bag.WoodlandProtection > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Woodland Protection");
                    }
                    if (bag.StoneCircle > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Stone Rising");
                    }
                    if (bag.GraspingRoots > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Grasping Roots");
                    }
                    if (bag.DruidicRune > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Druidic Marking");
                    }
                    if (bag.HerbalHealing > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Herbal Healing");
                    }
                    if (bag.BlendWithForest > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Forest Blending");
                    }
                    if (bag.Firefly > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Jar of Fireflies");
                    }
                    if (bag.MushroomGateway > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Mushroom Gateway");
                    }
                    if (bag.SwarmOfInsects > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Jar of Insects");
                    }
                    if (bag.ProtectiveFairy > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Fairy in a Jar");
                    }
                    if (bag.Treefellow > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Treant Fertilizer");
                    }
                    if (bag.VolcanicEruption > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Volcanic Fluid");
                    }
                    if (bag.RestorativeSoil > 0)
                    {
                        txt = txt + 50; AddLabel(70, txt, 2962, @"Magical Mud");
                    }
                }
            }
            else
            {
                ...
                if (bag.LureStone > 0)
                {
                    val = val + 50; AddButton(val, 0, 11446, 11446, 1, GumpButtonType.Reply, 0);
                }
                if (bag.NaturesPassage > 0)
                {
                    val = val + 50; AddButton(val, 0, 11449, 11449, 2, GumpButtonType.Reply, 0);
                }
                if (bag.ShieldOfEarth > 0)
                {
                    val = val + 50; AddButton(val, 0, 11450, 11450, 3, GumpButtonType.Reply, 0);
                }
                if (bag.WoodlandProtection > 0)
                {
                    val = val + 50; AddButton(val, 0, 11454, 11454, 4, GumpButtonType.Reply, 0);
                }
                if (bag.StoneCircle > 0)
                {
                    val = val + 50; AddButton(val, 0, 11451, 11451, 5, GumpButtonType.Reply, 0);
                }
                if (bag.GraspingRoots > 0)
                {
                    val = val + 50; AddButton(val, 0, 11443, 11443, 6, GumpButtonType.Reply, 0);
                }
                if (bag.DruidicRune > 0)
                {
                    val = val + 50; AddButton(val, 0, 11439, 11439, 7, GumpButtonType.Reply, 0);
                }
                if (bag.HerbalHealing > 0)
                {
                    val = val + 50; AddButton(val, 0, 11444, 11444, 8, GumpButtonType.Reply, 0);
                }
                if (bag.BlendWithForest > 0)
                {
                    val = val + 50; AddButton(val, 0, 11442, 11442, 9, GumpButtonType.Reply, 0);
                }
                if (bag.Firefly > 0)
                {
                    val = val + 50; AddButton(val, 0, 11445, 11445, 10, GumpButtonType.Reply, 0);
                }
                if (bag.MushroomGateway > 0)
                {
                    val = val + 50; AddButton(val, 0, 11448, 11448, 11, GumpButtonType.Reply, 0);
                }
                if (bag.SwarmOfInsects > 0)
                {
                    val = val + 50; AddButton(val, 0, 11441, 11441, 12, GumpButtonType.Reply, 0);
                }
                if (bag.ProtectiveFairy > 0)
                {
                    val = val + 50; AddButton(val, 0, 11440, 11440, 13, GumpButtonType.Reply, 0);
                }
                if (bag.Treefellow > 0)
                {
                    val = val + 50; AddButton(val, 0, 11452, 11452, 14, GumpButtonType.Reply, 0);
                }
                if (bag.VolcanicEruption > 0)
                {
                    val = val + 50; AddButton(val, 0, 11453, 11453, 15, GumpButtonType.Reply, 0);
                }
                if (bag.RestorativeSoil > 0)
                {
                    val = val + 50; AddButton(val, 0, 11447, 11447, 16, GumpButtonType.Reply, 0);
                }
            }
        }
    ...
    public int m_LureStone {
        get { return LureStone; } set { LureStone = value; InvalidateProperties(); }
    }
    ...
    public int m_ShieldOfEarth {
        get { return ShieldOfEarth; } set { ShieldOfEarth = value; InvalidateProperties(); }
    }

    public int WoodlandProtection;
    [CommandProperty(AccessLevel.Owner)]
    public int m_WoodlandProtection {
        get { return WoodlandProtection; } set { WoodlandProtection = value; InvalidateProperties(); }
    }

    public int StoneCircle;
    [CommandProperty(AccessLevel.Owner)]
    public int m_StoneCircle {
        get { return StoneCircle; } set { StoneCircle = value; InvalidateProperties(); }
    }
    ...
    public int m_DruidicRune {
        get { return DruidicRune; } set { DruidicRune = value; InvalidateProperties(); }
    }
    ...
    public int m_BlendWithForest {
        get { return BlendWithForest; } set { BlendWithForest = value; InvalidateProperties(); }
    }

    public int Firefly;
    [CommandProperty(AccessLevel.Owner)]
    public int m_Firefly {
        get { return Firefly; } set { Firefly = value; InvalidateProperties(); }
    }
    ...
    public int m_SwarmOfInsects {
        get { return SwarmOfInsects; } set { SwarmOfInsects = value; InvalidateProperties(); }
    }

    public int ProtectiveFairy;
    [CommandProperty(AccessLevel.Owner)]
    public int m_ProtectiveFairy {
        get { return ProtectiveFairy; } set { ProtectiveFairy = value; InvalidateProperties(); }
    }

    public int Treefellow;
    [CommandProperty(AccessLevel.Owner)]
    public int m_Treefellow {
        get { return Treefellow; } set { Treefellow = value; InvalidateProperties(); }
    }

    public int VolcanicEruption;
    [CommandProperty(AccessLevel.Owner)]
    public int m_VolcanicEruption {
        get { return VolcanicEruption; } set { VolcanicEruption = value; InvalidateProperties(); }
    }

    public int RestorativeSoil;
    [CommandProperty(AccessLevel.Owner)]
    public int m_RestorativeSoil {
        get { return RestorativeSoil; } set { RestorativeSoil = value; InvalidateProperties(); }
    }
}
}
