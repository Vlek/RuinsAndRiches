...
public abstract class JediSpell : Spell
{
    ...
    public abstract int RequiredTithing {
        get;
    }
    ...
    public static string SpellInfo(int spellID, int slice)
    {
        ...
        {
            name     = "Replicate"; icon = "11218"; crystal = "250"; skill = "100"; mana = "40"; mantra = "Leantre"; map = "Sosaria"; dungeon = "the Kuldar Cemetery"; world = "the Bottle World of Kuldar"; jedi = "Coran Horn"; scroll = "JediDatacron10";
    ...
    public static bool JediNotIllegal(Mobile from, bool checkSword)
    {
        ...
        if (from.FindItemOnLayer(Layer.TwoHanded) != null)
        {
            ...
            else if (twoHand is BaseShield && twoHand.Name != null && (twoHand.Name).Contains("Jedi"))
            {
                WearingCloth = true;
            }
        }
