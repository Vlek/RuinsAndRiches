...
public class JediSpellbookGump : Gump
{
    ...
    public JediSpellbookGump(Mobile from, JediSpellbook book, int page) : base(25, 25)
    {
        ...
        if (page == 1)
        {
            ...
            {
                AddHtml(310, 85, 183, 20, @"<BODY><BASEFONT Color=#00FF06>You Are One With The Jedi</BASEFONT></BODY>", (bool)false, (bool)false);
            }
            else
            {
                AddHtml(310, 85, 183, 20, @"<BODY><BASEFONT Color=#308EB3>You Are Not A Jedi!</BASEFONT></BODY>", (bool)false, (bool)false);
            }
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 380, 4005, 4005, 380, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 430, 4005, 4005, 381, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 480, 4005, 4005, 382, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 530, 4005, 4005, 383, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(100, 580, 4005, 4005, 384, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 380, 4005, 4005, 385, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 430, 4005, 4005, 386, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 480, 4005, 4005, 387, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 530, 4005, 4005, 388, GumpButtonType.Reply, 0);
            }
            else
            {
            ...
            {
                wordColor = "#00FF06"; AddButton(470, 580, 4005, 4005, 389, GumpButtonType.Reply, 0);
            }
            else
            {
        ...
        else if (page == 6)
        {
            ...
            {
                AddHtml(325, 81, 190, 20, @"<BODY><BASEFONT Color=#308EB3>You Need Durasteel!</BASEFONT></BODY>", (bool)false, (bool)false);
            }
            ...
            {
                AddHtml(325, 126, 190, 20, @"<BODY><BASEFONT Color=#308EB3>You Need A Gem!</BASEFONT></BODY>", (bool)false, (bool)false);
            }
        ...
        else if (page >= 280 && page < 290)
        {
            ...
            int prev = m_Book.page - 1; if (prev < 280)
            {
                prev = 289;
            }
            int next = m_Book.page + 1; if (next > 289)
            {
                next = 280;
            }
            ...
            {
                AddHtml(352, 226, 300, 20, @"<BODY><BASEFONT Color=#308EB3>You Are Not A Jedi!</BASEFONT></BODY>", (bool)false, (bool)false);
            }
        }
    }
