...
public class JediSpellbook : Spellbook
{
    ...
    [CommandProperty(AccessLevel.GameMaster)]
    public int Crystals {
        get { return crystals; } set { crystals = value; }
    }

    public int page;
    [CommandProperty(AccessLevel.GameMaster)]
    public int Page {
        get { return page; } set { page = value; }
    }
    ...
    [CommandProperty(AccessLevel.GameMaster)]
    public int Gem {
        get { return gem; } set { gem = value; }
    }

    public int steel;
    [CommandProperty(AccessLevel.GameMaster)]
    public int Steel {
        get { return steel; } set { steel = value; }
    }
    ...
    public override bool OnDragDrop(Mobile from, Item dropped)
    {
        ...
        {
            dropped.ItemID = 0x543E; dropped.Name = "Jedi Exacron"; doJediEffect = true;
        }
        ...
        else if (dropped != null && (dropped is BaseArmor || dropped is BaseClothing || dropped is BaseJewel || dropped is BaseHat))
        {
            if (dropped is BaseHat || dropped is MagicHat)
            {
                ...
                {
                    dropped.ItemID = 0x4D09; dropped.Name = "Jedi hood";
                }
                else
                {
                    dropped.ItemID = 0x2B71; dropped.Name = "Jedi hood";
                }
                doJediEffect = true;
            }
            ...
            else if (dropped.Layer == Layer.OuterTorso)
            {
                ...
                {
                    dropped.ItemID = 0x567D; dropped.Name = "Jedi robe";
                }
                else if (dropped.ItemID == 0x567D)
                {
                    dropped.ItemID = 0x2B6A; dropped.Name = "Jedi robe";
                }
                else
                {
                    dropped.ItemID = 0x1F03; dropped.Name = "Jedi robe";
                }
