...
public class MysticSpellbookGump : Gump
{
    ...
    public MysticSpellbookGump(Mobile from, MysticSpellbook book, int page) : base(100, 100)
    {
        ...
        if (page == 1)
        {
            ...
            while (SpellsInBook > 0)
            {
                ...
                if (this.HasSpell(SpellsListed))
                {
                    ...
                    if (SpellsListed == 250)
                    {
                        SpellName = "Astral Projection"; iBUTTON = 0x500E;
                    }
                    else if (SpellsListed == 251)
                    {
                        SpellName = "Astral Travel"; iBUTTON = 0x410;
                    }
                    else if (SpellsListed == 252)
                    {
                        SpellName = "Create Robe"; iBUTTON = 0x15;
                    }
                    else if (SpellsListed == 253)
                    {
                        SpellName = "Gentle Touch"; iBUTTON = 0x971;
                    }
                    else if (SpellsListed == 254)
                    {
                        SpellName = "Leap"; iBUTTON = 0x4B2;
                    }
                    else if (SpellsListed == 255)
                    {
                        SpellName = "Psionic Blast"; iBUTTON = 0x5DC2;
                    }
                    else if (SpellsListed == 256)
                    {
                        SpellName = "Psychic Wall"; iBUTTON = 0x1A;
                    }
                    else if (SpellsListed == 257)
                    {
                        SpellName = "Purity of Body"; iBUTTON = 0x96D;
                    }
                    else if (SpellsListed == 258)
                    {
                        SpellName = "Quivering Palm"; iBUTTON = 0x5001;
                    }
                    else if (SpellsListed == 259)
                    {
                        SpellName = "Wind Runner"; iBUTTON = 0x19;
                    }
                    ...
                    if (SpellsInBook == 5)
                    {
                        nHTMLx = 432; nHTMLy = 105;
                    }

                    nBUTTONy = nBUTTONy + 65;
                    if (SpellsInBook == 5)
                    {
                        nBUTTONx = 375; nBUTTONy = 93;
                    }
                }
        ...
        else if (page > 1 && page < 12)
        {
            ...
            string know = "<BODY><BASEFONT Color=#f58a8a>Not Learned</BASEFONT></BODY>"; if (this.HasSpell(abil_spid))
            {
            ...
            {
                abil_info = ""; showScrollBar = false; AddButton(78, 94, abil_icon, abil_icon, abil_spid, GumpButtonType.Reply, 0);
            }
