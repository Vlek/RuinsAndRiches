...
public abstract class MysticSpell : Spell
{
    ...
    public abstract int MysticSpellCircle {
        get;
    }
    ...
    public static bool MonkNotIllegal(Mobile from)
    {
        if (from.FindItemOnLayer(Layer.OneHanded) != null)
        {
            ...
            if (oneHand is Artifact_GlovesOfThePugilist || oneHand is GlovesOfThePugilist || oneHand is GiftPugilistGloves || oneHand is LevelPugilistGloves || oneHand is PugilistGloves || oneHand is PugilistGlove)
            {
            }
